...
pub struct TIMEOUT_ENABLE_R(crate::FieldReader<bool, TIMEOUT_ENABLE_A>);
...
impl core::ops::Deref for TIMEOUT_ENABLE_R {
    type Target = crate::FieldReader<bool, TIMEOUT_ENABLE_A>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
pub struct TX_REQ_ENABLE_R(crate::FieldReader<bool, TX_REQ_ENABLE_A>);
...
impl core::ops::Deref for TX_REQ_ENABLE_R {
    type Target = crate::FieldReader<bool, TX_REQ_ENABLE_A>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
pub struct RX_REQ_ENABLE_R(crate::FieldReader<bool, RX_REQ_ENABLE_A>);
...
impl core::ops::Deref for RX_REQ_ENABLE_R {
    type Target = crate::FieldReader<bool, RX_REQ_ENABLE_A>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
