...
pub struct T1H_TIME_R(crate::FieldReader<u8>);
impl T1H_TIME_R {
    #[inline(always)]
...
pub struct T1L_TIME_R(crate::FieldReader<u8>);
impl T1L_TIME_R {
    #[inline(always)]
    pub(crate) fn new(bits: u8) -> Self {
...
pub struct T0H_TIME_R(crate::FieldReader<u8>);
impl T0H_TIME_R {
    #[inline(always)]
    pub(crate) fn new(bits: u8) -> Self {
...
pub struct T0L_TIME_R(crate::FieldReader<u8>);
impl T0L_TIME_R {
    #[inline(always)]
    pub(crate) fn new(bits: u8) -> Self {
