...
pub type R = crate::R<CSIC_DMA_F0_BUFA_SPEC>;
#[doc = "Register `csic_dma_f0_bufa` writer"]
pub type W = crate::W<CSIC_DMA_F0_BUFA_SPEC>;
...
pub type F0_BUFA_R = crate::FieldReader<u32>;
...
pub type F0_BUFA_W<'a, REG> = crate::FieldWriter<'a, REG, 32, u32>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn f0_bufa(&mut self) -> F0_BUFA_W<CSIC_DMA_F0_BUFA_SPEC> {
        F0_BUFA_W::new(self, 0)
    }
