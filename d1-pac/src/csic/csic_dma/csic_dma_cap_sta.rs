...
pub type R = crate::R<CSIC_DMA_CAP_STA_SPEC>;
#[doc = "Register `csic_dma_cap_sta` writer"]
pub type W = crate::W<CSIC_DMA_CAP_STA_SPEC>;
...
pub type SCAP_STA_R = crate::BitReader;
...
pub type VCAP_STA_R = crate::BitReader;
...
impl FIELD_STA_R {
    ...
    #[inline(always)]
    pub const fn variant(&self) -> FIELD_STA_A {
        match self.bits {
