...
pub type R = crate::R<CSIC_DMA_F1_BUFA_RESULT_SPEC>;
#[doc = "Register `csic_dma_f1_bufa_result` writer"]
pub type W = crate::W<CSIC_DMA_F1_BUFA_RESULT_SPEC>;
...
pub type F1_BUFA_RESULT_R = crate::FieldReader<u32>;
impl R {
...
#[doc = "CSIC DMA FIFO 1 Output Buffer-A Address Result Register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`csic_dma_f1_bufa_result::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`csic_dma_f1_bufa_result::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
