...
pub struct R(crate::R<CSIC_DMA_F0_BUFA_RESULT_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<CSIC_DMA_F0_BUFA_RESULT_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<CSIC_DMA_F0_BUFA_RESULT_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<CSIC_DMA_F0_BUFA_RESULT_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `csic_dma_f0_bufa_result` writer"]
pub struct W(crate::W<CSIC_DMA_F0_BUFA_RESULT_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<CSIC_DMA_F0_BUFA_RESULT_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<CSIC_DMA_F0_BUFA_RESULT_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<CSIC_DMA_F0_BUFA_RESULT_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type F0_BUFA_RESULT_R = crate::FieldReader<u32, u32>;
impl R {
