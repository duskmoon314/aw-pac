...
pub type R = crate::R<CSIC_BIST_START_ADDR_SPEC>;
#[doc = "Register `csic_bist_start_addr` writer"]
pub type W = crate::W<CSIC_BIST_START_ADDR_SPEC>;
#[doc = "Field `bist_start_addr` reader - BIST start address, 32-bit aligned"]
pub type BIST_START_ADDR_R = crate::FieldReader<u32>;
#[doc = "Field `bist_start_addr` writer - BIST start address, 32-bit aligned"]
pub type BIST_START_ADDR_W<'a, REG> = crate::FieldWriter<'a, REG, 32, u32>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn bist_start_addr(&mut self) -> BIST_START_ADDR_W<CSIC_BIST_START_ADDR_SPEC> {
        BIST_START_ADDR_W::new(self, 0)
    }
...
#[doc = "CSIC BIST Start Address Register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`csic_bist_start_addr::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`csic_bist_start_addr::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
