...
pub type R = crate::R<DBI_CTL_0_SPEC>;
#[doc = "Register `dbi_ctl_0` writer"]
pub type W = crate::W<DBI_CTL_0_SPEC>;
...
impl VI_SRC_TYPE_R {
    ...
    #[inline(always)]
    pub const fn variant(&self) -> VI_SRC_TYPE_A {
        match self.bits {
...
pub type VI_SRC_TYPE_W<'a, REG> = crate::BitWriter<'a, REG, VI_SRC_TYPE_A>;
impl<'a, REG> VI_SRC_TYPE_W<'a, REG>
where
    REG: crate::Writable + crate::RegisterSpec,
{
    #[doc = "`0`"]
    #[inline(always)]
    pub fn rgb32(self) -> &'a mut crate::W<REG> {
        self.variant(VI_SRC_TYPE_A::RGB32)
    }
    #[doc = "`1`"]
    #[inline(always)]
    pub fn rgb16(self) -> &'a mut crate::W<REG> {
...
impl ELEMENT_A_POS_R {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
    pub const fn variant(&self) -> ELEMENT_A_POS_A {
        match self.bits {
...
pub type ELEMENT_A_POS_W<'a, REG> = crate::BitWriter<'a, REG, ELEMENT_A_POS_A>;
impl<'a, REG> ELEMENT_A_POS_W<'a, REG>
where
    REG: crate::Writable + crate::RegisterSpec,
{
    #[doc = "`0`"]
    #[inline(always)]
    pub fn _31_24(self) -> &'a mut crate::W<REG> {
        self.variant(ELEMENT_A_POS_A::_31_24)
    }
    #[doc = "`1`"]
    #[inline(always)]
    pub fn _7_0(self) -> &'a mut crate::W<REG> {
...
impl RGB_BO_R {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
    pub const fn variant(&self) -> RGB_BO_A {
        match self.bits {
            false => RGB_BO_A::DATA,
            true => RGB_BO_A::SWAP,
        }
...
pub type RGB_BO_W<'a, REG> = crate::BitWriter<'a, REG, RGB_BO_A>;
impl<'a, REG> RGB_BO_W<'a, REG>
where
    REG: crate::Writable + crate::RegisterSpec,
{
    #[doc = "`0`"]
...
pub type DUM_VAL_R = crate::BitReader;
#[doc = "Field `dum_val` writer - Dummy Cycle Value"]
pub type DUM_VAL_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `rgb_src_fmt` reader - RGB Source Format"]
pub type RGB_SRC_FMT_R = crate::FieldReader<RGB_SRC_FMT_A>;
...
impl crate::FieldSpec for RGB_SRC_FMT_A {
    type Ux = u8;
}
impl RGB_SRC_FMT_R {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
    pub const fn variant(&self) -> Option<RGB_SRC_FMT_A> {
        match self.bits {
...
pub type RGB_SRC_FMT_W<'a, REG> = crate::FieldWriter<'a, REG, 4, RGB_SRC_FMT_A>;
impl<'a, REG> RGB_SRC_FMT_W<'a, REG>
where
    REG: crate::Writable + crate::RegisterSpec,
    REG::Ux: From<u8>,
{
    ...
    #[doc = "`110`"]
    #[inline(always)]
    pub fn grbg_0(self) -> &'a mut crate::W<REG> {
        self.variant(RGB_SRC_FMT_A::GRBG_0)
    }
    #[doc = "`111`"]
    #[inline(always)]
    pub fn gbrg_0(self) -> &'a mut crate::W<REG> {
        self.variant(RGB_SRC_FMT_A::GBRG_0)
    }
    #[doc = "`1000`"]
    #[inline(always)]
    pub fn grbg_1(self) -> &'a mut crate::W<REG> {
        self.variant(RGB_SRC_FMT_A::GRBG_1)
    }
    #[doc = "`1001`"]
    #[inline(always)]
    pub fn gbrg_1(self) -> &'a mut crate::W<REG> {
        self.variant(RGB_SRC_FMT_A::GBRG_1)
    }
}
#[doc = "Field `dbi_interface` reader - "]
pub type DBI_INTERFACE_R = crate::FieldReader<DBI_INTERFACE_A>;
#[doc = "\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
#[repr(u8)]
...
impl crate::FieldSpec for DBI_INTERFACE_A {
    type Ux = u8;
}
impl DBI_INTERFACE_R {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
    pub const fn variant(&self) -> Option<DBI_INTERFACE_A> {
        match self.bits {
...
pub type DBI_INTERFACE_W<'a, REG> = crate::FieldWriter<'a, REG, 3, DBI_INTERFACE_A>;
impl<'a, REG> DBI_INTERFACE_W<'a, REG>
where
    REG: crate::Writable + crate::RegisterSpec,
    REG::Ux: From<u8>,
{
    #[doc = "3 Line Interface I"]
    #[inline(always)]
    pub fn l3i1(self) -> &'a mut crate::W<REG> {
        self.variant(DBI_INTERFACE_A::L3I1)
    }
    #[doc = "3 Line Interface II"]
    #[inline(always)]
    pub fn l3i2(self) -> &'a mut crate::W<REG> {
        self.variant(DBI_INTERFACE_A::L3I2)
    }
    #[doc = "4 Line Interface I"]
    #[inline(always)]
    pub fn l4i1(self) -> &'a mut crate::W<REG> {
        self.variant(DBI_INTERFACE_A::L4I1)
    }
    #[doc = "4 Line Interface II"]
    #[inline(always)]
    pub fn l4i2(self) -> &'a mut crate::W<REG> {
        self.variant(DBI_INTERFACE_A::L4I2)
    }
    #[doc = "2 Data Lane Interface"]
    #[inline(always)]
    pub fn d2li(self) -> &'a mut crate::W<REG> {
        self.variant(DBI_INTERFACE_A::D2LI)
    }
}
#[doc = "Field `dat_fmt` reader - Output Data Format"]
pub type DAT_FMT_R = crate::FieldReader<DAT_FMT_A>;
...
impl crate::FieldSpec for DAT_FMT_A {
    type Ux = u8;
}
impl DAT_FMT_R {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
    pub const fn variant(&self) -> Option<DAT_FMT_A> {
        match self.bits {
...
pub type DAT_FMT_W<'a, REG> = crate::FieldWriter<'a, REG, 3, DAT_FMT_A>;
impl<'a, REG> DAT_FMT_W<'a, REG>
where
    REG: crate::Writable + crate::RegisterSpec,
    REG::Ux: From<u8>,
{
    #[doc = "`0`"]
    #[inline(always)]
    pub fn rgb111(self) -> &'a mut crate::W<REG> {
...
impl TRAN_MOD_R {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
    pub const fn variant(&self) -> TRAN_MOD_A {
        match self.bits {
...
pub type TRAN_MOD_W<'a, REG> = crate::BitWriter<'a, REG, TRAN_MOD_A>;
impl<'a, REG> TRAN_MOD_W<'a, REG>
where
    REG: crate::Writable + crate::RegisterSpec,
{
    #[doc = "`0`"]
    #[inline(always)]
    pub fn command_parameter(self) -> &'a mut crate::W<REG> {
        self.variant(TRAN_MOD_A::COMMAND_PARAMETER)
    }
    #[doc = "`1`"]
    #[inline(always)]
    pub fn video(self) -> &'a mut crate::W<REG> {
        self.variant(TRAN_MOD_A::VIDEO)
    }
}
#[doc = "Field `rgb_seq` reader - Output RGB Sequence"]
pub type RGB_SEQ_R = crate::FieldReader<RGB_SEQ_A>;
...
impl crate::FieldSpec for RGB_SEQ_A {
    type Ux = u8;
}
impl RGB_SEQ_R {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
    pub const fn variant(&self) -> Option<RGB_SEQ_A> {
        match self.bits {
...
pub type RGB_SEQ_W<'a, REG> = crate::FieldWriter<'a, REG, 3, RGB_SEQ_A>;
impl<'a, REG> RGB_SEQ_W<'a, REG>
where
    REG: crate::Writable + crate::RegisterSpec,
    REG::Ux: From<u8>,
{
...
impl DAT_SEQ_R {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
    pub const fn variant(&self) -> DAT_SEQ_A {
        match self.bits {
            false => DAT_SEQ_A::MSB,
            true => DAT_SEQ_A::LSB,
        }
...
pub type DAT_SEQ_W<'a, REG> = crate::BitWriter<'a, REG, DAT_SEQ_A>;
impl<'a, REG> DAT_SEQ_W<'a, REG>
where
    REG: crate::Writable + crate::RegisterSpec,
{
    #[doc = "`0`"]
...
pub type WCDC_R = crate::FieldReader<u16>;
#[doc = "Field `wcdc` writer - Write Command Dummy Cycles"]
pub type WCDC_W<'a, REG> = crate::FieldWriter<'a, REG, 11, u16>;
...
impl CMDT_R {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
    pub const fn variant(&self) -> CMDT_A {
        match self.bits {
            false => CMDT_A::WRITE,
            true => CMDT_A::READ,
        }
...
pub type CMDT_W<'a, REG> = crate::BitWriter<'a, REG, CMDT_A>;
impl<'a, REG> CMDT_W<'a, REG>
where
    REG: crate::Writable + crate::RegisterSpec,
{
    #[doc = "`0`"]
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn vi_src_type(&mut self) -> VI_SRC_TYPE_W<DBI_CTL_0_SPEC> {
        VI_SRC_TYPE_W::new(self, 0)
    }
    #[doc = "Bit 1 - Element A Position"]
    #[inline(always)]
    #[must_use]
    pub fn element_a_pos(&mut self) -> ELEMENT_A_POS_W<DBI_CTL_0_SPEC> {
        ELEMENT_A_POS_W::new(self, 1)
    }
    #[doc = "Bit 2 - RGB Bit Order"]
    #[inline(always)]
    #[must_use]
    pub fn rgb_bo(&mut self) -> RGB_BO_W<DBI_CTL_0_SPEC> {
        RGB_BO_W::new(self, 2)
    }
    #[doc = "Bit 3 - Dummy Cycle Value"]
    #[inline(always)]
    #[must_use]
    pub fn dum_val(&mut self) -> DUM_VAL_W<DBI_CTL_0_SPEC> {
        DUM_VAL_W::new(self, 3)
    }
    #[doc = "Bits 4:7 - RGB Source Format"]
    #[inline(always)]
    #[must_use]
    pub fn rgb_src_fmt(&mut self) -> RGB_SRC_FMT_W<DBI_CTL_0_SPEC> {
        RGB_SRC_FMT_W::new(self, 4)
    }
    #[doc = "Bits 8:10"]
    #[inline(always)]
    #[must_use]
    pub fn dbi_interface(&mut self) -> DBI_INTERFACE_W<DBI_CTL_0_SPEC> {
        DBI_INTERFACE_W::new(self, 8)
    }
    #[doc = "Bits 12:14 - Output Data Format"]
    #[inline(always)]
    #[must_use]
    pub fn dat_fmt(&mut self) -> DAT_FMT_W<DBI_CTL_0_SPEC> {
        DAT_FMT_W::new(self, 12)
    }
    #[doc = "Bit 15 - Transmit Mode"]
    #[inline(always)]
    #[must_use]
    pub fn tran_mod(&mut self) -> TRAN_MOD_W<DBI_CTL_0_SPEC> {
        TRAN_MOD_W::new(self, 15)
    }
    #[doc = "Bits 16:18 - Output RGB Sequence"]
    #[inline(always)]
    #[must_use]
    pub fn rgb_seq(&mut self) -> RGB_SEQ_W<DBI_CTL_0_SPEC> {
        RGB_SEQ_W::new(self, 16)
    }
    #[doc = "Bit 19 - Output Data Sequence"]
    #[inline(always)]
    #[must_use]
    pub fn dat_seq(&mut self) -> DAT_SEQ_W<DBI_CTL_0_SPEC> {
        DAT_SEQ_W::new(self, 19)
    }
    #[doc = "Bits 20:30 - Write Command Dummy Cycles"]
    #[inline(always)]
    #[must_use]
    pub fn wcdc(&mut self) -> WCDC_W<DBI_CTL_0_SPEC> {
        WCDC_W::new(self, 20)
    }
    #[doc = "Bit 31 - Command Type"]
    #[inline(always)]
    #[must_use]
    pub fn cmdt(&mut self) -> CMDT_W<DBI_CTL_0_SPEC> {
        CMDT_W::new(self, 31)
    }
