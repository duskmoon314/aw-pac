...
pub struct RegisterBlock {
    ...
    pub smhc_ctrl: crate::Reg<smhc_ctrl::SMHC_CTRL_SPEC>,
    #[doc = "0x04 - Clock Control Register"]
    pub smhc_clkdiv: crate::Reg<smhc_clkdiv::SMHC_CLKDIV_SPEC>,
    #[doc = "0x08 - Time Out Register"]
    pub smhc_tmout: crate::Reg<smhc_tmout::SMHC_TMOUT_SPEC>,
    #[doc = "0x0c - Bus Width Register"]
    pub smhc_ctype: crate::Reg<smhc_ctype::SMHC_CTYPE_SPEC>,
    #[doc = "0x10 - Block Size Register"]
    pub smhc_blksiz: crate::Reg<smhc_blksiz::SMHC_BLKSIZ_SPEC>,
    #[doc = "0x14 - Byte Count Register"]
    pub smhc_bytcnt: crate::Reg<smhc_bytcnt::SMHC_BYTCNT_SPEC>,
    #[doc = "0x18 - Command Register"]
    pub smhc_cmd: crate::Reg<smhc_cmd::SMHC_CMD_SPEC>,
    #[doc = "0x1c - Command Argument Register"]
    pub smhc_cmdarg: crate::Reg<smhc_cmdarg::SMHC_CMDARG_SPEC>,
    #[doc = "0x20 - Response 0 Register"]
    pub smhc_resp0: crate::Reg<smhc_resp0::SMHC_RESP0_SPEC>,
    #[doc = "0x24 - Response 1 Register"]
    pub smhc_resp1: crate::Reg<smhc_resp1::SMHC_RESP1_SPEC>,
    #[doc = "0x28 - Response 2 Register"]
    pub smhc_resp2: crate::Reg<smhc_resp2::SMHC_RESP2_SPEC>,
    #[doc = "0x2c - Response 3 Register"]
    pub smhc_resp3: crate::Reg<smhc_resp3::SMHC_RESP3_SPEC>,
    #[doc = "0x30 - Interrupt Mask Register"]
    pub smhc_intmask: crate::Reg<smhc_intmask::SMHC_INTMASK_SPEC>,
    #[doc = "0x34 - Masked Interrupt Status Register"]
    pub smhc_mintsts: crate::Reg<smhc_mintsts::SMHC_MINTSTS_SPEC>,
    #[doc = "0x38 - Raw Interrupt Status Register"]
    pub smhc_rintsts: crate::Reg<smhc_rintsts::SMHC_RINTSTS_SPEC>,
    #[doc = "0x3c - Status Register"]
    pub smhc_status: crate::Reg<smhc_status::SMHC_STATUS_SPEC>,
    #[doc = "0x40 - FIFO Water Level Register"]
    pub smhc_fifoth: crate::Reg<smhc_fifoth::SMHC_FIFOTH_SPEC>,
    ...
    pub smhc_csdc: crate::Reg<smhc_csdc::SMHC_CSDC_SPEC>,
    #[doc = "0x58 - Auto Command 12 Argument Register"]
    pub smhc_a12a: crate::Reg<smhc_a12a::SMHC_A12A_SPEC>,
    #[doc = "0x5c - SD New Timing Set Register"]
    pub smhc_ntsr: crate::Reg<smhc_ntsr::SMHC_NTSR_SPEC>,
    _reserved24: [u8; 0x18],
    #[doc = "0x78 - Hardware Reset Register"]
    pub smhc_hwrst: crate::Reg<smhc_hwrst::SMHC_HWRST_SPEC>,
    _reserved25: [u8; 0x04],
    #[doc = "0x80 - IDMAC Control Register"]
    pub smhc_idmac: crate::Reg<smhc_idmac::SMHC_IDMAC_SPEC>,
    #[doc = "0x84 - Descriptor List Base Address Register"]
    pub smhc_dlba: crate::Reg<smhc_dlba::SMHC_DLBA_SPEC>,
    #[doc = "0x88 - IDMAC Status Register"]
    pub smhc_idst: crate::Reg<smhc_idst::SMHC_IDST_SPEC>,
    #[doc = "0x8c - IDMAC Interrupt Enable Register"]
    pub smhc_idie: crate::Reg<smhc_idie::SMHC_IDIE_SPEC>,
    _reserved29: [u8; 0x70],
    #[doc = "0x100 - Card Threshold Control Register"]
    pub smhc_thld: crate::Reg<smhc_thld::SMHC_THLD_SPEC>,
    #[doc = "0x104 - Sample FIFO Control Register"]
    pub smhc_sfc: crate::Reg<smhc_sfc::SMHC_SFC_SPEC>,
    #[doc = "0x108 - Auto Command 23 Argument Register"]
    pub smhc_a23a: crate::Reg<smhc_a23a::SMHC_A23A_SPEC>,
    #[doc = "0x10c - eMMC4.5 DDR Start Bit Detection Control Register"]
    pub emmc_ddr_sbit_det: crate::Reg<emmc_ddr_sbit_det::EMMC_DDR_SBIT_DET_SPEC>,
    _reserved33: [u8; 0x28],
    #[doc = "0x138 - Extended Command Register"]
    pub smhc_ext_cmd: crate::Reg<smhc_ext_cmd::SMHC_EXT_CMD_SPEC>,
    #[doc = "0x13c - Extended Response Register"]
    pub smhc_ext_resp: crate::Reg<smhc_ext_resp::SMHC_EXT_RESP_SPEC>,
    #[doc = "0x140 - Drive Delay Control Register"]
    pub smhc_drv_dl: crate::Reg<smhc_drv_dl::SMHC_DRV_DL_SPEC>,
    #[doc = "0x144 - Sample Delay Control Register"]
    pub smhc_smap_dl: crate::Reg<smhc_smap_dl::SMHC_SMAP_DL_SPEC>,
    #[doc = "0x148 - Data Strobe Delay Control Register"]
    pub smhc_ds_dl: crate::Reg<smhc_ds_dl::SMHC_DS_DL_SPEC>,
    #[doc = "0x14c - HS400 Delay Control Register"]
    pub smhc_hs400_dl: crate::Reg<smhc_hs400_dl::SMHC_HS400_DL_SPEC>,
    _reserved39: [u8; 0xb0],
