...
pub struct R(crate::R<TVD_HLOCK2_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<TVD_HLOCK2_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<TVD_HLOCK2_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<TVD_HLOCK2_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `tvd_hlock2` writer"]
pub struct W(crate::W<TVD_HLOCK2_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<TVD_HLOCK2_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<TVD_HLOCK2_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<TVD_HLOCK2_SPEC>) -> Self {
        W(writer)
    }
}
impl W {
