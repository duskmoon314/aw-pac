...
pub type R = crate::R<TVD_EN_SPEC>;
#[doc = "Register `tvd_en` writer"]
pub type W = crate::W<TVD_EN_SPEC>;
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        write!(f, "{}", self.bits())
    }
}
impl core::fmt::Debug for crate::generic::Reg<TVD_EN_SPEC> {
