...
pub struct R(crate::R<TVD_DEBUG1_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<TVD_DEBUG1_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<TVD_DEBUG1_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<TVD_DEBUG1_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `tvd_debug1` writer"]
pub struct W(crate::W<TVD_DEBUG1_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<TVD_DEBUG1_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<TVD_DEBUG1_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<TVD_DEBUG1_SPEC>) -> Self {
        W(writer)
    }
}
impl W {
