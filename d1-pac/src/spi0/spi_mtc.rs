...
pub type R = crate::R<SPI_MTC_SPEC>;
#[doc = "Register `spi_mtc` writer"]
pub type W = crate::W<SPI_MTC_SPEC>;
#[doc = "Field `mwtc` reader - Master Write Transmit Counter"]
pub type MWTC_R = crate::FieldReader<u32>;
#[doc = "Field `mwtc` writer - Master Write Transmit Counter"]
pub type MWTC_W<'a, REG> = crate::FieldWriter<'a, REG, 24, u32>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn mwtc(&mut self) -> MWTC_W<SPI_MTC_SPEC> {
        MWTC_W::new(self, 0)
    }
...
#[doc = "SPI Master Transmit Counter Register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`spi_mtc::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`spi_mtc::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
