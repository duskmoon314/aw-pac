...
pub struct R(crate::R<AC_ADC_DRC_RPFLRT_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<AC_ADC_DRC_RPFLRT_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<AC_ADC_DRC_RPFLRT_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<AC_ADC_DRC_RPFLRT_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `ac_adc_drc_rpflrt` writer"]
pub struct W(crate::W<AC_ADC_DRC_RPFLRT_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<AC_ADC_DRC_RPFLRT_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<AC_ADC_DRC_RPFLRT_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<AC_ADC_DRC_RPFLRT_SPEC>) -> Self {
        W(writer)
    }
}
