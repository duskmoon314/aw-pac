...
pub type R = crate::R<AC_ADC_DRC_MNGLS_SPEC>;
#[doc = "Register `ac_adc_drc_mngls` writer"]
pub type W = crate::W<AC_ADC_DRC_MNGLS_SPEC>;
...
pub type ADC_DRC_MNGLS_R = crate::FieldReader<u16>;
...
pub type ADC_DRC_MNGLS_W<'a, REG> = crate::FieldWriter<'a, REG, 16, u16>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn adc_drc_mngls(&mut self) -> ADC_DRC_MNGLS_W<AC_ADC_DRC_MNGLS_SPEC> {
        ADC_DRC_MNGLS_W::new(self, 0)
    }
...
#[doc = "ADC DRC MIN Gain Low Setting Register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`ac_adc_drc_mngls::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`ac_adc_drc_mngls::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
