...
pub type R = crate::R<AC_DAC_DRC_RPFLRT_SPEC>;
#[doc = "Register `ac_dac_drc_rpflrt` writer"]
pub type W = crate::W<AC_DAC_DRC_RPFLRT_SPEC>;
...
pub type DAC_DRC_RPFLRT_R = crate::FieldReader<u16>;
...
pub type DAC_DRC_RPFLRT_W<'a, REG> = crate::FieldWriter<'a, REG, 16, u16>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn dac_drc_rpflrt(&mut self) -> DAC_DRC_RPFLRT_W<AC_DAC_DRC_RPFLRT_SPEC> {
        DAC_DRC_RPFLRT_W::new(self, 0)
    }
