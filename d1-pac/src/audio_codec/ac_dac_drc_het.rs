...
pub struct R(crate::R<AC_DAC_DRC_HET_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<AC_DAC_DRC_HET_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<AC_DAC_DRC_HET_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<AC_DAC_DRC_HET_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `ac_dac_drc_het` writer"]
pub struct W(crate::W<AC_DAC_DRC_HET_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<AC_DAC_DRC_HET_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<AC_DAC_DRC_HET_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<AC_DAC_DRC_HET_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type DAC_DRC_HET_R = crate::FieldReader<u16, u16>;
...
pub type DAC_DRC_HET_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, AC_DAC_DRC_HET_SPEC, u16, u16, 16, O>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn dac_drc_het(&mut self) -> DAC_DRC_HET_W<0> {
        DAC_DRC_HET_W::new(self)
    }
