...
pub struct R(crate::R<AC_DAC_DRC_LKC_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<AC_DAC_DRC_LKC_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<AC_DAC_DRC_LKC_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<AC_DAC_DRC_LKC_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `ac_dac_drc_lkc` writer"]
pub struct W(crate::W<AC_DAC_DRC_LKC_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<AC_DAC_DRC_LKC_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<AC_DAC_DRC_LKC_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<AC_DAC_DRC_LKC_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type DAC_DRC_LKC_R = crate::FieldReader<u16, u16>;
...
pub type DAC_DRC_LKC_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, AC_DAC_DRC_LKC_SPEC, u16, u16, 16, O>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn dac_drc_lkc(&mut self) -> DAC_DRC_LKC_W<0> {
        DAC_DRC_LKC_W::new(self)
    }
