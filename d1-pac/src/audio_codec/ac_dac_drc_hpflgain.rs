...
pub struct R(crate::R<AC_DAC_DRC_HPFLGAIN_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<AC_DAC_DRC_HPFLGAIN_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<AC_DAC_DRC_HPFLGAIN_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<AC_DAC_DRC_HPFLGAIN_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `ac_dac_drc_hpflgain` writer"]
pub struct W(crate::W<AC_DAC_DRC_HPFLGAIN_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<AC_DAC_DRC_HPFLGAIN_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<AC_DAC_DRC_HPFLGAIN_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<AC_DAC_DRC_HPFLGAIN_SPEC>) -> Self {
        W(writer)
    }
}
#[doc = "Field `dac_drc_hpflgain` reader - The gain of HPF coefficient. The format is 3.24. (gain = 1)"]
pub type DAC_DRC_HPFLGAIN_R = crate::FieldReader<u16, u16>;
#[doc = "Field `dac_drc_hpflgain` writer - The gain of HPF coefficient. The format is 3.24. (gain = 1)"]
pub type DAC_DRC_HPFLGAIN_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, AC_DAC_DRC_HPFLGAIN_SPEC, u16, u16, 16, O>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn dac_drc_hpflgain(&mut self) -> DAC_DRC_HPFLGAIN_W<0> {
        DAC_DRC_HPFLGAIN_W::new(self)
    }
