#[doc = "Register `ac_adc_drc_hope` reader"]
pub type R = crate::R<AC_ADC_DRC_HOPE_SPEC>;
#[doc = "Register `ac_adc_drc_hope` writer"]
pub type W = crate::W<AC_ADC_DRC_HOPE_SPEC>;
...
pub type ADC_DRC_HOPE_R = crate::FieldReader<u16>;
...
pub type ADC_DRC_HOPE_W<'a, REG> = crate::FieldWriter<'a, REG, 16, u16>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn adc_drc_hope(&mut self) -> ADC_DRC_HOPE_W<AC_ADC_DRC_HOPE_SPEC> {
        ADC_DRC_HOPE_W::new(self, 0)
    }
...
#[doc = "ADC DRC Expander High Output at Expander Threshold\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`ac_adc_drc_hope::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`ac_adc_drc_hope::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct AC_ADC_DRC_HOPE_SPEC;
impl crate::RegisterSpec for AC_ADC_DRC_HOPE_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`ac_adc_drc_hope::R`](R) reader structure"]
impl crate::Readable for AC_ADC_DRC_HOPE_SPEC {}
