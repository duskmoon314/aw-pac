...
pub type DAC_DRC_LPFLAT_R = crate::FieldReader<u16, u16>;
...
pub type DAC_DRC_LPFLAT_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, AC_DAC_DRC_LPFLAT_SPEC, u16, u16, 16, O>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn dac_drc_lpflat(&mut self) -> DAC_DRC_LPFLAT_W<0> {
        DAC_DRC_LPFLAT_W::new(self)
    }
