...
pub type R = crate::R<AC_ADC_DRC_HHPFC_SPEC>;
#[doc = "Register `ac_adc_drc_hhpfc` writer"]
pub type W = crate::W<AC_ADC_DRC_HHPFC_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn hhpfc(&mut self) -> HHPFC_W<AC_ADC_DRC_HHPFC_SPEC> {
        HHPFC_W::new(self, 0)
    }
...
#[doc = "ADC DRC High HPF Coef Register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`ac_adc_drc_hhpfc::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`ac_adc_drc_hhpfc::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
