...
impl<'a, const O: u8> DAC_DRC_ET_EN_W<'a, O> {
    ...
    pub fn d_isabled(self) -> &'a mut W {
        self.variant(DAC_DRC_ET_EN_A::D_ISABLED)
    }
    #[doc = "Enabled\n\nWhen the bit is disabled, Ke and OPE parameter is unused."]
    #[inline(always)]
    pub fn e_nabled(self) -> &'a mut W {
        self.variant(DAC_DRC_ET_EN_A::E_NABLED)
    }
}
...
impl DAC_DRC_LT_EN_R {
    ...
    pub fn variant(&self) -> DAC_DRC_LT_EN_A {
        match self.bits {
            false => DAC_DRC_LT_EN_A::D_ISABLED,
            true => DAC_DRC_LT_EN_A::E_NABLED,
        }
    }
    #[doc = "Checks if the value of the field is `D_ISABLED`"]
    #[inline(always)]
    pub fn is_d_isabled(&self) -> bool {
        *self == DAC_DRC_LT_EN_A::D_ISABLED
    }
    #[doc = "Checks if the value of the field is `E_NABLED`"]
    #[inline(always)]
    pub fn is_e_nabled(&self) -> bool {
        *self == DAC_DRC_LT_EN_A::E_NABLED
    }
}
...
impl<'a, const O: u8> DAC_DRC_LT_EN_W<'a, O> {
    ...
    #[inline(always)]
    pub fn d_isabled(self) -> &'a mut W {
        self.variant(DAC_DRC_LT_EN_A::D_ISABLED)
    }
    #[doc = "Enabled\n\nWhen the bit is disabled, Kl and OPL parameter is unused."]
    #[inline(always)]
    pub fn e_nabled(self) -> &'a mut W {
        self.variant(DAC_DRC_LT_EN_A::E_NABLED)
    }
}
...
impl DAC_DRC_DELAY_FUNC_EN_R {
    ...
    pub fn variant(&self) -> DAC_DRC_DELAY_FUNC_EN_A {
        match self.bits {
            false => DAC_DRC_DELAY_FUNC_EN_A::D_ISABLED,
            true => DAC_DRC_DELAY_FUNC_EN_A::E_NABLED,
        }
    }
    #[doc = "Checks if the value of the field is `D_ISABLED`"]
    #[inline(always)]
    pub fn is_d_isabled(&self) -> bool {
        *self == DAC_DRC_DELAY_FUNC_EN_A::D_ISABLED
    }
    #[doc = "Checks if the value of the field is `E_NABLED`"]
    #[inline(always)]
    pub fn is_e_nabled(&self) -> bool {
        *self == DAC_DRC_DELAY_FUNC_EN_A::E_NABLED
    }
}
...
impl<'a, const O: u8> DAC_DRC_DELAY_FUNC_EN_W<'a, O> {
    ...
    #[inline(always)]
    pub fn d_isabled(self) -> &'a mut W {
        self.variant(DAC_DRC_DELAY_FUNC_EN_A::D_ISABLED)
    }
    #[doc = "Enabled\n\nWhen the bit is disabled, the signal delay time is unused."]
    #[inline(always)]
    pub fn e_nabled(self) -> &'a mut W {
        self.variant(DAC_DRC_DELAY_FUNC_EN_A::E_NABLED)
    }
}
...
impl DAC_DRC_DETECT_NOISE_EN_R {
    ...
    pub fn variant(&self) -> DAC_DRC_DETECT_NOISE_EN_A {
        match self.bits {
            false => DAC_DRC_DETECT_NOISE_EN_A::D_ISABLED,
            true => DAC_DRC_DETECT_NOISE_EN_A::E_NABLED,
        }
    }
    #[doc = "Checks if the value of the field is `D_ISABLED`"]
    #[inline(always)]
    pub fn is_d_isabled(&self) -> bool {
        *self == DAC_DRC_DETECT_NOISE_EN_A::D_ISABLED
    }
    #[doc = "Checks if the value of the field is `E_NABLED`"]
    #[inline(always)]
    pub fn is_e_nabled(&self) -> bool {
        *self == DAC_DRC_DETECT_NOISE_EN_A::E_NABLED
    }
}
...
impl<'a, const O: u8> DAC_DRC_DETECT_NOISE_EN_W<'a, O> {
    ...
    #[inline(always)]
    pub fn d_isabled(self) -> &'a mut W {
        self.variant(DAC_DRC_DETECT_NOISE_EN_A::D_ISABLED)
    }
    #[doc = "Enabled"]
    #[inline(always)]
    pub fn e_nabled(self) -> &'a mut W {
        self.variant(DAC_DRC_DETECT_NOISE_EN_A::E_NABLED)
    }
}
...
impl DAC_DRC_GAIN_MIN_LIMIT_EN_R {
    ...
    pub fn variant(&self) -> DAC_DRC_GAIN_MIN_LIMIT_EN_A {
        match self.bits {
            false => DAC_DRC_GAIN_MIN_LIMIT_EN_A::D_ISABLED,
            true => DAC_DRC_GAIN_MIN_LIMIT_EN_A::E_NABLED,
        }
    }
    #[doc = "Checks if the value of the field is `D_ISABLED`"]
    #[inline(always)]
    pub fn is_d_isabled(&self) -> bool {
        *self == DAC_DRC_GAIN_MIN_LIMIT_EN_A::D_ISABLED
    }
    #[doc = "Checks if the value of the field is `E_NABLED`"]
    #[inline(always)]
    pub fn is_e_nabled(&self) -> bool {
        *self == DAC_DRC_GAIN_MIN_LIMIT_EN_A::E_NABLED
    }
}
...
impl<'a, const O: u8> DAC_DRC_GAIN_MIN_LIMIT_EN_W<'a, O> {
    ...
    #[inline(always)]
    pub fn d_isabled(self) -> &'a mut W {
        self.variant(DAC_DRC_GAIN_MIN_LIMIT_EN_A::D_ISABLED)
    }
    #[doc = "Enabled"]
    #[inline(always)]
    pub fn e_nabled(self) -> &'a mut W {
        self.variant(DAC_DRC_GAIN_MIN_LIMIT_EN_A::E_NABLED)
    }
}
...
impl DAC_DRC_GAIN_MAX_LIMIT_EN_R {
    ...
    pub fn variant(&self) -> DAC_DRC_GAIN_MAX_LIMIT_EN_A {
        match self.bits {
            false => DAC_DRC_GAIN_MAX_LIMIT_EN_A::D_ISABLED,
            true => DAC_DRC_GAIN_MAX_LIMIT_EN_A::E_NABLED,
        }
    }
    #[doc = "Checks if the value of the field is `D_ISABLED`"]
    #[inline(always)]
    pub fn is_d_isabled(&self) -> bool {
        *self == DAC_DRC_GAIN_MAX_LIMIT_EN_A::D_ISABLED
    }
    #[doc = "Checks if the value of the field is `E_NABLED`"]
    #[inline(always)]
    pub fn is_e_nabled(&self) -> bool {
        *self == DAC_DRC_GAIN_MAX_LIMIT_EN_A::E_NABLED
    }
}
...
impl<'a, const O: u8> DAC_DRC_GAIN_MAX_LIMIT_EN_W<'a, O> {
    ...
    #[inline(always)]
    pub fn d_isabled(self) -> &'a mut W {
        self.variant(DAC_DRC_GAIN_MAX_LIMIT_EN_A::D_ISABLED)
    }
    #[doc = "Enabled"]
    #[inline(always)]
    pub fn e_nabled(self) -> &'a mut W {
        self.variant(DAC_DRC_GAIN_MAX_LIMIT_EN_A::E_NABLED)
    }
}
...
impl DRC_DEALY_BUFFER_DATA_OUTPUT_STATE_R {
    ...
    pub fn variant(&self) -> DRC_DEALY_BUFFER_DATA_OUTPUT_STATE_A {
        match self.bits {
            false => DRC_DEALY_BUFFER_DATA_OUTPUT_STATE_A::N_OT_COMPLETED,
            true => DRC_DEALY_BUFFER_DATA_OUTPUT_STATE_A::C_OMPLETED,
        }
    }
    #[doc = "Checks if the value of the field is `N_OT_COMPLETED`"]
    #[inline(always)]
    pub fn is_n_ot_completed(&self) -> bool {
        *self == DRC_DEALY_BUFFER_DATA_OUTPUT_STATE_A::N_OT_COMPLETED
    }
    #[doc = "Checks if the value of the field is `C_OMPLETED`"]
    #[inline(always)]
    pub fn is_c_ompleted(&self) -> bool {
        *self == DRC_DEALY_BUFFER_DATA_OUTPUT_STATE_A::C_OMPLETED
    }
}
impl R {
