...
pub type R = crate::R<AC_DAC_DRC_CTRL_SPEC>;
#[doc = "Register `ac_dac_drc_ctrl` writer"]
pub type W = crate::W<AC_DAC_DRC_CTRL_SPEC>;
...
impl DAC_DRC_ET_EN_R {
    ...
    #[inline(always)]
    pub const fn variant(&self) -> DAC_DRC_ET_EN_A {
        match self.bits {
...
pub type DAC_DRC_ET_EN_W<'a, REG> = crate::BitWriter<'a, REG, DAC_DRC_ET_EN_A>;
impl<'a, REG> DAC_DRC_ET_EN_W<'a, REG>
where
...
impl DAC_DRC_LT_EN_R {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
    pub const fn variant(&self) -> DAC_DRC_LT_EN_A {
        match self.bits {
...
pub type DAC_DRC_LT_EN_W<'a, REG> = crate::BitWriter<'a, REG, DAC_DRC_LT_EN_A>;
impl<'a, REG> DAC_DRC_LT_EN_W<'a, REG>
where
    REG: crate::Writable + crate::RegisterSpec,
{
    #[doc = "Disabled"]
...
impl DAC_DRC_DELAY_FUNC_EN_R {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
    pub const fn variant(&self) -> DAC_DRC_DELAY_FUNC_EN_A {
        match self.bits {
...
pub type DAC_DRC_DELAY_FUNC_EN_W<'a, REG> = crate::BitWriter<'a, REG, DAC_DRC_DELAY_FUNC_EN_A>;
impl<'a, REG> DAC_DRC_DELAY_FUNC_EN_W<'a, REG>
where
    REG: crate::Writable + crate::RegisterSpec,
{
    #[doc = "Disabled"]
...
impl DAC_DRC_SIGNAL_FUNC_SEL_R {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
    pub const fn variant(&self) -> DAC_DRC_SIGNAL_FUNC_SEL_A {
        match self.bits {
...
pub type DAC_DRC_SIGNAL_FUNC_SEL_W<'a, REG> = crate::BitWriter<'a, REG, DAC_DRC_SIGNAL_FUNC_SEL_A>;
impl<'a, REG> DAC_DRC_SIGNAL_FUNC_SEL_W<'a, REG>
where
    REG: crate::Writable + crate::RegisterSpec,
{
    #[doc = "RMS filter"]
...
impl DAC_DRC_DETECT_NOISE_EN_R {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
    pub const fn variant(&self) -> DAC_DRC_DETECT_NOISE_EN_A {
        match self.bits {
...
pub type DAC_DRC_DETECT_NOISE_EN_W<'a, REG> = crate::BitWriter<'a, REG, DAC_DRC_DETECT_NOISE_EN_A>;
impl<'a, REG> DAC_DRC_DETECT_NOISE_EN_W<'a, REG>
where
    REG: crate::Writable + crate::RegisterSpec,
{
    #[doc = "Disabled"]
...
impl DAC_DRC_GAIN_MIN_LIMIT_EN_R {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
    pub const fn variant(&self) -> DAC_DRC_GAIN_MIN_LIMIT_EN_A {
        match self.bits {
...
pub type DAC_DRC_GAIN_MIN_LIMIT_EN_W<'a, REG> =
    crate::BitWriter<'a, REG, DAC_DRC_GAIN_MIN_LIMIT_EN_A>;
impl<'a, REG> DAC_DRC_GAIN_MIN_LIMIT_EN_W<'a, REG>
where
    REG: crate::Writable + crate::RegisterSpec,
{
    #[doc = "Disabled"]
...
impl DAC_DRC_GAIN_MAX_LIMIT_EN_R {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
    pub const fn variant(&self) -> DAC_DRC_GAIN_MAX_LIMIT_EN_A {
        match self.bits {
...
pub type DAC_DRC_GAIN_MAX_LIMIT_EN_W<'a, REG> =
    crate::BitWriter<'a, REG, DAC_DRC_GAIN_MAX_LIMIT_EN_A>;
impl<'a, REG> DAC_DRC_GAIN_MAX_LIMIT_EN_W<'a, REG>
where
    REG: crate::Writable + crate::RegisterSpec,
{
    #[doc = "Disabled"]
...
impl DAC_DRC_DELAY_BUF_EN_R {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
    pub const fn variant(&self) -> DAC_DRC_DELAY_BUF_EN_A {
        match self.bits {
...
pub type DAC_DRC_DELAY_BUF_EN_W<'a, REG> = crate::BitWriter<'a, REG, DAC_DRC_DELAY_BUF_EN_A>;
impl<'a, REG> DAC_DRC_DELAY_BUF_EN_W<'a, REG>
where
    REG: crate::Writable + crate::RegisterSpec,
{
    #[doc = "Do not use the buffer."]
...
pub type SIGNAL_DELAY_TIME_SETTING_R = crate::FieldReader;
#[doc = "Field `signal_delay_time_setting` writer - Signal delay time setting\n\nDelay time = 8*(n + 1) fs, n less than 30\n\nWhen the delay function is disabled, the signal delay time is unused."]
pub type SIGNAL_DELAY_TIME_SETTING_W<'a, REG> = crate::FieldWriter<'a, REG, 6>;
...
impl DRC_DEALY_BUFFER_DATA_OUTPUT_STATE_R {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
    pub const fn variant(&self) -> DRC_DEALY_BUFFER_DATA_OUTPUT_STATE_A {
        match self.bits {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn dac_drc_et_en(&mut self) -> DAC_DRC_ET_EN_W<AC_DAC_DRC_CTRL_SPEC> {
        DAC_DRC_ET_EN_W::new(self, 0)
    }
    #[doc = "Bit 1 - DRC LT enable"]
    #[inline(always)]
    #[must_use]
    pub fn dac_drc_lt_en(&mut self) -> DAC_DRC_LT_EN_W<AC_DAC_DRC_CTRL_SPEC> {
        DAC_DRC_LT_EN_W::new(self, 1)
    }
    #[doc = "Bit 2 - Delay function enable"]
    #[inline(always)]
    #[must_use]
    pub fn dac_drc_delay_func_en(&mut self) -> DAC_DRC_DELAY_FUNC_EN_W<AC_DAC_DRC_CTRL_SPEC> {
        DAC_DRC_DELAY_FUNC_EN_W::new(self, 2)
    }
    #[doc = "Bit 3 - Signal function select\n\nWhen the signal function selects the Peak filter, the RMS parameter is unused. (AC_DRC_LRMSHAT, AC_DRC_LRMSLAT, AC_DRC_LRMSHAT, AC_DRC_LRMSLAT)\n\nWhen the signal function selects the RMS filter, the Peak filter parameter is unused. (AC_DRC_LPFHAT, AC_DRC_LPFLAT, AC_DRC_RPFHAT, AC_DRC_RPFLAT, AC_DRC_LPFHRT, AC_DRC_LPFLRT, AC_DRC_RPFHRT, and AC_DRC_RPFLRT)"]
    #[inline(always)]
    #[must_use]
    pub fn dac_drc_signal_func_sel(&mut self) -> DAC_DRC_SIGNAL_FUNC_SEL_W<AC_DAC_DRC_CTRL_SPEC> {
        DAC_DRC_SIGNAL_FUNC_SEL_W::new(self, 3)
    }
    #[doc = "Bit 4 - Control the DRC to detect noise when ET is enabled."]
    #[inline(always)]
    #[must_use]
    pub fn dac_drc_detect_noise_en(&mut self) -> DAC_DRC_DETECT_NOISE_EN_W<AC_DAC_DRC_CTRL_SPEC> {
        DAC_DRC_DETECT_NOISE_EN_W::new(self, 4)
    }
    #[doc = "Bit 5 - DRC gain min limit enable When this function is enabled, it will overwrite the noise detect function."]
    #[inline(always)]
    #[must_use]
    pub fn dac_drc_gain_min_limit_en(
        &mut self,
    ) -> DAC_DRC_GAIN_MIN_LIMIT_EN_W<AC_DAC_DRC_CTRL_SPEC> {
        DAC_DRC_GAIN_MIN_LIMIT_EN_W::new(self, 5)
    }
    #[doc = "Bit 6 - DRC gain max limit enable"]
    #[inline(always)]
    #[must_use]
    pub fn dac_drc_gain_max_limit_en(
        &mut self,
    ) -> DAC_DRC_GAIN_MAX_LIMIT_EN_W<AC_DAC_DRC_CTRL_SPEC> {
        DAC_DRC_GAIN_MAX_LIMIT_EN_W::new(self, 6)
    }
    #[doc = "Bit 7 - The delay buffer use or not when the DRC is disabled and the DRC buffer data output completely."]
    #[inline(always)]
    #[must_use]
    pub fn dac_drc_delay_buf_en(&mut self) -> DAC_DRC_DELAY_BUF_EN_W<AC_DAC_DRC_CTRL_SPEC> {
        DAC_DRC_DELAY_BUF_EN_W::new(self, 7)
    }
    #[doc = "Bits 8:13 - Signal delay time setting\n\nDelay time = 8*(n + 1) fs, n less than 30\n\nWhen the delay function is disabled, the signal delay time is unused."]
    #[inline(always)]
    #[must_use]
    pub fn signal_delay_time_setting(
        &mut self,
    ) -> SIGNAL_DELAY_TIME_SETTING_W<AC_DAC_DRC_CTRL_SPEC> {
        SIGNAL_DELAY_TIME_SETTING_W::new(self, 8)
    }
