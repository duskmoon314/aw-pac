...
pub struct R(crate::R<AC_ADC_DRC_MNGHS_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<AC_ADC_DRC_MNGHS_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<AC_ADC_DRC_MNGHS_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<AC_ADC_DRC_MNGHS_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `ac_adc_drc_mnghs` writer"]
pub struct W(crate::W<AC_ADC_DRC_MNGHS_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<AC_ADC_DRC_MNGHS_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<AC_ADC_DRC_MNGHS_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<AC_ADC_DRC_MNGHS_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type ADC_DRC_MNGHS_R = crate::FieldReader<u16, u16>;
...
pub type ADC_DRC_MNGHS_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, AC_ADC_DRC_MNGHS_SPEC, u16, u16, 16, O>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn adc_drc_mnghs(&mut self) -> ADC_DRC_MNGHS_W<0> {
        ADC_DRC_MNGHS_W::new(self)
    }
