...
pub type R = crate::R<AC_ADC_DRC_LPFHAT_SPEC>;
#[doc = "Register `ac_adc_drc_lpfhat` writer"]
pub type W = crate::W<AC_ADC_DRC_LPFHAT_SPEC>;
...
pub type ADC_DRC_LPFHAT_R = crate::FieldReader<u16>;
...
pub type ADC_DRC_LPFHAT_W<'a, REG> = crate::FieldWriter<'a, REG, 11, u16>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn adc_drc_lpfhat(&mut self) -> ADC_DRC_LPFHAT_W<AC_ADC_DRC_LPFHAT_SPEC> {
        ADC_DRC_LPFHAT_W::new(self, 0)
    }
