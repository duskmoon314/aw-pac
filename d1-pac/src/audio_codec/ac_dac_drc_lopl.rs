...
pub type R = crate::R<AC_DAC_DRC_LOPL_SPEC>;
#[doc = "Register `ac_dac_drc_lopl` writer"]
pub type W = crate::W<AC_DAC_DRC_LOPL_SPEC>;
...
pub type DAC_DRC_LOPL_R = crate::FieldReader<u16>;
...
pub type DAC_DRC_LOPL_W<'a, REG> = crate::FieldWriter<'a, REG, 16, u16>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn dac_drc_lopl(&mut self) -> DAC_DRC_LOPL_W<AC_DAC_DRC_LOPL_SPEC> {
        DAC_DRC_LOPL_W::new(self, 0)
    }
...
#[doc = "DAC DRC Limiter Low Output at Limiter Threshold\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`ac_dac_drc_lopl::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`ac_dac_drc_lopl::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
