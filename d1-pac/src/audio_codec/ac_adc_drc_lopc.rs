...
pub type R = crate::R<AC_ADC_DRC_LOPC_SPEC>;
#[doc = "Register `ac_adc_drc_lopc` writer"]
pub type W = crate::W<AC_ADC_DRC_LOPC_SPEC>;
...
pub type ADC_DRC_LOPC_R = crate::FieldReader<u16>;
...
pub type ADC_DRC_LOPC_W<'a, REG> = crate::FieldWriter<'a, REG, 16, u16>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn adc_drc_lopc(&mut self) -> ADC_DRC_LOPC_W<AC_ADC_DRC_LOPC_SPEC> {
        ADC_DRC_LOPC_W::new(self, 0)
    }
