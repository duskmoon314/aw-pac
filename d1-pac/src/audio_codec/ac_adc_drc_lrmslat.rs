...
pub type R = crate::R<AC_ADC_DRC_LRMSLAT_SPEC>;
#[doc = "Register `ac_adc_drc_lrmslat` writer"]
pub type W = crate::W<AC_ADC_DRC_LRMSLAT_SPEC>;
...
pub type ADC_DRC_LRMSLAT_R = crate::FieldReader<u16>;
...
pub type ADC_DRC_LRMSLAT_W<'a, REG> = crate::FieldWriter<'a, REG, 16, u16>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn adc_drc_lrmslat(&mut self) -> ADC_DRC_LRMSLAT_W<AC_ADC_DRC_LRMSLAT_SPEC> {
        ADC_DRC_LRMSLAT_W::new(self, 0)
    }
