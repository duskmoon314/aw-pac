...
pub struct R(crate::R<AC_ADC_DRC_LET_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<AC_ADC_DRC_LET_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<AC_ADC_DRC_LET_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<AC_ADC_DRC_LET_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `ac_adc_drc_let` writer"]
pub struct W(crate::W<AC_ADC_DRC_LET_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<AC_ADC_DRC_LET_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<AC_ADC_DRC_LET_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<AC_ADC_DRC_LET_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type ADC_DRC_LET_R = crate::FieldReader<u16, u16>;
...
pub type ADC_DRC_LET_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, AC_ADC_DRC_LET_SPEC, u16, u16, 16, O>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn adc_drc_let(&mut self) -> ADC_DRC_LET_W<0> {
        ADC_DRC_LET_W::new(self)
    }
