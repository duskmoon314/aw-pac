#[doc = "Register `ac_dac_drc_hkn` reader"]
pub type R = crate::R<AC_DAC_DRC_HKN_SPEC>;
#[doc = "Register `ac_dac_drc_hkn` writer"]
pub type W = crate::W<AC_DAC_DRC_HKN_SPEC>;
...
pub type DAC_DRC_HKN_R = crate::FieldReader<u16>;
...
pub type DAC_DRC_HKN_W<'a, REG> = crate::FieldWriter<'a, REG, 16, u16>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn dac_drc_hkn(&mut self) -> DAC_DRC_HKN_W<AC_DAC_DRC_HKN_SPEC> {
        DAC_DRC_HKN_W::new(self, 0)
    }
...
#[doc = "DAC DRC Linear Slope High Setting Register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`ac_dac_drc_hkn::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`ac_dac_drc_hkn::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct AC_DAC_DRC_HKN_SPEC;
impl crate::RegisterSpec for AC_DAC_DRC_HKN_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`ac_dac_drc_hkn::R`](R) reader structure"]
impl crate::Readable for AC_DAC_DRC_HKN_SPEC {}
#[doc = "`write(|w| ..)` method takes [`ac_dac_drc_hkn::W`](W) writer structure"]
