...
pub type R = crate::R<AC_DAC_DRC_LHPFC_SPEC>;
#[doc = "Register `ac_dac_drc_lhpfc` writer"]
pub type W = crate::W<AC_DAC_DRC_LHPFC_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn lhpfc(&mut self) -> LHPFC_W<AC_DAC_DRC_LHPFC_SPEC> {
        LHPFC_W::new(self, 0)
    }
