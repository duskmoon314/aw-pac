...
pub type R = crate::R<AC_ADC_DRC_HKL_SPEC>;
#[doc = "Register `ac_adc_drc_hkl` writer"]
pub type W = crate::W<AC_ADC_DRC_HKL_SPEC>;
...
pub type ADC_DRC_HKL_R = crate::FieldReader<u16>;
...
pub type ADC_DRC_HKL_W<'a, REG> = crate::FieldWriter<'a, REG, 14, u16>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn adc_drc_hkl(&mut self) -> ADC_DRC_HKL_W<AC_ADC_DRC_HKL_SPEC> {
        ADC_DRC_HKL_W::new(self, 0)
    }
