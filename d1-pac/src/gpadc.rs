...
#[doc = "gp_sr_con (rw) register accessor: an alias for `Reg<GP_SR_CON_SPEC>`"]
pub type GP_SR_CON = crate::Reg<gp_sr_con::GP_SR_CON_SPEC>;
#[doc = "GPADC Sample Rate Configure Register"]
pub mod gp_sr_con;
#[doc = "gp_ctrl (rw) register accessor: an alias for `Reg<GP_CTRL_SPEC>`"]
pub type GP_CTRL = crate::Reg<gp_ctrl::GP_CTRL_SPEC>;
#[doc = "GPADC Control Register"]
pub mod gp_ctrl;
#[doc = "gp_cs_en (rw) register accessor: an alias for `Reg<GP_CS_EN_SPEC>`"]
pub type GP_CS_EN = crate::Reg<gp_cs_en::GP_CS_EN_SPEC>;
#[doc = "GPADC Compare and Select Enable Register"]
pub mod gp_cs_en;
#[doc = "gp_fifo_intc (rw) register accessor: an alias for `Reg<GP_FIFO_INTC_SPEC>`"]
...
#[doc = "gp_fifo_ints (rw) register accessor: an alias for `Reg<GP_FIFO_INTS_SPEC>`"]
...
#[doc = "gp_fifo_data (rw) register accessor: an alias for `Reg<GP_FIFO_DATA_SPEC>`"]
pub type GP_FIFO_DATA = crate::Reg<gp_fifo_data::GP_FIFO_DATA_SPEC>;
#[doc = "GPADC FIFO Data Register"]
pub mod gp_fifo_data;
#[doc = "gp_cdata (rw) register accessor: an alias for `Reg<GP_CDATA_SPEC>`"]
pub type GP_CDATA = crate::Reg<gp_cdata::GP_CDATA_SPEC>;
#[doc = "GPADC Calibration Data Register"]
pub mod gp_cdata;
#[doc = "gp_datal_intc (rw) register accessor: an alias for `Reg<GP_DATAL_INTC_SPEC>`"]
...
#[doc = "gp_datah_intc (rw) register accessor: an alias for `Reg<GP_DATAH_INTC_SPEC>`"]
...
#[doc = "gp_data_intc (rw) register accessor: an alias for `Reg<GP_DATA_INTC_SPEC>`"]
...
#[doc = "gp_datal_ints (rw) register accessor: an alias for `Reg<GP_DATAL_INTS_SPEC>`"]
...
#[doc = "gp_datah_ints (rw) register accessor: an alias for `Reg<GP_DATAH_INTS_SPEC>`"]
...
#[doc = "gp_data_ints (rw) register accessor: an alias for `Reg<GP_DATA_INTS_SPEC>`"]
...
#[doc = "gp_ch0_cmp_data (rw) register accessor: an alias for `Reg<GP_CH0_CMP_DATA_SPEC>`"]
...
#[doc = "gp_ch1_cmp_data (rw) register accessor: an alias for `Reg<GP_CH1_CMP_DATA_SPEC>`"]
...
#[doc = "gp_ch0_data (rw) register accessor: an alias for `Reg<GP_CH0_DATA_SPEC>`"]
pub type GP_CH0_DATA = crate::Reg<gp_ch0_data::GP_CH0_DATA_SPEC>;
#[doc = "GPADC CH0 Data Register"]
pub mod gp_ch0_data;
#[doc = "gp_ch1_data (rw) register accessor: an alias for `Reg<GP_CH1_DATA_SPEC>`"]
