...
#[doc = "Register `DMAC_CUR_DEST_REG%s` writer"]
pub struct W(crate::W<DMAC_CUR_DEST_REG_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<DMAC_CUR_DEST_REG_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<DMAC_CUR_DEST_REG_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<DMAC_CUR_DEST_REG_SPEC>) -> Self {
        W(writer)
    }
}
impl W {
...
#[doc = "`write(|w| ..)` method takes [dmac_cur_dest_reg::W](W) writer structure"]
impl crate::Writable for DMAC_CUR_DEST_REG_SPEC {
    type Writer = W;
}
