...
impl From<crate::R<DMAC_IRQ_PEND_REG0_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<DMAC_IRQ_PEND_REG0_SPEC>) -> Self {
        R(reader)
    }
}
...
impl From<crate::W<DMAC_IRQ_PEND_REG0_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<DMAC_IRQ_PEND_REG0_SPEC>) -> Self {
        W(writer)
    }
}
...
#[doc = "Fields `DMA(0-7)_HLAF_IRQ_PEND` const generic writer - The IRQ pending bit for the half package interrupt of DMA"]
...
#[doc = "Fields `DMA(0-7)_PKG_IRQ_PEND` const generic writer - The IRQ pending bit for the package end interrupt of DMA"]
...
#[doc = "Fields `DMA(0-7)_QUEUE_IRQ_PEND` const generic writer - The IRQ pending bit for the queue end interrupt of DMA"]
...
#[doc = "DMAC IRQ Pending Register 0\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [dmac_irq_pend_reg0](index.html) module"]
pub struct DMAC_IRQ_PEND_REG0_SPEC;
impl crate::RegisterSpec for DMAC_IRQ_PEND_REG0_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [dmac_irq_pend_reg0::R](R) reader structure"]
impl crate::Readable for DMAC_IRQ_PEND_REG0_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [dmac_irq_pend_reg0::W](W) writer structure"]
