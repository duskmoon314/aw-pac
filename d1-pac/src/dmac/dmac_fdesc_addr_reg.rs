...
#[doc = "Register `DMAC_FDESC_ADDR_REG%s` writer"]
pub struct W(crate::W<DMAC_FDESC_ADDR_REG_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<DMAC_FDESC_ADDR_REG_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<DMAC_FDESC_ADDR_REG_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<DMAC_FDESC_ADDR_REG_SPEC>) -> Self {
        W(writer)
    }
}
impl W {
...
#[doc = "`write(|w| ..)` method takes [dmac_fdesc_addr_reg::W](W) writer structure"]
impl crate::Writable for DMAC_FDESC_ADDR_REG_SPEC {
    type Writer = W;
}
