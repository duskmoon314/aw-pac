...
pub struct RegisterBlock {
    ...
    pub losc_ctrl: crate::Reg<losc_ctrl::LOSC_CTRL_SPEC>,
    #[doc = "0x04 - LOSC Auto Switch Status Register"]
    pub losc_auto_swt_sta: crate::Reg<losc_auto_swt_sta::LOSC_AUTO_SWT_STA_SPEC>,
    #[doc = "0x08 - Internal OSC Clock Pre-scalar Register"]
    pub intosc_clk_prescal: crate::Reg<intosc_clk_prescal::INTOSC_CLK_PRESCAL_SPEC>,
    _reserved3: [u8; 0x04],
    #[doc = "0x10 - RTC Year-Month-Day Register"]
    pub rtc_day: crate::Reg<rtc_day::RTC_DAY_SPEC>,
    #[doc = "0x14 - RTC Hour-Minute-Second Register"]
    pub rtc_hh_mm_ss: crate::Reg<rtc_hh_mm_ss::RTC_HH_MM_SS_SPEC>,
    _reserved5: [u8; 0x08],
    #[doc = "0x20 - Alarm 0 Day Setting Register"]
    pub alarm0_day_set: crate::Reg<alarm0_day_set::ALARM0_DAY_SET_SPEC>,
    #[doc = "0x24 - Alarm 0 Counter Current Value Register"]
    pub alarm0_cur_vlu: crate::Reg<alarm0_cur_vlu::ALARM0_CUR_VLU_SPEC>,
    #[doc = "0x28 - Alarm 0 Enable Register"]
    pub alarm0_enable: crate::Reg<alarm0_enable::ALARM0_ENABLE_SPEC>,
    ...
    pub alarm0_irq_sta: crate::Reg<alarm0_irq_sta::ALARM0_IRQ_STA_SPEC>,
    _reserved10: [u8; 0x1c],
    #[doc = "0x50 - Alarm Configuration Register"]
    pub alarm_config: crate::Reg<alarm_config::ALARM_CONFIG_SPEC>,
    _reserved11: [u8; 0x0c],
    #[doc = "0x60 - 32K Fanout Control Gating Register"]
    pub fout_32k_ctrl_gating: crate::Reg<fout_32k_ctrl_gating::FOUT_32K_CTRL_GATING_SPEC>,
    _reserved12: [u8; 0x9c],
    #[doc = "0x100..0x120 - General Purpose Register"]
    pub gp_data: [crate::Reg<gp_data::GP_DATA_SPEC>; 8],
    #[doc = "0x120..0x128 - Fast Boot Information Register \\[01\\]"]
    pub fboot_info: [crate::Reg<fboot_info::FBOOT_INFO_SPEC>; 2],
    _reserved14: [u8; 0x38],
    #[doc = "0x160 - DCXO Control Register"]
    pub dcxo_ctrl: crate::Reg<dcxo_ctrl::DCXO_CTRL_SPEC>,
    _reserved15: [u8; 0x2c],
    #[doc = "0x190 - RTC_VIO Regulation Register"]
    pub rtc_vio: crate::Reg<rtc_vio::RTC_VIO_SPEC>,
    _reserved16: [u8; 0x5c],
    #[doc = "0x1f0 - IC Characteristic Register"]
    pub ic_chara: crate::Reg<ic_chara::IC_CHARA_SPEC>,
    #[doc = "0x1f4 - VDD Off Gating Control Register"]
    pub vdd_off_gating_ctrl: crate::Reg<vdd_off_gating_ctrl::VDD_OFF_GATING_CTRL_SPEC>,
    _reserved18: [u8; 0x0c],
    #[doc = "0x204 - Efuse High Voltage Power Switch Control Register"]
    pub efuse_hv_pwrswt_ctrl: crate::Reg<efuse_hv_pwrswt_ctrl::EFUSE_HV_PWRSWT_CTRL_SPEC>,
    _reserved19: [u8; 0x0108],
    #[doc = "0x310 - RTC SPI Clock Control Register"]
    pub rtc_spi_clk_ctrl: crate::Reg<rtc_spi_clk_ctrl::RTC_SPI_CLK_CTRL_SPEC>,
}
#[doc = "losc_ctrl register accessor: an alias for `Reg<LOSC_CTRL_SPEC>`"]
pub type LOSC_CTRL = crate::Reg<losc_ctrl::LOSC_CTRL_SPEC>;
#[doc = "Low Oscillator Control Register"]
pub mod losc_ctrl;
#[doc = "losc_auto_swt_sta register accessor: an alias for `Reg<LOSC_AUTO_SWT_STA_SPEC>`"]
...
#[doc = "intosc_clk_prescal register accessor: an alias for `Reg<INTOSC_CLK_PRESCAL_SPEC>`"]
...
#[doc = "rtc_day register accessor: an alias for `Reg<RTC_DAY_SPEC>`"]
pub type RTC_DAY = crate::Reg<rtc_day::RTC_DAY_SPEC>;
#[doc = "RTC Year-Month-Day Register"]
pub mod rtc_day;
#[doc = "rtc_hh_mm_ss register accessor: an alias for `Reg<RTC_HH_MM_SS_SPEC>`"]
pub type RTC_HH_MM_SS = crate::Reg<rtc_hh_mm_ss::RTC_HH_MM_SS_SPEC>;
#[doc = "RTC Hour-Minute-Second Register"]
pub mod rtc_hh_mm_ss;
#[doc = "alarm0_day_set register accessor: an alias for `Reg<ALARM0_DAY_SET_SPEC>`"]
...
#[doc = "alarm0_cur_vlu register accessor: an alias for `Reg<ALARM0_CUR_VLU_SPEC>`"]
...
#[doc = "alarm0_enable register accessor: an alias for `Reg<ALARM0_ENABLE_SPEC>`"]
...
#[doc = "alarm0_irq_sta register accessor: an alias for `Reg<ALARM0_IRQ_STA_SPEC>`"]
...
#[doc = "alarm_config register accessor: an alias for `Reg<ALARM_CONFIG_SPEC>`"]
pub type ALARM_CONFIG = crate::Reg<alarm_config::ALARM_CONFIG_SPEC>;
#[doc = "Alarm Configuration Register"]
pub mod alarm_config;
#[doc = "fout_32k_ctrl_gating register accessor: an alias for `Reg<FOUT_32K_CTRL_GATING_SPEC>`"]
...
#[doc = "efuse_hv_pwrswt_ctrl register accessor: an alias for `Reg<EFUSE_HV_PWRSWT_CTRL_SPEC>`"]
...
#[doc = "rtc_spi_clk_ctrl register accessor: an alias for `Reg<RTC_SPI_CLK_CTRL_SPEC>`"]
