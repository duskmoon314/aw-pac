...
pub type R = crate::R<IOMMU_PC_IVLD_END_ADDR_SPEC>;
#[doc = "Register `iommu_pc_ivld_end_addr` writer"]
pub type W = crate::W<IOMMU_PC_IVLD_END_ADDR_SPEC>;
#[doc = "Field `pc_ivld_ea` reader - PTW Cache invalid end address, 1 MB aligned."]
pub type PC_IVLD_EA_R = crate::FieldReader<u16>;
#[doc = "Field `pc_ivld_ea` writer - PTW Cache invalid end address, 1 MB aligned."]
pub type PC_IVLD_EA_W<'a, REG> = crate::FieldWriter<'a, REG, 12, u16>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn pc_ivld_ea(&mut self) -> PC_IVLD_EA_W<IOMMU_PC_IVLD_END_ADDR_SPEC> {
        PC_IVLD_EA_W::new(self, 20)
    }
