...
pub struct R(crate::R<IOMMU_PC_IVLD_ADDR_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<IOMMU_PC_IVLD_ADDR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<IOMMU_PC_IVLD_ADDR_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<IOMMU_PC_IVLD_ADDR_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `iommu_pc_ivld_addr` writer"]
pub struct W(crate::W<IOMMU_PC_IVLD_ADDR_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<IOMMU_PC_IVLD_ADDR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<IOMMU_PC_IVLD_ADDR_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<IOMMU_PC_IVLD_ADDR_SPEC>) -> Self {
        W(writer)
    }
}
#[doc = "Field `pc_ivld_addr` reader - PTW Cache invalid address, 1 MB aligned."]
pub type PC_IVLD_ADDR_R = crate::FieldReader<u16, u16>;
#[doc = "Field `pc_ivld_addr` writer - PTW Cache invalid address, 1 MB aligned."]
pub type PC_IVLD_ADDR_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, IOMMU_PC_IVLD_ADDR_SPEC, u16, u16, 12, O>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn pc_ivld_addr(&mut self) -> PC_IVLD_ADDR_W<20> {
        PC_IVLD_ADDR_W::new(self)
    }
