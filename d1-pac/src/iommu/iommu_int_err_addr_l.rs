...
pub struct R(crate::R<IOMMU_INT_ERR_ADDR_L_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<IOMMU_INT_ERR_ADDR_L_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<IOMMU_INT_ERR_ADDR_L_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<IOMMU_INT_ERR_ADDR_L_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Field `int_err_addr` reader - Virtual address that caused L\\[i\\]
page table to interrupt"]
pub type INT_ERR_ADDR_R = crate::FieldReader<u32, u32>;
impl R {
    #[doc = "Bits 0:31 - Virtual address that caused L\\[i\\]
page table to interrupt"]
    #[inline(always)]
...
#[doc = "IOMMU Interrupt Error Address L\\[i\\]\n\nThis register you can [`read`](crate::generic::Reg::read). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [iommu_int_err_addr_l](index.html) module"]
