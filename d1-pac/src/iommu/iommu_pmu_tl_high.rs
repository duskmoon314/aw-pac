...
pub struct R(crate::R<IOMMU_PMU_TL_HIGH_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<IOMMU_PMU_TL_HIGH_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<IOMMU_PMU_TL_HIGH_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<IOMMU_PMU_TL_HIGH_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `iommu_pmu_tl_high%s` writer"]
pub struct W(crate::W<IOMMU_PMU_TL_HIGH_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<IOMMU_PMU_TL_HIGH_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<IOMMU_PMU_TL_HIGH_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<IOMMU_PMU_TL_HIGH_SPEC>) -> Self {
        W(writer)
    }
}
impl W {
