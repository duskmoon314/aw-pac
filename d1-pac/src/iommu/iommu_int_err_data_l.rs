...
#[doc = "Field `int_err_data` reader - Corresponding page table of virtual address that caused L\\[i\\]
page table to interrupt"]
pub type INT_ERR_DATA_R = crate::FieldReader<u32, u32>;
impl R {
    #[doc = "Bits 0:31 - Corresponding page table of virtual address that caused L\\[i\\]
page table to interrupt"]
    #[inline(always)]
