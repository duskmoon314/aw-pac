...
impl TLB_IVLD_ENABLE_R {
    ...
    pub fn variant(&self) -> TLB_IVLD_ENABLE_A {
        match self.bits {
            false => TLB_IVLD_ENABLE_A::N_O_OPERATION_OR_COMPLETED,
            true => TLB_IVLD_ENABLE_A::E_NABLE,
        }
    }
    #[doc = "Checks if the value of the field is `N_O_OPERATION_OR_COMPLETED`"]
    #[inline(always)]
    pub fn is_n_o_operation_or_completed(&self) -> bool {
        *self == TLB_IVLD_ENABLE_A::N_O_OPERATION_OR_COMPLETED
    }
    #[doc = "Checks if the value of the field is `E_NABLE`"]
    #[inline(always)]
    pub fn is_e_nable(&self) -> bool {
        *self == TLB_IVLD_ENABLE_A::E_NABLE
    }
}
...
impl<'a, const O: u8> TLB_IVLD_ENABLE_W<'a, O> {
    ...
    pub fn n_o_operation_or_completed(self) -> &'a mut W {
        self.variant(TLB_IVLD_ENABLE_A::N_O_OPERATION_OR_COMPLETED)
    }
    #[doc = "Enable invalidation operation"]
    #[inline(always)]
    pub fn e_nable(self) -> &'a mut W {
        self.variant(TLB_IVLD_ENABLE_A::E_NABLE)
    }
}
impl R {
