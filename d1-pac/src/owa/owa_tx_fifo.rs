...
pub struct R(crate::R<OWA_TX_FIFO_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<OWA_TX_FIFO_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<OWA_TX_FIFO_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<OWA_TX_FIFO_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `owa_tx_fifo` writer"]
pub struct W(crate::W<OWA_TX_FIFO_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<OWA_TX_FIFO_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<OWA_TX_FIFO_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<OWA_TX_FIFO_SPEC>) -> Self {
        W(writer)
    }
}
impl W {
...
#[doc = "OWA TX FIFO Register\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [owa_tx_fifo](index.html) module"]
