...
pub struct R(crate::R<OWA_EXP_INFO_0_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<OWA_EXP_INFO_0_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<OWA_EXP_INFO_0_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<OWA_EXP_INFO_0_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `owa_exp_info_0` writer"]
pub struct W(crate::W<OWA_EXP_INFO_0_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<OWA_EXP_INFO_0_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<OWA_EXP_INFO_0_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<OWA_EXP_INFO_0_SPEC>) -> Self {
        W(writer)
    }
}
impl W {
