...
pub type R = crate::R<OWA_TX_CHSTA1_SPEC>;
#[doc = "Register `owa_tx_chsta1` writer"]
pub type W = crate::W<OWA_TX_CHSTA1_SPEC>;
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        write!(f, "{}", self.bits())
    }
}
impl core::fmt::Debug for crate::generic::Reg<OWA_TX_CHSTA1_SPEC> {
