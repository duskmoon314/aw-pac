...
pub struct R(crate::R<OWA_FCTL_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<OWA_FCTL_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<OWA_FCTL_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<OWA_FCTL_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `owa_fctl` writer"]
pub struct W(crate::W<OWA_FCTL_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<OWA_FCTL_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<OWA_FCTL_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<OWA_FCTL_SPEC>) -> Self {
        W(writer)
    }
}
impl W {
