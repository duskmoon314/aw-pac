...
pub type R = crate::R<OWA_FSTA_SPEC>;
#[doc = "Register `owa_fsta` writer"]
pub type W = crate::W<OWA_FSTA_SPEC>;
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        write!(f, "{}", self.bits())
    }
}
impl core::fmt::Debug for crate::generic::Reg<OWA_FSTA_SPEC> {
