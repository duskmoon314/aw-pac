...
impl From<crate::R<LOSC_AUTO_SWT_STA_REG_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<LOSC_AUTO_SWT_STA_REG_SPEC>) -> Self {
        R(reader)
    }
}
...
impl From<crate::W<LOSC_AUTO_SWT_STA_REG_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<LOSC_AUTO_SWT_STA_REG_SPEC>) -> Self {
        W(writer)
    }
}
...
#[doc = "LOSC Auto Switch Status Register\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [losc_auto_swt_sta_reg](index.html) module"]
pub struct LOSC_AUTO_SWT_STA_REG_SPEC;
impl crate::RegisterSpec for LOSC_AUTO_SWT_STA_REG_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [losc_auto_swt_sta_reg::R](R) reader structure"]
impl crate::Readable for LOSC_AUTO_SWT_STA_REG_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [losc_auto_swt_sta_reg::W](W) writer structure"]
