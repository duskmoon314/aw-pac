#[doc = "Register `fout_32k_ctrl_gating_reg` reader"]
pub struct R(crate::R<FOUT_32K_CTRL_GATING_REG_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<FOUT_32K_CTRL_GATING_REG_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<FOUT_32K_CTRL_GATING_REG_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<FOUT_32K_CTRL_GATING_REG_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `fout_32k_ctrl_gating_reg` writer"]
pub struct W(crate::W<FOUT_32K_CTRL_GATING_REG_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<FOUT_32K_CTRL_GATING_REG_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<FOUT_32K_CTRL_GATING_REG_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<FOUT_32K_CTRL_GATING_REG_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type HOSC_TO_32K_DIVIDER_ENABLE_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, FOUT_32K_CTRL_GATING_REG_SPEC, HOSC_TO_32K_DIVIDER_ENABLE_A, O>;
...
pub type LOSC_OUT_SRC_SEL_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, FOUT_32K_CTRL_GATING_REG_SPEC, u8, LOSC_OUT_SRC_SEL_A, 2, O>;
...
pub type FANOUT_32K_GATING_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, FOUT_32K_CTRL_GATING_REG_SPEC, FANOUT_32K_GATING_A, O>;
...
#[doc = "32K Fanout Control Gating Register\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [fout_32k_ctrl_gating_reg](index.html) module"]
pub struct FOUT_32K_CTRL_GATING_REG_SPEC;
impl crate::RegisterSpec for FOUT_32K_CTRL_GATING_REG_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [fout_32k_ctrl_gating_reg::R](R) reader structure"]
impl crate::Readable for FOUT_32K_CTRL_GATING_REG_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [fout_32k_ctrl_gating_reg::W](W) writer structure"]
impl crate::Writable for FOUT_32K_CTRL_GATING_REG_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets fout_32k_ctrl_gating_reg to value 0"]
impl crate::Resettable for FOUT_32K_CTRL_GATING_REG_SPEC {
    #[inline(always)]
