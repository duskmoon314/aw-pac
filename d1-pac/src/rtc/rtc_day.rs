...
pub struct R(crate::R<RTC_DAY_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<RTC_DAY_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<RTC_DAY_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<RTC_DAY_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `rtc_day` writer"]
pub struct W(crate::W<RTC_DAY_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<RTC_DAY_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<RTC_DAY_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<RTC_DAY_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type DAY_W<'a, const O: u8> = crate::FieldWriter<'a, u32, RTC_DAY_SPEC, u16, u16, 16, O>;
impl R {
