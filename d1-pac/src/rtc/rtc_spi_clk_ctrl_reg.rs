#[doc = "Register `RTC_SPI_CLK_CTRL_REG` reader"]
pub struct R(crate::R<RTC_SPI_CLK_CTRL_REG_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<RTC_SPI_CLK_CTRL_REG_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<RTC_SPI_CLK_CTRL_REG_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<RTC_SPI_CLK_CTRL_REG_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `RTC_SPI_CLK_CTRL_REG` writer"]
pub struct W(crate::W<RTC_SPI_CLK_CTRL_REG_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<RTC_SPI_CLK_CTRL_REG_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<RTC_SPI_CLK_CTRL_REG_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<RTC_SPI_CLK_CTRL_REG_SPEC>) -> Self {
        W(writer)
    }
}
...
#[doc = "RTC SPI Clock Control Register\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [rtc_spi_clk_ctrl_reg](index.html) module"]
pub struct RTC_SPI_CLK_CTRL_REG_SPEC;
impl crate::RegisterSpec for RTC_SPI_CLK_CTRL_REG_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [rtc_spi_clk_ctrl_reg::R](R) reader structure"]
impl crate::Readable for RTC_SPI_CLK_CTRL_REG_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [rtc_spi_clk_ctrl_reg::W](W) writer structure"]
