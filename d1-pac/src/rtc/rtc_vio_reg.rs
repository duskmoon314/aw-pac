...
impl From<crate::R<RTC_VIO_REG_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<RTC_VIO_REG_SPEC>) -> Self {
        R(reader)
    }
}
...
impl From<crate::W<RTC_VIO_REG_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<RTC_VIO_REG_SPEC>) -> Self {
        W(writer)
    }
}
#[doc = "VDD Select\n\nValue on reset: 0"]
...
#[doc = "RTC_VIO Regulation Register\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [rtc_vio_reg](index.html) module"]
pub struct RTC_VIO_REG_SPEC;
impl crate::RegisterSpec for RTC_VIO_REG_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [rtc_vio_reg::R](R) reader structure"]
impl crate::Readable for RTC_VIO_REG_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [rtc_vio_reg::W](W) writer structure"]
