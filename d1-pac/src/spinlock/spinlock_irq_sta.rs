...
pub type R = crate::R<SPINLOCK_IRQ_STA_SPEC>;
#[doc = "Register `spinlock_irq_sta` writer"]
pub type W = crate::W<SPINLOCK_IRQ_STA_SPEC>;
...
impl LOCK_IRQ_STATUS_R {
    ...
    #[inline(always)]
    pub const fn variant(&self) -> LOCK_IRQ_STATUS_A {
        match self.bits {
...
pub type LOCK_IRQ_STATUS_W<'a, REG> = crate::BitWriter1C<'a, REG, LOCK_IRQ_STATUS_A>;
impl<'a, REG> LOCK_IRQ_STATUS_W<'a, REG>
where
...
impl R {
    #[doc = "Lock\\[i\\] Interrupt Status\n\nNOTE: `n` is number of field in register. `n == 0` corresponds to `lock0_irq_status` field"]
    #[inline(always)]
    pub fn lock_irq_status(&self, n: u8) -> LOCK_IRQ_STATUS_R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn lock_irq_status(&mut self, n: u8) -> LOCK_IRQ_STATUS_W<SPINLOCK_IRQ_STA_SPEC> {
        #[allow(clippy::no_effect)]
        [(); 32][n as usize];
        LOCK_IRQ_STATUS_W::new(self, n)
    }
    #[doc = "Bit 0 - Lock\\[i\\] Interrupt Status"]
    #[inline(always)]
    #[must_use]
    pub fn lock0_irq_status(&mut self) -> LOCK_IRQ_STATUS_W<SPINLOCK_IRQ_STA_SPEC> {
        LOCK_IRQ_STATUS_W::new(self, 0)
    }
    #[doc = "Bit 1 - Lock\\[i\\] Interrupt Status"]
    #[inline(always)]
    #[must_use]
    pub fn lock1_irq_status(&mut self) -> LOCK_IRQ_STATUS_W<SPINLOCK_IRQ_STA_SPEC> {
        LOCK_IRQ_STATUS_W::new(self, 1)
    }
    #[doc = "Bit 2 - Lock\\[i\\] Interrupt Status"]
    #[inline(always)]
    #[must_use]
    pub fn lock2_irq_status(&mut self) -> LOCK_IRQ_STATUS_W<SPINLOCK_IRQ_STA_SPEC> {
        LOCK_IRQ_STATUS_W::new(self, 2)
    }
    #[doc = "Bit 3 - Lock\\[i\\] Interrupt Status"]
    #[inline(always)]
    #[must_use]
    pub fn lock3_irq_status(&mut self) -> LOCK_IRQ_STATUS_W<SPINLOCK_IRQ_STA_SPEC> {
        LOCK_IRQ_STATUS_W::new(self, 3)
    }
    #[doc = "Bit 4 - Lock\\[i\\] Interrupt Status"]
    #[inline(always)]
    #[must_use]
    pub fn lock4_irq_status(&mut self) -> LOCK_IRQ_STATUS_W<SPINLOCK_IRQ_STA_SPEC> {
        LOCK_IRQ_STATUS_W::new(self, 4)
    }
    #[doc = "Bit 5 - Lock\\[i\\] Interrupt Status"]
    #[inline(always)]
    #[must_use]
    pub fn lock5_irq_status(&mut self) -> LOCK_IRQ_STATUS_W<SPINLOCK_IRQ_STA_SPEC> {
        LOCK_IRQ_STATUS_W::new(self, 5)
    }
    #[doc = "Bit 6 - Lock\\[i\\] Interrupt Status"]
    #[inline(always)]
    #[must_use]
    pub fn lock6_irq_status(&mut self) -> LOCK_IRQ_STATUS_W<SPINLOCK_IRQ_STA_SPEC> {
        LOCK_IRQ_STATUS_W::new(self, 6)
    }
    #[doc = "Bit 7 - Lock\\[i\\] Interrupt Status"]
    #[inline(always)]
    #[must_use]
    pub fn lock7_irq_status(&mut self) -> LOCK_IRQ_STATUS_W<SPINLOCK_IRQ_STA_SPEC> {
        LOCK_IRQ_STATUS_W::new(self, 7)
    }
    #[doc = "Bit 8 - Lock\\[i\\] Interrupt Status"]
    #[inline(always)]
    #[must_use]
    pub fn lock8_irq_status(&mut self) -> LOCK_IRQ_STATUS_W<SPINLOCK_IRQ_STA_SPEC> {
        LOCK_IRQ_STATUS_W::new(self, 8)
    }
    #[doc = "Bit 9 - Lock\\[i\\] Interrupt Status"]
    #[inline(always)]
    #[must_use]
    pub fn lock9_irq_status(&mut self) -> LOCK_IRQ_STATUS_W<SPINLOCK_IRQ_STA_SPEC> {
        LOCK_IRQ_STATUS_W::new(self, 9)
    }
    #[doc = "Bit 10 - Lock\\[i\\] Interrupt Status"]
    #[inline(always)]
    #[must_use]
    pub fn lock10_irq_status(&mut self) -> LOCK_IRQ_STATUS_W<SPINLOCK_IRQ_STA_SPEC> {
        LOCK_IRQ_STATUS_W::new(self, 10)
    }
    #[doc = "Bit 11 - Lock\\[i\\] Interrupt Status"]
    #[inline(always)]
    #[must_use]
    pub fn lock11_irq_status(&mut self) -> LOCK_IRQ_STATUS_W<SPINLOCK_IRQ_STA_SPEC> {
        LOCK_IRQ_STATUS_W::new(self, 11)
    }
    #[doc = "Bit 12 - Lock\\[i\\] Interrupt Status"]
    #[inline(always)]
    #[must_use]
    pub fn lock12_irq_status(&mut self) -> LOCK_IRQ_STATUS_W<SPINLOCK_IRQ_STA_SPEC> {
        LOCK_IRQ_STATUS_W::new(self, 12)
    }
    #[doc = "Bit 13 - Lock\\[i\\] Interrupt Status"]
    #[inline(always)]
    #[must_use]
    pub fn lock13_irq_status(&mut self) -> LOCK_IRQ_STATUS_W<SPINLOCK_IRQ_STA_SPEC> {
        LOCK_IRQ_STATUS_W::new(self, 13)
    }
    #[doc = "Bit 14 - Lock\\[i\\] Interrupt Status"]
    #[inline(always)]
    #[must_use]
    pub fn lock14_irq_status(&mut self) -> LOCK_IRQ_STATUS_W<SPINLOCK_IRQ_STA_SPEC> {
        LOCK_IRQ_STATUS_W::new(self, 14)
    }
    #[doc = "Bit 15 - Lock\\[i\\] Interrupt Status"]
    #[inline(always)]
    #[must_use]
    pub fn lock15_irq_status(&mut self) -> LOCK_IRQ_STATUS_W<SPINLOCK_IRQ_STA_SPEC> {
        LOCK_IRQ_STATUS_W::new(self, 15)
    }
    #[doc = "Bit 16 - Lock\\[i\\] Interrupt Status"]
    #[inline(always)]
    #[must_use]
    pub fn lock16_irq_status(&mut self) -> LOCK_IRQ_STATUS_W<SPINLOCK_IRQ_STA_SPEC> {
        LOCK_IRQ_STATUS_W::new(self, 16)
    }
    #[doc = "Bit 17 - Lock\\[i\\] Interrupt Status"]
    #[inline(always)]
    #[must_use]
    pub fn lock17_irq_status(&mut self) -> LOCK_IRQ_STATUS_W<SPINLOCK_IRQ_STA_SPEC> {
        LOCK_IRQ_STATUS_W::new(self, 17)
    }
    #[doc = "Bit 18 - Lock\\[i\\] Interrupt Status"]
    #[inline(always)]
    #[must_use]
    pub fn lock18_irq_status(&mut self) -> LOCK_IRQ_STATUS_W<SPINLOCK_IRQ_STA_SPEC> {
        LOCK_IRQ_STATUS_W::new(self, 18)
    }
    #[doc = "Bit 19 - Lock\\[i\\] Interrupt Status"]
    #[inline(always)]
    #[must_use]
    pub fn lock19_irq_status(&mut self) -> LOCK_IRQ_STATUS_W<SPINLOCK_IRQ_STA_SPEC> {
        LOCK_IRQ_STATUS_W::new(self, 19)
    }
    #[doc = "Bit 20 - Lock\\[i\\] Interrupt Status"]
    #[inline(always)]
    #[must_use]
    pub fn lock20_irq_status(&mut self) -> LOCK_IRQ_STATUS_W<SPINLOCK_IRQ_STA_SPEC> {
        LOCK_IRQ_STATUS_W::new(self, 20)
    }
    #[doc = "Bit 21 - Lock\\[i\\] Interrupt Status"]
    #[inline(always)]
    #[must_use]
    pub fn lock21_irq_status(&mut self) -> LOCK_IRQ_STATUS_W<SPINLOCK_IRQ_STA_SPEC> {
        LOCK_IRQ_STATUS_W::new(self, 21)
    }
    #[doc = "Bit 22 - Lock\\[i\\] Interrupt Status"]
    #[inline(always)]
    #[must_use]
    pub fn lock22_irq_status(&mut self) -> LOCK_IRQ_STATUS_W<SPINLOCK_IRQ_STA_SPEC> {
        LOCK_IRQ_STATUS_W::new(self, 22)
    }
    #[doc = "Bit 23 - Lock\\[i\\] Interrupt Status"]
    #[inline(always)]
    #[must_use]
    pub fn lock23_irq_status(&mut self) -> LOCK_IRQ_STATUS_W<SPINLOCK_IRQ_STA_SPEC> {
        LOCK_IRQ_STATUS_W::new(self, 23)
    }
    #[doc = "Bit 24 - Lock\\[i\\] Interrupt Status"]
    #[inline(always)]
    #[must_use]
    pub fn lock24_irq_status(&mut self) -> LOCK_IRQ_STATUS_W<SPINLOCK_IRQ_STA_SPEC> {
        LOCK_IRQ_STATUS_W::new(self, 24)
    }
    #[doc = "Bit 25 - Lock\\[i\\] Interrupt Status"]
    #[inline(always)]
    #[must_use]
    pub fn lock25_irq_status(&mut self) -> LOCK_IRQ_STATUS_W<SPINLOCK_IRQ_STA_SPEC> {
        LOCK_IRQ_STATUS_W::new(self, 25)
    }
    #[doc = "Bit 26 - Lock\\[i\\] Interrupt Status"]
    #[inline(always)]
    #[must_use]
    pub fn lock26_irq_status(&mut self) -> LOCK_IRQ_STATUS_W<SPINLOCK_IRQ_STA_SPEC> {
        LOCK_IRQ_STATUS_W::new(self, 26)
    }
    #[doc = "Bit 27 - Lock\\[i\\] Interrupt Status"]
    #[inline(always)]
    #[must_use]
    pub fn lock27_irq_status(&mut self) -> LOCK_IRQ_STATUS_W<SPINLOCK_IRQ_STA_SPEC> {
        LOCK_IRQ_STATUS_W::new(self, 27)
    }
    #[doc = "Bit 28 - Lock\\[i\\] Interrupt Status"]
    #[inline(always)]
    #[must_use]
    pub fn lock28_irq_status(&mut self) -> LOCK_IRQ_STATUS_W<SPINLOCK_IRQ_STA_SPEC> {
        LOCK_IRQ_STATUS_W::new(self, 28)
    }
    #[doc = "Bit 29 - Lock\\[i\\] Interrupt Status"]
    #[inline(always)]
    #[must_use]
    pub fn lock29_irq_status(&mut self) -> LOCK_IRQ_STATUS_W<SPINLOCK_IRQ_STA_SPEC> {
        LOCK_IRQ_STATUS_W::new(self, 29)
    }
    #[doc = "Bit 30 - Lock\\[i\\] Interrupt Status"]
    #[inline(always)]
    #[must_use]
    pub fn lock30_irq_status(&mut self) -> LOCK_IRQ_STATUS_W<SPINLOCK_IRQ_STA_SPEC> {
        LOCK_IRQ_STATUS_W::new(self, 30)
    }
    #[doc = "Bit 31 - Lock\\[i\\] Interrupt Status"]
    #[inline(always)]
    #[must_use]
    pub fn lock31_irq_status(&mut self) -> LOCK_IRQ_STATUS_W<SPINLOCK_IRQ_STA_SPEC> {
        LOCK_IRQ_STATUS_W::new(self, 31)
    }
...
#[doc = "Spinlock Interrupt Status Register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`spinlock_irq_sta::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`spinlock_irq_sta::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
