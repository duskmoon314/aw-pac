...
impl From<crate::R<SPINLOCK_IRQ_EN_REG_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<SPINLOCK_IRQ_EN_REG_SPEC>) -> Self {
        R(reader)
    }
}
...
impl From<crate::W<SPINLOCK_IRQ_EN_REG_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<SPINLOCK_IRQ_EN_REG_SPEC>) -> Self {
        W(writer)
    }
}
#[doc = "Lock\\[i\\]
...
Interrupt Enable"]
pub struct LOCK_IRQ_EN_R(crate::FieldReader<bool>);
impl LOCK_IRQ_EN_R {
    #[inline(always)]
    pub(crate) fn new(bits: bool) -> Self {
        LOCK_IRQ_EN_R(crate::FieldReader::new(bits))
    }
...
impl core::ops::Deref for LOCK_IRQ_EN_R {
...
#[doc = "Fields `LOCK(0-31)_IRQ_EN` const generic writer - Lock\\[i\\]
Interrupt Enable"]
pub struct LOCK_IRQ_EN_W<'a, const O: usize> {
    w: &'a mut W,
}
impl<'a, const O: usize> LOCK_IRQ_EN_W<'a, O> {
    #[doc = r"Writes `variant` to the field"]
    #[inline(always)]
    pub fn variant(self, variant: LOCK_IRQ_EN_A) -> &'a mut W {
...
Interrupt Enable"]
    #[inline(always)]
    pub unsafe fn lock_irq_en(&self, n: usize) -> LOCK_IRQ_EN_R {
...
Interrupt Enable"]
    #[inline(always)]
    pub unsafe fn lock_irq_en<const O: usize>(&mut self) -> LOCK_IRQ_EN_W<O> {
        LOCK_IRQ_EN_W { w: self }
    }
    #[doc = "Bit 0 - Lock\\[i\\]
Interrupt Enable"]
    #[inline(always)]
...
#[doc = "Spinlock Interrupt Enable Register\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [spinlock_irq_en_reg](index.html) module"]
pub struct SPINLOCK_IRQ_EN_REG_SPEC;
impl crate::RegisterSpec for SPINLOCK_IRQ_EN_REG_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [spinlock_irq_en_reg::R](R) reader structure"]
impl crate::Readable for SPINLOCK_IRQ_EN_REG_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [spinlock_irq_en_reg::W](W) writer structure"]
