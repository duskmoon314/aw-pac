...
pub type PORT_RESET_STATUS_CHANGE_W<'a> =
    crate::BitWriter<'a, u32, HC_RH_PORT_STATUS_SPEC, PORT_RESET_STATUS_CHANGE_A, 20>;
impl<'a> PORT_RESET_STATUS_CHANGE_W<'a> {
...
pub type PORT_OVER_CURRENT_INDICATOR_CHANGE_W<'a> =
    crate::BitWriter<'a, u32, HC_RH_PORT_STATUS_SPEC, PORT_OVER_CURRENT_INDICATOR_CHANGE_A, 19>;
impl<'a> PORT_OVER_CURRENT_INDICATOR_CHANGE_W<'a> {
...
pub type PORT_SUSPEND_STATUS_CHANGE_W<'a> =
    crate::BitWriter<'a, u32, HC_RH_PORT_STATUS_SPEC, PORT_SUSPEND_STATUS_CHANGE_A, 18>;
impl<'a> PORT_SUSPEND_STATUS_CHANGE_W<'a> {
...
pub type PORT_ENABLE_STATUS_CHANGE_W<'a> =
    crate::BitWriter<'a, u32, HC_RH_PORT_STATUS_SPEC, PORT_ENABLE_STATUS_CHANGE_A, 17>;
impl<'a> PORT_ENABLE_STATUS_CHANGE_W<'a> {
...
bit is set, this bit is set only after a Root Hub reset to inform the system that the device is attached."]
pub type CONNECT_STATUS_CHANGE_W<'a> =
    crate::BitWriter<'a, u32, HC_RH_PORT_STATUS_SPEC, CONNECT_STATUS_CHANGE_A, 16>;
impl<'a> CONNECT_STATUS_CHANGE_W<'a> {
...
pub type R_LOW_SPEED_DEVICE_ATTACHED_W_CLEAR_PORT_POWER_W<'a> =
    crate::BitWriter<'a, u32, HC_RH_PORT_STATUS_SPEC, bool, 9>;
#[doc = "Field `R_PORT_POWER_STATUS_W_SET_PORT_POWER` reader - (read) PortPowerStatus\n\nThis bit reflects the port’s power status, regardless of the type of power switching implemented. This bit is cleared if an overcurrent condition is detected. HCD sets this bit by writing SetPortPower or SetGlobalPower. HCD clears this bit by writing ClearPortPower or ClearGlobalPower. Which power control switches are enabled is determined by PowerSwitchingMode and PortPortControlMask\\[NumberDownstreamPort\\]. In global switching mode(PowerSwitchingMode=0), Set/ClearGlobalPower controls this bit. In per-port power switching (PowerSwitchingMode=1), if the PortPowerControlMask\\[NDP\\]
bit for the port is set, only Set/ClearPortPower commands are enabled. If the mask is not set, only Set/ClearGlobalPower commands are enabled. When port power is disabled, CurrentConnectStatus, PortEnableStatus, PortSuspendStatus, and PortResetStatus should be reset.\n\n0 port power is off\n\n1 port power is on\n\n(write) SetPortPower\n\nThe HCD writes a ‘1’ to set the PortPowerStatus bit. Writing a ‘0’ has no effect.\n\nNote: This bit is always reads ‘1b’ if power switching is not supported."]
...
bit for the port is set, only Set/ClearPortPower commands are enabled. If the mask is not set, only Set/ClearGlobalPower commands are enabled. When port power is disabled, CurrentConnectStatus, PortEnableStatus, PortSuspendStatus, and PortResetStatus should be reset.\n\n0 port power is off\n\n1 port power is on\n\n(write) SetPortPower\n\nThe HCD writes a ‘1’ to set the PortPowerStatus bit. Writing a ‘0’ has no effect.\n\nNote: This bit is always reads ‘1b’ if power switching is not supported."]
pub type R_PORT_POWER_STATUS_W_SET_PORT_POWER_W<'a> =
    crate::BitWriter<'a, u32, HC_RH_PORT_STATUS_SPEC, bool, 8>;
...
pub type R_PORT_RESET_STATUS_W_SET_PORT_RESET_W<'a> =
    crate::BitWriter<'a, u32, HC_RH_PORT_STATUS_SPEC, bool, 4>;
...
pub type R_PORT_OVER_CURRENT_INDICATOR_W_CLEAR_SUSPEND_STATUS_W<'a> =
    crate::BitWriter<'a, u32, HC_RH_PORT_STATUS_SPEC, bool, 3>;
...
pub type R_PORT_SUSPEND_STATUS_W_SET_PORT_SUSPEND_W<'a> =
    crate::BitWriter<'a, u32, HC_RH_PORT_STATUS_SPEC, bool, 2>;
...
pub type R_PORT_ENABLE_STATUS_W_SET_PORT_ENABLE_W<'a> =
    crate::BitWriter<'a, u32, HC_RH_PORT_STATUS_SPEC, bool, 1>;
...
pub type R_CURRENT_CONNECT_STATUS_W_CLEAR_PORT_ENABLE_W<'a> =
    crate::BitWriter<'a, u32, HC_RH_PORT_STATUS_SPEC, bool, 0>;
impl R {
...
impl W {
    #[doc = "Bit 20 - This bit is set at the end of the 10ms port reset signal. The HCD writes a '1' to clear this bit. Writing a '0' has no effect."]
    #[inline(always)]
    pub fn port_reset_status_change(&mut self) -> PORT_RESET_STATUS_CHANGE_W {
        PORT_RESET_STATUS_CHANGE_W::new(self)
    }
    #[doc = "Bit 19 - This bit is valid only if overcurrent conditions are reported on a per-port basis. This bit is set when Root Hub changes the PortOverCurrentIndicator bit. The HCD writes a ‘1’ to clear this bit. Writing a ‘0’ has no effect."]
    #[inline(always)]
    pub fn port_over_current_indicator_change(&mut self) -> PORT_OVER_CURRENT_INDICATOR_CHANGE_W {
        PORT_OVER_CURRENT_INDICATOR_CHANGE_W::new(self)
    }
    #[doc = "Bit 18 - This bit is set when the full resume sequence has been completed. This sequence includes the 20-s resume pulse, LS EOP, and 3-ms resychronization delay. The HCD writes a '1' to clear this bit. Writing a '0' has no effect. This bit is also cleared when ResetStatusChange is set."]
    #[inline(always)]
    pub fn port_suspend_status_change(&mut self) -> PORT_SUSPEND_STATUS_CHANGE_W {
        PORT_SUSPEND_STATUS_CHANGE_W::new(self)
    }
    #[doc = "Bit 17 - This bit is set when hardware events cause the PortEnableStatus bit to be cleared. Changes from HCD writes do not set this bit. The HCD writes a '1' to clear this bit. Writing a '0' has no effect."]
    #[inline(always)]
    pub fn port_enable_status_change(&mut self) -> PORT_ENABLE_STATUS_CHANGE_W {
...
bit is set, this bit is set only after a Root Hub reset to inform the system that the device is attached."]
    ...
    pub fn r_low_speed_device_attached_w_clear_port_power(
        &mut self,
    ) -> R_LOW_SPEED_DEVICE_ATTACHED_W_CLEAR_PORT_POWER_W {
...
bit for the port is set, only Set/ClearPortPower commands are enabled. If the mask is not set, only Set/ClearGlobalPower commands are enabled. When port power is disabled, CurrentConnectStatus, PortEnableStatus, PortSuspendStatus, and PortResetStatus should be reset.\n\n0 port power is off\n\n1 port power is on\n\n(write) SetPortPower\n\nThe HCD writes a ‘1’ to set the PortPowerStatus bit. Writing a ‘0’ has no effect.\n\nNote: This bit is always reads ‘1b’ if power switching is not supported."]
    ...
    pub fn r_port_power_status_w_set_port_power(
        &mut self,
    ) -> R_PORT_POWER_STATUS_W_SET_PORT_POWER_W {
    ...
    pub fn r_port_reset_status_w_set_port_reset(
        &mut self,
    ) -> R_PORT_RESET_STATUS_W_SET_PORT_RESET_W {
    ...
    pub fn r_port_over_current_indicator_w_clear_suspend_status(
        &mut self,
    ) -> R_PORT_OVER_CURRENT_INDICATOR_W_CLEAR_SUSPEND_STATUS_W {
    ...
    pub fn r_port_suspend_status_w_set_port_suspend(
        &mut self,
    ) -> R_PORT_SUSPEND_STATUS_W_SET_PORT_SUSPEND_W {
    ...
    pub fn r_port_enable_status_w_set_port_enable(
        &mut self,
    ) -> R_PORT_ENABLE_STATUS_W_SET_PORT_ENABLE_W {
    ...
    pub fn r_current_connect_status_w_clear_port_enable(
        &mut self,
    ) -> R_CURRENT_CONNECT_STATUS_W_CLEAR_PORT_ENABLE_W {
