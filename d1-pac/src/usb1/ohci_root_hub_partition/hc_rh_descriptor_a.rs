...
pub type R = crate::R<HC_RH_DESCRIPTOR_A_SPEC>;
#[doc = "Register `hc_rh_descriptor_a` writer"]
pub type W = crate::W<HC_RH_DESCRIPTOR_A_SPEC>;
...
pub type NUMBER_DOWNSTREAM_PORTS_R = crate::FieldReader;
...
impl NO_POWER_SWITHCING_R {
    ...
    #[inline(always)]
    pub const fn variant(&self) -> NO_POWER_SWITHCING_A {
        match self.bits {
...
pub type NO_POWER_SWITHCING_W<'a, REG> = crate::BitWriter<'a, REG, NO_POWER_SWITHCING_A>;
impl<'a, REG> NO_POWER_SWITHCING_W<'a, REG>
where
    REG: crate::Writable + crate::RegisterSpec,
{
    #[doc = "Ports are power switched"]
    #[inline(always)]
    pub fn switched(self) -> &'a mut crate::W<REG> {
...
impl POWER_SWITCHING_MODE_R {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
    pub const fn variant(&self) -> POWER_SWITCHING_MODE_A {
        match self.bits {
...
pub type POWER_SWITCHING_MODE_W<'a, REG> = crate::BitWriter<'a, REG, POWER_SWITCHING_MODE_A>;
impl<'a, REG> POWER_SWITCHING_MODE_W<'a, REG>
where
    REG: crate::Writable + crate::RegisterSpec,
{
    #[doc = "All ports are powered at the same time"]
    #[inline(always)]
    pub fn same_time(self) -> &'a mut crate::W<REG> {
...
pub type DEVICE_R = crate::BitReader;
...
impl OVER_CURRENT_PROTECTION_MODE_R {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
    pub const fn variant(&self) -> OVER_CURRENT_PROTECTION_MODE_A {
        match self.bits {
...
pub type OVER_CURRENT_PROTECTION_MODE_W<'a, REG> =
    crate::BitWriter<'a, REG, OVER_CURRENT_PROTECTION_MODE_A>;
impl<'a, REG> OVER_CURRENT_PROTECTION_MODE_W<'a, REG>
where
    REG: crate::Writable + crate::RegisterSpec,
{
    #[doc = "Over-current status is reported collectively for all downstream ports"]
    #[inline(always)]
    pub fn report(self) -> &'a mut crate::W<REG> {
        self.variant(OVER_CURRENT_PROTECTION_MODE_A::REPORT)
    }
    #[doc = "Over-current status is reported on per-port basis"]
    #[inline(always)]
    pub fn report_perport(self) -> &'a mut crate::W<REG> {
...
impl NO_OVER_CURRENT_PROTECTION_R {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
    pub const fn variant(&self) -> NO_OVER_CURRENT_PROTECTION_A {
        match self.bits {
...
pub type NO_OVER_CURRENT_PROTECTION_W<'a, REG> =
    crate::BitWriter<'a, REG, NO_OVER_CURRENT_PROTECTION_A>;
impl<'a, REG> NO_OVER_CURRENT_PROTECTION_W<'a, REG>
where
    REG: crate::Writable + crate::RegisterSpec,
{
    #[doc = "Over-current status is reported collectively for all downstream ports"]
    ...
    #[doc = "No over-current protection supported"]
    #[inline(always)]
    pub fn no_support(self) -> &'a mut crate::W<REG> {
...
pub type POWER_ON_TO_POWER_GOOD_TIME_R = crate::FieldReader;
#[doc = "Field `power_on_to_power_good_time` writer - PowerOnToPowerGoodTime\\[POTPGT\\]\n\nThis byte specifies the duration HCD has to wait before accessing a powered-on port of the Root Hub. It is implementation-specific. The unit of time is 2 ms. The duration is calculated as POTPGT * 2ms."]
pub type POWER_ON_TO_POWER_GOOD_TIME_W<'a, REG> = crate::FieldWriter<'a, REG, 8>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn no_power_swithcing(&mut self) -> NO_POWER_SWITHCING_W<HC_RH_DESCRIPTOR_A_SPEC> {
        NO_POWER_SWITHCING_W::new(self, 8)
    }
    #[doc = "Bit 9 - PowerSwitchingMode\n\nThis bit is used to specify how the power switching of the Root Hub ports is controlled. It is implementation-specific. This field is only valid if the NoPowerSwitching field is cleared."]
    #[inline(always)]
    #[must_use]
    pub fn power_switching_mode(&mut self) -> POWER_SWITCHING_MODE_W<HC_RH_DESCRIPTOR_A_SPEC> {
        POWER_SWITCHING_MODE_W::new(self, 9)
    }
    #[doc = "Bit 11 - OverCurrentProtectionMode\n\nThis bit describes how the overcurrent status for the Root Hub ports are reported. At reset, these fields should reflect the same mode as PowerSwitchingMode. This field is valid only if the NoOverCurrentProtection field is cleared. 0 Over-current status is reported collectively for all downstream ports. 1 Over-current status is reported on per-port basis."]
    #[inline(always)]
    #[must_use]
    pub fn over_current_protection_mode(
        &mut self,
    ) -> OVER_CURRENT_PROTECTION_MODE_W<HC_RH_DESCRIPTOR_A_SPEC> {
        OVER_CURRENT_PROTECTION_MODE_W::new(self, 11)
    }
    #[doc = "Bit 12 - NoOverCurrentProtection\n\nThis bit describes how the overcurrent status for the Root Hub ports are reported. When this bit is cleared, the OverCurrentProtectionMode field specifies global or per-port reporting."]
    #[inline(always)]
    #[must_use]
    pub fn no_over_current_protection(
        &mut self,
    ) -> NO_OVER_CURRENT_PROTECTION_W<HC_RH_DESCRIPTOR_A_SPEC> {
        NO_OVER_CURRENT_PROTECTION_W::new(self, 12)
    }
    #[doc = "Bits 24:31 - PowerOnToPowerGoodTime\\[POTPGT\\]\n\nThis byte specifies the duration HCD has to wait before accessing a powered-on port of the Root Hub. It is implementation-specific. The unit of time is 2 ms. The duration is calculated as POTPGT * 2ms."]
    #[inline(always)]
    #[must_use]
    pub fn power_on_to_power_good_time(
        &mut self,
    ) -> POWER_ON_TO_POWER_GOOD_TIME_W<HC_RH_DESCRIPTOR_A_SPEC> {
        POWER_ON_TO_POWER_GOOD_TIME_W::new(self, 24)
    }
