#[doc = "HC_FM_INTERVAL register accessor: an alias for `Reg<HC_FM_INTERVAL_SPEC>`"]
...
#[doc = "HC_FM_REMAINING register accessor: an alias for `Reg<HC_FM_REMAINING_SPEC>`"]
...
#[doc = "HC_FM_NUMBER register accessor: an alias for `Reg<HC_FM_NUMBER_SPEC>`"]
pub type HC_FM_NUMBER = crate::Reg<hc_fm_number::HC_FM_NUMBER_SPEC>;
#[doc = "OHCI Frame Number Register"]
pub mod hc_fm_number;
#[doc = "HC_PERIODIC_START register accessor: an alias for `Reg<HC_PERIODIC_START_SPEC>`"]
...
#[doc = "HC_LS_THRESHOLD register accessor: an alias for `Reg<HC_LS_THRESHOLD_SPEC>`"]
