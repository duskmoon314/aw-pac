...
pub type R = crate::R<HC_INTERRUPT_ENABLE_SPEC>;
#[doc = "Register `hc_interrupt_enable` writer"]
pub type W = crate::W<HC_INTERRUPT_ENABLE_SPEC>;
...
pub type MASTER_INTERRUPT_ENABLE_R = crate::BitReader;
#[doc = "Field `master_interrupt_enable` writer - MasterInterruptEnable\n\nA '0' writtern to this field is ignored by HC. A '1' written to this field enables interrupt generation due to events specified in the other bits of this register. This is used by HCD as Master Interrupt Enable."]
pub type MASTER_INTERRUPT_ENABLE_W<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn scheduling_overrun(&mut self) -> SCHEDULING_OVERRUN_W<HC_INTERRUPT_ENABLE_SPEC> {
        SCHEDULING_OVERRUN_W::new(self, 0)
    }
    #[doc = "Bit 1 - WritebackDoneHead Interrupt Enable"]
    #[inline(always)]
    #[must_use]
    pub fn writeback_done_head(&mut self) -> WRITEBACK_DONE_HEAD_W<HC_INTERRUPT_ENABLE_SPEC> {
        WRITEBACK_DONE_HEAD_W::new(self, 1)
    }
    #[doc = "Bit 2 - StartofFrame Interrupt Enable"]
    #[inline(always)]
    #[must_use]
    pub fn start_of_frame(&mut self) -> START_OF_FRAME_W<HC_INTERRUPT_ENABLE_SPEC> {
        START_OF_FRAME_W::new(self, 2)
    }
    #[doc = "Bit 3 - ResumeDetected Interrupt Enable"]
    #[inline(always)]
    #[must_use]
    pub fn resume_detected(&mut self) -> RESUME_DETECTED_W<HC_INTERRUPT_ENABLE_SPEC> {
        RESUME_DETECTED_W::new(self, 3)
    }
    #[doc = "Bit 4 - UnrecoverableError Interrupt Enable"]
    #[inline(always)]
    #[must_use]
    pub fn unrecoverable_error(&mut self) -> UNRECOVERABLE_ERROR_W<HC_INTERRUPT_ENABLE_SPEC> {
        UNRECOVERABLE_ERROR_W::new(self, 4)
    }
    #[doc = "Bit 5 - FrameNumberOverflow Interrupt Enable"]
    #[inline(always)]
    #[must_use]
    pub fn frame_number_overflow(&mut self) -> FRAME_NUMBER_OVERFLOW_W<HC_INTERRUPT_ENABLE_SPEC> {
        FRAME_NUMBER_OVERFLOW_W::new(self, 5)
    }
    #[doc = "Bit 6 - RootHubStatusChange Interrupt Enable"]
    #[inline(always)]
    #[must_use]
    pub fn root_hub_status_change(&mut self) -> ROOT_HUB_STATUS_CHANGE_W<HC_INTERRUPT_ENABLE_SPEC> {
        ROOT_HUB_STATUS_CHANGE_W::new(self, 6)
    }
    #[doc = "Bit 31 - MasterInterruptEnable\n\nA '0' writtern to this field is ignored by HC. A '1' written to this field enables interrupt generation due to events specified in the other bits of this register. This is used by HCD as Master Interrupt Enable."]
    #[inline(always)]
    #[must_use]
    pub fn master_interrupt_enable(
        &mut self,
    ) -> MASTER_INTERRUPT_ENABLE_W<HC_INTERRUPT_ENABLE_SPEC> {
        MASTER_INTERRUPT_ENABLE_W::new(self, 31)
    }
