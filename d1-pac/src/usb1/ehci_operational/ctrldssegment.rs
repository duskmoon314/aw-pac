...
impl From<crate::R<CTRLDSSEGMENT_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<CTRLDSSEGMENT_SPEC>) -> Self {
        R(reader)
    }
}
...
impl From<crate::W<CTRLDSSEGMENT_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<CTRLDSSEGMENT_SPEC>) -> Self {
        W(writer)
    }
}
impl W {
