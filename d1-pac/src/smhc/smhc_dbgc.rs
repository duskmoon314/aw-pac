...
impl From<crate::R<SMHC_DBGC_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<SMHC_DBGC_SPEC>) -> Self {
        R(reader)
    }
}
...
impl From<crate::W<SMHC_DBGC_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<SMHC_DBGC_SPEC>) -> Self {
        W(writer)
    }
}
impl W {
