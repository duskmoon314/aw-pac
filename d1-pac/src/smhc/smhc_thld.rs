...
pub struct CARD_WR_THLD_R(crate::FieldReader<u16>);
impl CARD_WR_THLD_R {
    #[inline(always)]
...
pub struct CARD_WR_THLD_ENB_R(crate::FieldReader<bool>);
...
pub struct BCIG_R(crate::FieldReader<bool>);
impl BCIG_R {
    #[inline(always)]
    pub(crate) fn new(bits: bool) -> Self {
...
pub struct CARD_RD_THLD_ENB_R(crate::FieldReader<bool>);
