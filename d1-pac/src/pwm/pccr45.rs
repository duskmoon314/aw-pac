...
pub type R = crate::R<PCCR45_SPEC>;
#[doc = "Register `pccr45` writer"]
pub type W = crate::W<PCCR45_SPEC>;
#[doc = "Field `pwm45_clk_div_m` reader - PWM45 Clock Divide M"]
pub type PWM45_CLK_DIV_M_R = crate::FieldReader<PWM45_CLK_DIV_M_A>;
...
impl From<PWM45_CLK_DIV_M_A> for u8 {
    #[inline(always)]
    fn from(variant: PWM45_CLK_DIV_M_A) -> Self {
        variant as _
    }
}
impl crate::FieldSpec for PWM45_CLK_DIV_M_A {
    type Ux = u8;
}
impl PWM45_CLK_DIV_M_R {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
    pub const fn variant(&self) -> Option<PWM45_CLK_DIV_M_A> {
        match self.bits {
            0 => Some(PWM45_CLK_DIV_M_A::M1),
            1 => Some(PWM45_CLK_DIV_M_A::M2),
            2 => Some(PWM45_CLK_DIV_M_A::M4),
            3 => Some(PWM45_CLK_DIV_M_A::M8),
            4 => Some(PWM45_CLK_DIV_M_A::M16),
            5 => Some(PWM45_CLK_DIV_M_A::M32),
            6 => Some(PWM45_CLK_DIV_M_A::M64),
            7 => Some(PWM45_CLK_DIV_M_A::M128),
            8 => Some(PWM45_CLK_DIV_M_A::M256),
            _ => None,
        }
    }
    #[doc = "/1"]
    ...
    pub fn is_m1(&self) -> bool {
        *self == PWM45_CLK_DIV_M_A::M1
    }
    #[doc = "/2"]
    #[inline(always)]
    pub fn is_m2(&self) -> bool {
        *self == PWM45_CLK_DIV_M_A::M2
    }
    #[doc = "/4"]
    #[inline(always)]
    pub fn is_m4(&self) -> bool {
        *self == PWM45_CLK_DIV_M_A::M4
    }
    #[doc = "/8"]
    #[inline(always)]
    pub fn is_m8(&self) -> bool {
        *self == PWM45_CLK_DIV_M_A::M8
    }
    #[doc = "/16"]
    #[inline(always)]
    pub fn is_m16(&self) -> bool {
        *self == PWM45_CLK_DIV_M_A::M16
    }
    #[doc = "/32"]
    #[inline(always)]
    pub fn is_m32(&self) -> bool {
        *self == PWM45_CLK_DIV_M_A::M32
    }
    #[doc = "/64"]
    #[inline(always)]
    pub fn is_m64(&self) -> bool {
        *self == PWM45_CLK_DIV_M_A::M64
    }
    #[doc = "/128"]
    #[inline(always)]
    pub fn is_m128(&self) -> bool {
        *self == PWM45_CLK_DIV_M_A::M128
    }
    #[doc = "/256"]
    #[inline(always)]
    pub fn is_m256(&self) -> bool {
        *self == PWM45_CLK_DIV_M_A::M256
    }
}
#[doc = "Field `pwm45_clk_div_m` writer - PWM45 Clock Divide M"]
pub type PWM45_CLK_DIV_M_W<'a, REG> = crate::FieldWriter<'a, REG, 4, PWM45_CLK_DIV_M_A>;
impl<'a, REG> PWM45_CLK_DIV_M_W<'a, REG>
where
    ...
    REG::Ux: From<u8>,
{
    ...
    pub fn m1(self) -> &'a mut crate::W<REG> {
        self.variant(PWM45_CLK_DIV_M_A::M1)
    }
    #[doc = "/2"]
    #[inline(always)]
    pub fn m2(self) -> &'a mut crate::W<REG> {
        self.variant(PWM45_CLK_DIV_M_A::M2)
    }
    #[doc = "/4"]
    #[inline(always)]
    pub fn m4(self) -> &'a mut crate::W<REG> {
        self.variant(PWM45_CLK_DIV_M_A::M4)
    }
    #[doc = "/8"]
    #[inline(always)]
    pub fn m8(self) -> &'a mut crate::W<REG> {
        self.variant(PWM45_CLK_DIV_M_A::M8)
    }
    #[doc = "/16"]
    #[inline(always)]
    pub fn m16(self) -> &'a mut crate::W<REG> {
        self.variant(PWM45_CLK_DIV_M_A::M16)
    }
    #[doc = "/32"]
    #[inline(always)]
    pub fn m32(self) -> &'a mut crate::W<REG> {
        self.variant(PWM45_CLK_DIV_M_A::M32)
    }
    #[doc = "/64"]
    #[inline(always)]
    pub fn m64(self) -> &'a mut crate::W<REG> {
        self.variant(PWM45_CLK_DIV_M_A::M64)
    }
    #[doc = "/128"]
    #[inline(always)]
    pub fn m128(self) -> &'a mut crate::W<REG> {
        self.variant(PWM45_CLK_DIV_M_A::M128)
    }
    #[doc = "/256"]
    #[inline(always)]
...
pub type PWM45_CLK_SRC_SEL_R = crate::FieldReader<PWM45_CLK_SRC_SEL_A>;
...
impl crate::FieldSpec for PWM45_CLK_SRC_SEL_A {
    type Ux = u8;
}
impl PWM45_CLK_SRC_SEL_R {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
    pub const fn variant(&self) -> Option<PWM45_CLK_SRC_SEL_A> {
        match self.bits {
...
pub type PWM45_CLK_SRC_SEL_W<'a, REG> = crate::FieldWriter<'a, REG, 2, PWM45_CLK_SRC_SEL_A>;
impl<'a, REG> PWM45_CLK_SRC_SEL_W<'a, REG>
where
    REG: crate::Writable + crate::RegisterSpec,
    REG::Ux: From<u8>,
{
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn pwm45_clk_div_m(&mut self) -> PWM45_CLK_DIV_M_W<PCCR45_SPEC> {
        PWM45_CLK_DIV_M_W::new(self, 0)
    }
    #[doc = "Bits 7:8 - Select PWM45 Clock Source"]
    #[inline(always)]
    #[must_use]
    pub fn pwm45_clk_src_sel(&mut self) -> PWM45_CLK_SRC_SEL_W<PCCR45_SPEC> {
        PWM45_CLK_SRC_SEL_W::new(self, 7)
    }
