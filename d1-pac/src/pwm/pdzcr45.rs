...
pub type PWM45_DZ_INTV_W<'a> = crate::FieldWriter<'a, u32, PDZCR45_SPEC, u8, u8, 8, 8>;
...
pub type PWM45_DZ_EN_W<'a> = crate::BitWriter<'a, u32, PDZCR45_SPEC, PWM45_DZ_EN_A, 0>;
impl<'a> PWM45_DZ_EN_W<'a> {
...
impl W {
    #[doc = "Bits 8:15 - PWM45 Dead Zone Interval Value"]
    #[inline(always)]
    pub fn pwm45_dz_intv(&mut self) -> PWM45_DZ_INTV_W {
        PWM45_DZ_INTV_W::new(self)
    }
    #[doc = "Bit 0 - PWM45 Dead Zone Enable"]
    #[inline(always)]
    pub fn pwm45_dz_en(&mut self) -> PWM45_DZ_EN_W {
