...
pub struct R(crate::R<RF1P_CFG_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<RF1P_CFG_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<RF1P_CFG_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<RF1P_CFG_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `rf1p_cfg` writer"]
pub struct W(crate::W<RF1P_CFG_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<RF1P_CFG_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<RF1P_CFG_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<RF1P_CFG_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type RF1P_CFG_W<'a, const O: u8> = crate::FieldWriter<'a, u32, RF1P_CFG_SPEC, u8, u8, 8, O>;
impl R {
