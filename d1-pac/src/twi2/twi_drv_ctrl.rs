...
pub struct START_TRAN_R(crate::FieldReader<bool, START_TRAN_A>);
impl START_TRAN_R {
    #[inline(always)]
...
impl core::ops::Deref for START_TRAN_R {
    type Target = crate::FieldReader<bool, START_TRAN_A>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
pub struct RESTART_MODE_R(crate::FieldReader<bool, RESTART_MODE_A>);
impl RESTART_MODE_R {
    #[inline(always)]
    pub(crate) fn new(bits: bool) -> Self {
...
impl core::ops::Deref for RESTART_MODE_R {
    type Target = crate::FieldReader<bool, RESTART_MODE_A>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
pub struct READ_TRAN_MODE_R(crate::FieldReader<bool, READ_TRAN_MODE_A>);
...
impl core::ops::Deref for READ_TRAN_MODE_R {
    type Target = crate::FieldReader<bool, READ_TRAN_MODE_A>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
pub struct TRAN_RESULT_R(crate::FieldReader<u8, TRAN_RESULT_A>);
impl TRAN_RESULT_R {
    #[inline(always)]
...
impl core::ops::Deref for TRAN_RESULT_R {
    type Target = crate::FieldReader<u8, TRAN_RESULT_A>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
pub struct TWI_STA_R(crate::FieldReader<u8, TWI_STA_A>);
impl TWI_STA_R {
    #[inline(always)]
    pub(crate) fn new(bits: u8) -> Self {
...
impl core::ops::Deref for TWI_STA_R {
    type Target = crate::FieldReader<u8, TWI_STA_A>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
pub struct TIMEOUT_N_R(crate::FieldReader<u8, u8>);
impl TIMEOUT_N_R {
    #[inline(always)]
    pub(crate) fn new(bits: u8) -> Self {
...
pub struct SOFT_RESET_R(crate::FieldReader<bool, SOFT_RESET_A>);
impl SOFT_RESET_R {
    #[inline(always)]
    pub(crate) fn new(bits: bool) -> Self {
...
impl core::ops::Deref for SOFT_RESET_R {
    type Target = crate::FieldReader<bool, SOFT_RESET_A>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
pub struct TWI_DRV_EN_R(crate::FieldReader<bool, TWI_DRV_EN_A>);
impl TWI_DRV_EN_R {
    #[inline(always)]
    pub(crate) fn new(bits: bool) -> Self {
...
impl core::ops::Deref for TWI_DRV_EN_R {
    type Target = crate::FieldReader<bool, TWI_DRV_EN_A>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
