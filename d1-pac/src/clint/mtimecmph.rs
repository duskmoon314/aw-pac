...
pub struct R(crate::R<MTIMECMPH_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<MTIMECMPH_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<MTIMECMPH_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<MTIMECMPH_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `mtimecmph` writer"]
pub struct W(crate::W<MTIMECMPH_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<MTIMECMPH_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<MTIMECMPH_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<MTIMECMPH_SPEC>) -> Self {
        W(writer)
    }
}
impl W {
