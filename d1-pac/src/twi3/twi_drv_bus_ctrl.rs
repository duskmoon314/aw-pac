...
pub struct SCL_STA_R(crate::FieldReader<bool, bool>);
impl SCL_STA_R {
    #[inline(always)]
    pub(crate) fn new(bits: bool) -> Self {
...
pub struct SDA_STA_R(crate::FieldReader<bool, bool>);
impl SDA_STA_R {
    #[inline(always)]
    pub(crate) fn new(bits: bool) -> Self {
...
pub struct SCL_MOV_R(crate::FieldReader<bool, bool>);
impl SCL_MOV_R {
    #[inline(always)]
    pub(crate) fn new(bits: bool) -> Self {
...
pub struct SDA_MOV_R(crate::FieldReader<bool, bool>);
impl SDA_MOV_R {
    #[inline(always)]
    pub(crate) fn new(bits: bool) -> Self {
...
pub struct SCL_MOE_R(crate::FieldReader<bool, bool>);
impl SCL_MOE_R {
    #[inline(always)]
    pub(crate) fn new(bits: bool) -> Self {
...
pub struct SDA_MOE_R(crate::FieldReader<bool, bool>);
impl SDA_MOE_R {
    #[inline(always)]
    pub(crate) fn new(bits: bool) -> Self {
