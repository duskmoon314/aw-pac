...
pub type R = crate::R<HPF_GAIN_SPEC>;
#[doc = "Register `hpf_gain` writer"]
pub type W = crate::W<HPF_GAIN_SPEC>;
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        write!(f, "{}", self.bits())
    }
}
impl core::fmt::Debug for crate::generic::Reg<HPF_GAIN_SPEC> {
...
#[doc = "High Pass Filter Gain Register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`hpf_gain::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`hpf_gain::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
