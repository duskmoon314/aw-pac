...
pub struct R(crate::R<DMIC_EN_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<DMIC_EN_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<DMIC_EN_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<DMIC_EN_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `dmic_en` writer"]
pub struct W(crate::W<DMIC_EN_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<DMIC_EN_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<DMIC_EN_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<DMIC_EN_SPEC>) -> Self {
        W(writer)
    }
}
impl W {
