...
#[doc = "Register `THS_DATA` writer"]
pub struct W(crate::W<THS_DATA_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<THS_DATA_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<THS_DATA_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<THS_DATA_SPEC>) -> Self {
        W(writer)
    }
}
impl W {
...
#[doc = "`write(|w| ..)` method takes [ths_data::W](W) writer structure"]
impl crate::Writable for THS_DATA_SPEC {
    type Writer = W;
}
