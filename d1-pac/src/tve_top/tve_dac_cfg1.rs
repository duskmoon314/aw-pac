...
impl crate::FieldSpec for REF1_SEL_A {
    type Ux = u8;
}
impl REF1_SEL_R {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
    pub const fn variant(&self) -> REF1_SEL_A {
        match self.bits {
...
pub type REF1_SEL_W<'a, REG> = crate::FieldWriterSafe<'a, REG, 4, REF1_SEL_A>;
impl<'a, REG> REF1_SEL_W<'a, REG>
where
    ...
    REG::Ux: From<u8>,
{
    #[doc = "0.50 V"]
    #[inline(always)]
    pub fn _0_50_v(self) -> &'a mut crate::W<REG> {
        self.variant(REF1_SEL_A::_0_50_V)
    }
    #[doc = "0.55 V"]
    #[inline(always)]
    pub fn _0_55_v(self) -> &'a mut crate::W<REG> {
        self.variant(REF1_SEL_A::_0_55_V)
    }
    #[doc = "0.60 V"]
    #[inline(always)]
    pub fn _0_60_v(self) -> &'a mut crate::W<REG> {
        self.variant(REF1_SEL_A::_0_60_V)
    }
    #[doc = "0.65 V"]
    #[inline(always)]
    pub fn _0_65_v(self) -> &'a mut crate::W<REG> {
        self.variant(REF1_SEL_A::_0_65_V)
    }
    #[doc = "0.70 V"]
    #[inline(always)]
    pub fn _0_70_v(self) -> &'a mut crate::W<REG> {
        self.variant(REF1_SEL_A::_0_70_V)
    }
    #[doc = "0.75 V"]
    #[inline(always)]
    pub fn _0_75_v(self) -> &'a mut crate::W<REG> {
        self.variant(REF1_SEL_A::_0_75_V)
    }
    #[doc = "0.80 V"]
    #[inline(always)]
    pub fn _0_80_v(self) -> &'a mut crate::W<REG> {
        self.variant(REF1_SEL_A::_0_80_V)
    }
    #[doc = "0.85 V"]
    #[inline(always)]
    pub fn _0_85_v(self) -> &'a mut crate::W<REG> {
        self.variant(REF1_SEL_A::_0_85_V)
    }
    #[doc = "0.90 V"]
    #[inline(always)]
    pub fn _0_90_v(self) -> &'a mut crate::W<REG> {
        self.variant(REF1_SEL_A::_0_90_V)
    }
    #[doc = "0.95 V"]
    #[inline(always)]
    pub fn _0_95_v(self) -> &'a mut crate::W<REG> {
        self.variant(REF1_SEL_A::_0_95_V)
    }
    #[doc = "1.00 V"]
    #[inline(always)]
    pub fn _1_00_v(self) -> &'a mut crate::W<REG> {
        self.variant(REF1_SEL_A::_1_00_V)
    }
    #[doc = "1.05 V"]
    #[inline(always)]
    pub fn _1_05_v(self) -> &'a mut crate::W<REG> {
        self.variant(REF1_SEL_A::_1_05_V)
    }
    #[doc = "1.10 V"]
    #[inline(always)]
    pub fn _1_10_v(self) -> &'a mut crate::W<REG> {
        self.variant(REF1_SEL_A::_1_10_V)
    }
    #[doc = "1.15 V"]
    #[inline(always)]
    pub fn _1_15_v(self) -> &'a mut crate::W<REG> {
        self.variant(REF1_SEL_A::_1_15_V)
    }
    #[doc = "1.20 V"]
    #[inline(always)]
    pub fn _1_20_v(self) -> &'a mut crate::W<REG> {
        self.variant(REF1_SEL_A::_1_20_V)
    }
    #[doc = "1.25 V"]
    #[inline(always)]
    pub fn _1_25_v(self) -> &'a mut crate::W<REG> {
        self.variant(REF1_SEL_A::_1_25_V)
    }
}
#[doc = "Field `ref2_sel` reader - (a_refslct2\\[1:0\\])"]
pub type REF2_SEL_R = crate::FieldReader<REF2_SEL_A>;
#[doc = "(a_refslct2\\[1:0\\])\n\nValue on reset: 3"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
#[repr(u8)]
pub enum REF2_SEL_A {
...
impl crate::FieldSpec for REF2_SEL_A {
    type Ux = u8;
}
impl REF2_SEL_R {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
    pub const fn variant(&self) -> REF2_SEL_A {
        match self.bits {
...
pub type REF2_SEL_W<'a, REG> = crate::FieldWriterSafe<'a, REG, 2, REF2_SEL_A>;
impl<'a, REG> REF2_SEL_W<'a, REG>
where
    REG: crate::Writable + crate::RegisterSpec,
    REG::Ux: From<u8>,
{
    #[doc = "0.25 V"]
    #[inline(always)]
    pub fn _0_25_v(self) -> &'a mut crate::W<REG> {
        self.variant(REF2_SEL_A::_0_25_V)
    }
    #[doc = "0.30 V"]
    #[inline(always)]
    pub fn _0_30_v(self) -> &'a mut crate::W<REG> {
        self.variant(REF2_SEL_A::_0_30_V)
    }
    #[doc = "0.35 V"]
    #[inline(always)]
    pub fn _0_35_v(self) -> &'a mut crate::W<REG> {
        self.variant(REF2_SEL_A::_0_35_V)
    }
    #[doc = "0.40 V"]
    #[inline(always)]
    pub fn _0_40_v(self) -> &'a mut crate::W<REG> {
...
impl REF_INT_SEL_R {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
    pub const fn variant(&self) -> REF_INT_SEL_A {
        match self.bits {
...
pub type REF_INT_SEL_W<'a, REG> = crate::BitWriter<'a, REG, REF_INT_SEL_A>;
impl<'a, REG> REF_INT_SEL_W<'a, REG>
where
    REG: crate::Writable + crate::RegisterSpec,
{
    #[doc = "Disable"]
...
impl REF_EXT_SEL_R {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
    pub const fn variant(&self) -> REF_EXT_SEL_A {
        match self.bits {
...
pub type REF_EXT_SEL_W<'a, REG> = crate::BitWriter<'a, REG, REF_EXT_SEL_A>;
impl<'a, REG> REF_EXT_SEL_W<'a, REG>
where
    REG: crate::Writable + crate::RegisterSpec,
{
    #[doc = "Disable"]
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn ref1_sel(&mut self) -> REF1_SEL_W<TVE_DAC_CFG1_SPEC> {
        REF1_SEL_W::new(self, 0)
    }
    #[doc = "Bits 4:5 - (a_refslct2\\[1:0\\])"]
    #[inline(always)]
    #[must_use]
    pub fn ref2_sel(&mut self) -> REF2_SEL_W<TVE_DAC_CFG1_SPEC> {
        REF2_SEL_W::new(self, 4)
    }
    #[doc = "Bit 8 - (A_SEL_DETREF_RES)"]
    #[inline(always)]
    #[must_use]
    pub fn ref_int_sel(&mut self) -> REF_INT_SEL_W<TVE_DAC_CFG1_SPEC> {
        REF_INT_SEL_W::new(self, 8)
    }
    #[doc = "Bit 9 - (A_SEL_DETREF_LDO)"]
    #[inline(always)]
    #[must_use]
    pub fn ref_ext_sel(&mut self) -> REF_EXT_SEL_W<TVE_DAC_CFG1_SPEC> {
        REF_EXT_SEL_W::new(self, 9)
    }
...
#[doc = "TV Encoder DAC CFG1 Register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`tve_dac_cfg1::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`tve_dac_cfg1::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
