...
pub type R = crate::R<TVE_DAC_CFG0_SPEC>;
#[doc = "Register `tve_dac_cfg0` writer"]
pub type W = crate::W<TVE_DAC_CFG0_SPEC>;
...
impl DAC_EN_R {
    ...
    #[inline(always)]
    pub const fn variant(&self) -> DAC_EN_A {
        match self.bits {
...
pub type DAC_EN_W<'a, REG> = crate::BitWriter<'a, REG, DAC_EN_A>;
impl<'a, REG> DAC_EN_W<'a, REG>
where
...
impl BIAS_REF_INT_EN_R {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
    pub const fn variant(&self) -> BIAS_REF_INT_EN_A {
        match self.bits {
...
pub type BIAS_REF_INT_EN_W<'a, REG> = crate::BitWriter<'a, REG, BIAS_REF_INT_EN_A>;
impl<'a, REG> BIAS_REF_INT_EN_W<'a, REG>
where
    REG: crate::Writable + crate::RegisterSpec,
{
    #[doc = "Disable"]
...
impl BIAS_INT_SEL_R {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
    pub const fn variant(&self) -> BIAS_INT_SEL_A {
        match self.bits {
...
pub type BIAS_INT_SEL_W<'a, REG> = crate::BitWriter<'a, REG, BIAS_INT_SEL_A>;
impl<'a, REG> BIAS_INT_SEL_W<'a, REG>
where
    REG: crate::Writable + crate::RegisterSpec,
{
    #[doc = "Disable"]
...
impl BIAS_EXT_SEL_R {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
    pub const fn variant(&self) -> BIAS_EXT_SEL_A {
        match self.bits {
...
pub type BIAS_EXT_SEL_W<'a, REG> = crate::BitWriter<'a, REG, BIAS_EXT_SEL_A>;
impl<'a, REG> BIAS_EXT_SEL_W<'a, REG>
where
    REG: crate::Writable + crate::RegisterSpec,
{
    #[doc = "Disable"]
...
pub type LOW_BIAS_R = crate::FieldReader;
#[doc = "Field `low_bias` writer - 500 uA to 4 mA"]
pub type LOW_BIAS_W<'a, REG> = crate::FieldWriter<'a, REG, 4>;
#[doc = "Field `cali_in` reader - "]
pub type CALI_IN_R = crate::FieldReader<u16>;
#[doc = "Field `cali_in` writer - "]
pub type CALI_IN_W<'a, REG> = crate::FieldWriter<'a, REG, 10, u16>;
...
impl DAC_CLOCK_INVERT_R {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
    pub const fn variant(&self) -> DAC_CLOCK_INVERT_A {
        match self.bits {
...
pub type DAC_CLOCK_INVERT_W<'a, REG> = crate::BitWriter<'a, REG, DAC_CLOCK_INVERT_A>;
impl<'a, REG> DAC_CLOCK_INVERT_W<'a, REG>
where
    REG: crate::Writable + crate::RegisterSpec,
{
    #[doc = "Not invert"]
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn dac_en(&mut self) -> DAC_EN_W<TVE_DAC_CFG0_SPEC> {
        DAC_EN_W::new(self, 0)
    }
    #[doc = "Bit 4 - (A_EN_RESREF)"]
    #[inline(always)]
    #[must_use]
    pub fn bias_ref_int_en(&mut self) -> BIAS_REF_INT_EN_W<TVE_DAC_CFG0_SPEC> {
        BIAS_REF_INT_EN_W::new(self, 4)
    }
    #[doc = "Bit 8 - (A_SEL_BIAS_RES)"]
    #[inline(always)]
    #[must_use]
    pub fn bias_int_sel(&mut self) -> BIAS_INT_SEL_W<TVE_DAC_CFG0_SPEC> {
        BIAS_INT_SEL_W::new(self, 8)
    }
    #[doc = "Bit 9 - (A_SEL_BIAS_ADDA)"]
    #[inline(always)]
    #[must_use]
    pub fn bias_ext_sel(&mut self) -> BIAS_EXT_SEL_W<TVE_DAC_CFG0_SPEC> {
        BIAS_EXT_SEL_W::new(self, 9)
    }
    #[doc = "Bits 12:15 - 500 uA to 4 mA"]
    #[inline(always)]
    #[must_use]
    pub fn low_bias(&mut self) -> LOW_BIAS_W<TVE_DAC_CFG0_SPEC> {
        LOW_BIAS_W::new(self, 12)
    }
    #[doc = "Bits 16:25"]
    #[inline(always)]
    #[must_use]
    pub fn cali_in(&mut self) -> CALI_IN_W<TVE_DAC_CFG0_SPEC> {
        CALI_IN_W::new(self, 16)
    }
    #[doc = "Bit 31"]
    #[inline(always)]
    #[must_use]
    pub fn dac_clock_invert(&mut self) -> DAC_CLOCK_INVERT_W<TVE_DAC_CFG0_SPEC> {
        DAC_CLOCK_INVERT_W::new(self, 31)
    }
...
#[doc = "TV Encoder DAC CFG0 Register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`tve_dac_cfg0::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`tve_dac_cfg0::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
