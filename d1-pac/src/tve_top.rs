...
#[doc = "tve_dac_map (rw) register accessor: an alias for `Reg<TVE_DAC_MAP_SPEC>`"]
pub type TVE_DAC_MAP = crate::Reg<tve_dac_map::TVE_DAC_MAP_SPEC>;
#[doc = "TV Encoder DAC MAP Register"]
pub mod tve_dac_map;
#[doc = "tve_dac_status (rw) register accessor: an alias for `Reg<TVE_DAC_STATUS_SPEC>`"]
