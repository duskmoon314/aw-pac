...
pub struct TIMEOUT_THRESHOLD_R(crate::FieldReader<u16, u16>);
...
pub struct TIMEOUT_ENABLE_R(crate::FieldReader<bool, bool>);
...
pub struct AHB_BURST_MODE_R(crate::FieldReader<u8, AHB_BURST_MODE_A>);
...
impl core::ops::Deref for AHB_BURST_MODE_R {
    type Target = crate::FieldReader<u8, AHB_BURST_MODE_A>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
pub struct BLK_SIZE_R(crate::FieldReader<u8, BLK_SIZE_A>);
impl BLK_SIZE_R {
    #[inline(always)]
    pub(crate) fn new(bits: u8) -> Self {
...
impl core::ops::Deref for BLK_SIZE_R {
    type Target = crate::FieldReader<u8, BLK_SIZE_A>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
