...
pub struct PTE_R(crate::FieldReader<bool, bool>);
impl PTE_R {
    #[inline(always)]
...
pub struct DMA_PTE_RX_R(crate::FieldReader<bool, bool>);
impl DMA_PTE_RX_R {
    #[inline(always)]
    pub(crate) fn new(bits: bool) -> Self {
...
pub struct SIR_RX_INVERT_R(crate::FieldReader<bool, SIR_RX_INVERT_A>);
...
impl core::ops::Deref for SIR_RX_INVERT_R {
    type Target = crate::FieldReader<bool, SIR_RX_INVERT_A>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
pub struct SIR_TX_INVERT_R(crate::FieldReader<bool, SIR_TX_INVERT_A>);
...
impl core::ops::Deref for SIR_TX_INVERT_R {
    type Target = crate::FieldReader<bool, SIR_TX_INVERT_A>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
pub struct CHANGE_UPDATE_R(crate::FieldReader<bool, CHANGE_UPDATE_A>);
...
impl core::ops::Deref for CHANGE_UPDATE_R {
    type Target = crate::FieldReader<bool, CHANGE_UPDATE_A>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
pub struct CHCFG_AT_BUSY_R(crate::FieldReader<bool, CHCFG_AT_BUSY_A>);
...
impl core::ops::Deref for CHCFG_AT_BUSY_R {
    type Target = crate::FieldReader<bool, CHCFG_AT_BUSY_A>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
pub struct HALT_TX_R(crate::FieldReader<bool, HALT_TX_A>);
impl HALT_TX_R {
    #[inline(always)]
    pub(crate) fn new(bits: bool) -> Self {
...
impl core::ops::Deref for HALT_TX_R {
    type Target = crate::FieldReader<bool, HALT_TX_A>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
