...
pub type CHEN_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, I2S_PCM_TX0CHSEL_SPEC, u16, u16, 16, O>;
...
pub type CHSEL_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, I2S_PCM_TX0CHSEL_SPEC, u8, u8, 4, O>;
...
pub type OFFSET_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, I2S_PCM_TX0CHSEL_SPEC, u8, u8, 2, O>;
impl R {
