...
pub type R = crate::R<I2S_PCM_TX3CHMAP0_SPEC>;
#[doc = "Register `i2s_pcm_tx3chmap0` writer"]
pub type W = crate::W<I2S_PCM_TX3CHMAP0_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn ch_map(&mut self, n: u8) -> CH_MAP_W<I2S_PCM_TX3CHMAP0_SPEC> {
        #[allow(clippy::no_effect)]
        [(); 8][n as usize];
    ...
    #[inline(always)]
    #[must_use]
    pub fn ch8_map(&mut self) -> CH_MAP_W<I2S_PCM_TX3CHMAP0_SPEC> {
        CH_MAP_W::new(self, 0)
    }
    #[doc = "Bits 4:7 - Channel 9 mapping\n\n0000: The first sample\n\n...\n\n1111: The sixteenth sample"]
    #[inline(always)]
    #[must_use]
    pub fn ch9_map(&mut self) -> CH_MAP_W<I2S_PCM_TX3CHMAP0_SPEC> {
        CH_MAP_W::new(self, 4)
    }
    #[doc = "Bits 8:11 - Channel 10 mapping\n\n0000: The first sample\n\n...\n\n1111: The sixteenth sample"]
    #[inline(always)]
    #[must_use]
    pub fn ch10_map(&mut self) -> CH_MAP_W<I2S_PCM_TX3CHMAP0_SPEC> {
        CH_MAP_W::new(self, 8)
    }
    #[doc = "Bits 12:15 - Channel 11 mapping\n\n0000: The first sample\n\n...\n\n1111: The sixteenth sample"]
    #[inline(always)]
    #[must_use]
    pub fn ch11_map(&mut self) -> CH_MAP_W<I2S_PCM_TX3CHMAP0_SPEC> {
        CH_MAP_W::new(self, 12)
    }
    #[doc = "Bits 16:19 - Channel 12 mapping\n\n0000: The first sample\n\n...\n\n1111: The sixteenth sample"]
    #[inline(always)]
    #[must_use]
    pub fn ch12_map(&mut self) -> CH_MAP_W<I2S_PCM_TX3CHMAP0_SPEC> {
        CH_MAP_W::new(self, 16)
    }
    #[doc = "Bits 20:23 - Channel 13 mapping\n\n0000: The first sample\n\n...\n\n1111: The sixteenth sample"]
    #[inline(always)]
    #[must_use]
    pub fn ch13_map(&mut self) -> CH_MAP_W<I2S_PCM_TX3CHMAP0_SPEC> {
        CH_MAP_W::new(self, 20)
    }
    #[doc = "Bits 24:27 - Channel 14 mapping\n\n0000: The first sample\n\n...\n\n1111: The sixteenth sample"]
    #[inline(always)]
    #[must_use]
    pub fn ch14_map(&mut self) -> CH_MAP_W<I2S_PCM_TX3CHMAP0_SPEC> {
        CH_MAP_W::new(self, 24)
    }
    #[doc = "Bits 28:31 - Channel 15 mapping\n\n0000: The first sample\n\n...\n\n1111: The sixteenth sample"]
    #[inline(always)]
    #[must_use]
    pub fn ch15_map(&mut self) -> CH_MAP_W<I2S_PCM_TX3CHMAP0_SPEC> {
...
#[doc = "I2S/PCM TX3 Channel Mapping Register0\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`i2s_pcm_tx3chmap0::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`i2s_pcm_tx3chmap0::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
