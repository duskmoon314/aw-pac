...
pub struct R(crate::R<I2S_PCM_TX1CHSEL_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<I2S_PCM_TX1CHSEL_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<I2S_PCM_TX1CHSEL_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<I2S_PCM_TX1CHSEL_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `i2s_pcm_tx1chsel` writer"]
pub struct W(crate::W<I2S_PCM_TX1CHSEL_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<I2S_PCM_TX1CHSEL_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<I2S_PCM_TX1CHSEL_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<I2S_PCM_TX1CHSEL_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type CHEN_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, I2S_PCM_TX1CHSEL_SPEC, u16, u16, 16, O>;
...
pub type CHSEL_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, I2S_PCM_TX1CHSEL_SPEC, u8, u8, 4, O>;
...
pub type OFFSET_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, I2S_PCM_TX1CHSEL_SPEC, u8, u8, 2, O>;
impl R {
