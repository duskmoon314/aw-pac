...
pub type R = crate::R<I2S_PCM_RXCHMAP1_SPEC>;
#[doc = "Register `i2s_pcm_rxchmap1` writer"]
pub type W = crate::W<I2S_PCM_RXCHMAP1_SPEC>;
...
impl R {
    ...
    #[doc = "RX Channel [8-11] Select\n\nNOTE: `n` is number of field in register. `n == 0` corresponds to `ch8_select` field"]
    #[inline(always)]
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn ch_map(&mut self, n: u8) -> CH_MAP_W<I2S_PCM_RXCHMAP1_SPEC> {
        #[allow(clippy::no_effect)]
        [(); 4][n as usize];
    ...
    #[inline(always)]
    #[must_use]
    pub fn ch8_map(&mut self) -> CH_MAP_W<I2S_PCM_RXCHMAP1_SPEC> {
        CH_MAP_W::new(self, 0)
    }
    #[doc = "Bits 8:11 - RX Channel 9 mapping\n\n0000: The first sample\n\n...\n\n1111: The sixteenth sample"]
    #[inline(always)]
    #[must_use]
    pub fn ch9_map(&mut self) -> CH_MAP_W<I2S_PCM_RXCHMAP1_SPEC> {
        CH_MAP_W::new(self, 8)
    }
    #[doc = "Bits 16:19 - RX Channel 10 mapping\n\n0000: The first sample\n\n...\n\n1111: The sixteenth sample"]
    #[inline(always)]
    #[must_use]
    pub fn ch10_map(&mut self) -> CH_MAP_W<I2S_PCM_RXCHMAP1_SPEC> {
        CH_MAP_W::new(self, 16)
    }
    #[doc = "Bits 24:27 - RX Channel 11 mapping\n\n0000: The first sample\n\n...\n\n1111: The sixteenth sample"]
    #[inline(always)]
    #[must_use]
    pub fn ch11_map(&mut self) -> CH_MAP_W<I2S_PCM_RXCHMAP1_SPEC> {
        CH_MAP_W::new(self, 24)
    }
    #[doc = "RX Channel [8-11] Select\n\nNOTE: `n` is number of field in register. `n == 0` corresponds to `ch8_select` field"]
    #[inline(always)]
    #[must_use]
    pub fn ch_select(&mut self, n: u8) -> CH_SELECT_W<I2S_PCM_RXCHMAP1_SPEC> {
        #[allow(clippy::no_effect)]
        [(); 4][n as usize];
    ...
    #[inline(always)]
    #[must_use]
    pub fn ch8_select(&mut self) -> CH_SELECT_W<I2S_PCM_RXCHMAP1_SPEC> {
        CH_SELECT_W::new(self, 4)
    }
    #[doc = "Bits 12:13 - RX Channel 9 Select"]
    #[inline(always)]
    #[must_use]
    pub fn ch9_select(&mut self) -> CH_SELECT_W<I2S_PCM_RXCHMAP1_SPEC> {
        CH_SELECT_W::new(self, 12)
    }
    #[doc = "Bits 20:21 - RX Channel 10 Select"]
    #[inline(always)]
    #[must_use]
    pub fn ch10_select(&mut self) -> CH_SELECT_W<I2S_PCM_RXCHMAP1_SPEC> {
        CH_SELECT_W::new(self, 20)
    }
    #[doc = "Bits 28:29 - RX Channel 11 Select"]
    #[inline(always)]
    #[must_use]
    pub fn ch11_select(&mut self) -> CH_SELECT_W<I2S_PCM_RXCHMAP1_SPEC> {
...
#[doc = "I2S/PCM RX Channel Mapping Register1\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`i2s_pcm_rxchmap1::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`i2s_pcm_rxchmap1::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
