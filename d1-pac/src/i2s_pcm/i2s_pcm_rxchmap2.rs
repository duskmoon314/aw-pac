...
pub type CH_MAP_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, I2S_PCM_RXCHMAP2_SPEC, u8, u8, 4, O>;
...
pub type CH_SELECT_W<'a, const O: u8> =
    crate::FieldWriterSafe<'a, u32, I2S_PCM_RXCHMAP2_SPEC, u8, CH_SELECT_A, 2, O>;
...
impl R {
    ...
    pub unsafe fn ch_map(&self, n: u8) -> CH_MAP_R {
        CH_MAP_R::new(((self.bits >> ((n - 4) * 8)) & 0x0f) as u8)
    }
    ...
    pub unsafe fn ch_select(&self, n: u8) -> CH_SELECT_R {
        CH_SELECT_R::new(((self.bits >> ((n - 4) * 8 + 4)) & 3) as u8)
    }
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn ch4_map(&mut self) -> CH_MAP_W<0> {
        CH_MAP_W::new(self)
    }
    #[doc = "Bits 8:11 - RX Channel 5 mapping\n\n0000: The first sample\n\n...\n\n1111: The sixteenth sample"]
    #[inline(always)]
    #[must_use]
    pub fn ch5_map(&mut self) -> CH_MAP_W<8> {
        CH_MAP_W::new(self)
    }
    #[doc = "Bits 16:19 - RX Channel 6 mapping\n\n0000: The first sample\n\n...\n\n1111: The sixteenth sample"]
    #[inline(always)]
    #[must_use]
    pub fn ch6_map(&mut self) -> CH_MAP_W<16> {
        CH_MAP_W::new(self)
    }
    #[doc = "Bits 24:27 - RX Channel 7 mapping\n\n0000: The first sample\n\n...\n\n1111: The sixteenth sample"]
    #[inline(always)]
    #[must_use]
    pub fn ch7_map(&mut self) -> CH_MAP_W<24> {
        CH_MAP_W::new(self)
    }
    #[doc = "RX Channel [4-7] Select"]
    #[inline(always)]
    ...
    #[inline(always)]
    #[must_use]
    pub fn ch4_select(&mut self) -> CH_SELECT_W<4> {
        CH_SELECT_W::new(self)
    }
    #[doc = "Bits 12:13 - RX Channel 5 Select"]
    #[inline(always)]
    #[must_use]
    pub fn ch5_select(&mut self) -> CH_SELECT_W<12> {
        CH_SELECT_W::new(self)
    }
    #[doc = "Bits 20:21 - RX Channel 6 Select"]
    #[inline(always)]
    #[must_use]
    pub fn ch6_select(&mut self) -> CH_SELECT_W<20> {
        CH_SELECT_W::new(self)
    }
    #[doc = "Bits 28:29 - RX Channel 7 Select"]
    #[inline(always)]
    #[must_use]
    pub fn ch7_select(&mut self) -> CH_SELECT_W<28> {
        CH_SELECT_W::new(self)
    }
