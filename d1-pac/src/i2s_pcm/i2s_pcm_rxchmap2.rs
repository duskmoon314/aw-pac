...
pub type R = crate::R<I2S_PCM_RXCHMAP2_SPEC>;
#[doc = "Register `i2s_pcm_rxchmap2` writer"]
pub type W = crate::W<I2S_PCM_RXCHMAP2_SPEC>;
#[doc = "Field `ch_map[4-7]` reader - RX Channel %s mapping\n\n0000: The first sample\n\n...\n\n1111: The sixteenth sample"]
pub type CH_MAP_R = crate::FieldReader;
#[doc = "Field `ch_map[4-7]` writer - RX Channel %s mapping\n\n0000: The first sample\n\n...\n\n1111: The sixteenth sample"]
pub type CH_MAP_W<'a, REG> = crate::FieldWriter<'a, REG, 4>;
#[doc = "Field `ch_select[4-7]` reader - RX Channel %s Select"]
...
#[doc = "Field `ch_select[4-7]` writer - RX Channel %s Select"]
...
impl R {
    #[doc = "RX Channel [4-7] mapping\n\n0000: The first sample\n\n...\n\n1111: The sixteenth sample\n\nNOTE: `n` is number of field in register. `n == 0` corresponds to `ch4_map` field"]
    #[inline(always)]
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn ch_map(&mut self, n: u8) -> CH_MAP_W<I2S_PCM_RXCHMAP2_SPEC> {
        #[allow(clippy::no_effect)]
        [(); 4][n as usize];
    ...
    #[inline(always)]
    #[must_use]
    pub fn ch4_map(&mut self) -> CH_MAP_W<I2S_PCM_RXCHMAP2_SPEC> {
        CH_MAP_W::new(self, 0)
    }
    #[doc = "Bits 8:11 - RX Channel 5 mapping\n\n0000: The first sample\n\n...\n\n1111: The sixteenth sample"]
    #[inline(always)]
    #[must_use]
    pub fn ch5_map(&mut self) -> CH_MAP_W<I2S_PCM_RXCHMAP2_SPEC> {
        CH_MAP_W::new(self, 8)
    }
    #[doc = "Bits 16:19 - RX Channel 6 mapping\n\n0000: The first sample\n\n...\n\n1111: The sixteenth sample"]
    #[inline(always)]
    #[must_use]
    pub fn ch6_map(&mut self) -> CH_MAP_W<I2S_PCM_RXCHMAP2_SPEC> {
        CH_MAP_W::new(self, 16)
    }
    #[doc = "Bits 24:27 - RX Channel 7 mapping\n\n0000: The first sample\n\n...\n\n1111: The sixteenth sample"]
    #[inline(always)]
    #[must_use]
    pub fn ch7_map(&mut self) -> CH_MAP_W<I2S_PCM_RXCHMAP2_SPEC> {
        CH_MAP_W::new(self, 24)
    }
    #[doc = "RX Channel [4-7] Select\n\nNOTE: `n` is number of field in register. `n == 0` corresponds to `ch4_select` field"]
    #[inline(always)]
    #[must_use]
    pub fn ch_select(&mut self, n: u8) -> CH_SELECT_W<I2S_PCM_RXCHMAP2_SPEC> {
        #[allow(clippy::no_effect)]
        [(); 4][n as usize];
    ...
    #[inline(always)]
    #[must_use]
    pub fn ch4_select(&mut self) -> CH_SELECT_W<I2S_PCM_RXCHMAP2_SPEC> {
        CH_SELECT_W::new(self, 4)
    }
    #[doc = "Bits 12:13 - RX Channel 5 Select"]
    #[inline(always)]
    #[must_use]
    pub fn ch5_select(&mut self) -> CH_SELECT_W<I2S_PCM_RXCHMAP2_SPEC> {
        CH_SELECT_W::new(self, 12)
    }
    #[doc = "Bits 20:21 - RX Channel 6 Select"]
    #[inline(always)]
    #[must_use]
    pub fn ch6_select(&mut self) -> CH_SELECT_W<I2S_PCM_RXCHMAP2_SPEC> {
        CH_SELECT_W::new(self, 20)
    }
    #[doc = "Bits 28:29 - RX Channel 7 Select"]
    #[inline(always)]
    #[must_use]
    pub fn ch7_select(&mut self) -> CH_SELECT_W<I2S_PCM_RXCHMAP2_SPEC> {
