...
pub struct RegisterBlock {
    ...
    pub dsp_boot_rammap: DSP_BOOT_RAMMAP,
    _reserved1: [u8; 0x18],
    #[doc = "0x24 - Version Register"]
    pub ver: VER,
    _reserved2: [u8; 0x08],
    #[doc = "0x30 - EMAC-EPHY Clock Register 0"]
    pub emac_ephy_clk0: EMAC_EPHY_CLK0,
    _reserved3: [u8; 0x011c],
    #[doc = "0x150 - System LDO Control Register"]
    pub sys_ldo_ctrl: SYS_LDO_CTRL,
    _reserved4: [u8; 0x0c],
    #[doc = "0x160 - Resistor Calibration Control Register"]
    pub rescal_ctrl: RESCAL_CTRL,
    _reserved5: [u8; 0x04],
    #[doc = "0x168 - 240ohms Resistor Manual Control Register"]
    pub res240_ctrl: RES240_CTRL,
    #[doc = "0x16c - Resistor Calibration Status Register"]
    pub rescal_status: RESCAL_STATUS,
}
#[doc = "dsp_boot_rammap (rw) register accessor: an alias for `Reg<DSP_BOOT_RAMMAP_SPEC>`"]
