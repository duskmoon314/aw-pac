...
pub type R = crate::R<RXDMA_IE_SPEC>;
#[doc = "Register `rxdma_ie` writer"]
pub type W = crate::W<RXDMA_IE_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn limit_done(&mut self) -> LIMIT_DONE_W<RXDMA_IE_SPEC> {
        LIMIT_DONE_W::new(self, 0)
    }
    #[doc = "Bit 1"]
    #[inline(always)]
    #[must_use]
    pub fn blk_done(&mut self) -> BLK_DONE_W<RXDMA_IE_SPEC> {
        BLK_DONE_W::new(self, 1)
    }
    #[doc = "Bit 2"]
    #[inline(always)]
    #[must_use]
    pub fn timeout_done(&mut self) -> TIMEOUT_DONE_W<RXDMA_IE_SPEC> {
        TIMEOUT_DONE_W::new(self, 2)
    }
    #[doc = "Bit 3"]
    #[inline(always)]
    #[must_use]
    pub fn buffer_overrun(&mut self) -> BUFFER_OVERRUN_W<RXDMA_IE_SPEC> {
