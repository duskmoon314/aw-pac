...
pub struct GP_CH1_DATA_R(crate::FieldReader<u16>);
impl GP_CH1_DATA_R {
    #[inline(always)]
    pub(crate) fn new(bits: u16) -> Self {
        GP_CH1_DATA_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for GP_CH1_DATA_R {
...
impl R {
    ...
    #[inline(always)]
    pub fn gp_ch1_data(&self) -> GP_CH1_DATA_R {
        GP_CH1_DATA_R::new((self.bits & 0x0fff) as u16)
    }
}
impl W {
