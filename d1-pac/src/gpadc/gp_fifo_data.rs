...
pub struct R(crate::R<GP_FIFO_DATA_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<GP_FIFO_DATA_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<GP_FIFO_DATA_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<GP_FIFO_DATA_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `gp_fifo_data` writer"]
pub struct W(crate::W<GP_FIFO_DATA_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<GP_FIFO_DATA_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<GP_FIFO_DATA_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<GP_FIFO_DATA_SPEC>) -> Self {
        W(writer)
    }
}
#[doc = "Field `gp_fifo_data` reader - GPADC Data in FIFO"]
pub type GP_FIFO_DATA_R = crate::FieldReader<u16, u16>;
impl R {
