...
pub struct CH_DATA_IRQ_EN_R(crate::FieldReader<bool>);
impl CH_DATA_IRQ_EN_R {
    #[inline(always)]
    pub(crate) fn new(bits: bool) -> Self {
        CH_DATA_IRQ_EN_R(crate::FieldReader::new(bits))
    }
...
impl core::ops::Deref for CH_DATA_IRQ_EN_R {
...
#[doc = "Fields `CH(0-1)_DATA_IRQ_EN` const generic writer - Channel Data Interrupt Enable"]
pub struct CH_DATA_IRQ_EN_W<'a, const O: usize> {
    w: &'a mut W,
}
impl<'a, const O: usize> CH_DATA_IRQ_EN_W<'a, O> {
    #[doc = r"Writes `variant` to the field"]
    #[inline(always)]
    pub fn variant(self, variant: CH_DATA_IRQ_EN_A) -> &'a mut W {
...
impl R {
    #[doc = "Channel Data Interrupt Enable"]
    #[inline(always)]
    pub unsafe fn ch_data_irq_en(&self, n: usize) -> CH_DATA_IRQ_EN_R {
...
impl W {
    #[doc = "Channel Data Interrupt Enable"]
    #[inline(always)]
    pub unsafe fn ch_data_irq_en<const O: usize>(&mut self) -> CH_DATA_IRQ_EN_W<O> {
        CH_DATA_IRQ_EN_W { w: self }
    }
    #[doc = "Bit 0 - Channel Data Interrupt Enable"]
    #[inline(always)]
