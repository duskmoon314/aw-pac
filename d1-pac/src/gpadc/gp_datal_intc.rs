...
pub type R = crate::R<GP_DATAL_INTC_SPEC>;
#[doc = "Register `gp_datal_intc` writer"]
pub type W = crate::W<GP_DATAL_INTC_SPEC>;
...
impl CH_LOW_IRQ_EN_R {
    ...
    #[inline(always)]
    pub const fn variant(&self) -> CH_LOW_IRQ_EN_A {
        match self.bits {
...
pub type CH_LOW_IRQ_EN_W<'a, REG> = crate::BitWriter<'a, REG, CH_LOW_IRQ_EN_A>;
impl<'a, REG> CH_LOW_IRQ_EN_W<'a, REG>
where
...
impl R {
    #[doc = "Channel Voltage Low Available Interrupt Enable\n\nNOTE: `n` is number of field in register. `n == 0` corresponds to `ch0_low_irq_en` field"]
    #[inline(always)]
    pub fn ch_low_irq_en(&self, n: u8) -> CH_LOW_IRQ_EN_R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn ch_low_irq_en(&mut self, n: u8) -> CH_LOW_IRQ_EN_W<GP_DATAL_INTC_SPEC> {
        #[allow(clippy::no_effect)]
        [(); 2][n as usize];
        CH_LOW_IRQ_EN_W::new(self, n)
    }
    #[doc = "Bit 0 - Channel Voltage Low Available Interrupt Enable"]
    #[inline(always)]
    #[must_use]
    pub fn ch0_low_irq_en(&mut self) -> CH_LOW_IRQ_EN_W<GP_DATAL_INTC_SPEC> {
        CH_LOW_IRQ_EN_W::new(self, 0)
    }
    #[doc = "Bit 1 - Channel Voltage Low Available Interrupt Enable"]
    #[inline(always)]
    #[must_use]
    pub fn ch1_low_irq_en(&mut self) -> CH_LOW_IRQ_EN_W<GP_DATAL_INTC_SPEC> {
        CH_LOW_IRQ_EN_W::new(self, 1)
    }
