...
pub struct RegisterBlock {
    ...
    pub fsout_cfg: crate::Reg<fsout_cfg::FSOUT_CFG_SPEC>,
    #[doc = "0x88 - ASRC Input Sample Pulse Extend Configuration Register"]
    pub fsin_extcfg: crate::Reg<fsin_extcfg::FSIN_EXTCFG_SPEC>,
...
pub mod mclkcfg;
#[doc = "fsout_cfg register accessor: an alias for `Reg<FSOUT_CFG_SPEC>`"]
pub type FSOUT_CFG = crate::Reg<fsout_cfg::FSOUT_CFG_SPEC>;
#[doc = "ASRC Out Sample Rate Configuration Register"]
pub mod fsout_cfg;
#[doc = "fsin_extcfg register accessor: an alias for `Reg<FSIN_EXTCFG_SPEC>`"]
