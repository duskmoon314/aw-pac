#[doc = "Register `msgbox_wr_irq_en_reg` reader"]
pub struct R(crate::R<MSGBOX_WR_IRQ_EN_REG_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<MSGBOX_WR_IRQ_EN_REG_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<MSGBOX_WR_IRQ_EN_REG_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<MSGBOX_WR_IRQ_EN_REG_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `msgbox_wr_irq_en_reg` writer"]
pub struct W(crate::W<MSGBOX_WR_IRQ_EN_REG_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<MSGBOX_WR_IRQ_EN_REG_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<MSGBOX_WR_IRQ_EN_REG_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<MSGBOX_WR_IRQ_EN_REG_SPEC>) -> Self {
        W(writer)
    }
}
...
#[doc = "Fields `transmit_mq(0-3)_irq_en` reader - Transmit Channel\\[i\\]
Interrupt Enable"]
...
#[doc = "Fields `transmit_mq(0-3)_irq_en` writer - Transmit Channel\\[i\\]
Interrupt Enable"]
pub type TRANSMIT_MQ_IRQ_EN_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, MSGBOX_WR_IRQ_EN_REG_SPEC, TRANSMIT_MQ_IRQ_EN_A, O>;
...
#[doc = "Message Box Write Interrupt Enable Register\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [msgbox_wr_irq_en_reg](index.html) module"]
pub struct MSGBOX_WR_IRQ_EN_REG_SPEC;
impl crate::RegisterSpec for MSGBOX_WR_IRQ_EN_REG_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [msgbox_wr_irq_en_reg::R](R) reader structure"]
impl crate::Readable for MSGBOX_WR_IRQ_EN_REG_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [msgbox_wr_irq_en_reg::W](W) writer structure"]
impl crate::Writable for MSGBOX_WR_IRQ_EN_REG_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets msgbox_wr_irq_en_reg to value 0"]
impl crate::Resettable for MSGBOX_WR_IRQ_EN_REG_SPEC {
    #[inline(always)]
