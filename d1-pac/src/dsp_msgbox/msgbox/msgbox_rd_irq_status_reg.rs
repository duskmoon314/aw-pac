#[doc = "Register `MSGBOX_RD_IRQ_STATUS_REG` reader"]
pub struct R(crate::R<MSGBOX_RD_IRQ_STATUS_REG_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<MSGBOX_RD_IRQ_STATUS_REG_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<MSGBOX_RD_IRQ_STATUS_REG_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<MSGBOX_RD_IRQ_STATUS_REG_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `MSGBOX_RD_IRQ_STATUS_REG` writer"]
pub struct W(crate::W<MSGBOX_RD_IRQ_STATUS_REG_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<MSGBOX_RD_IRQ_STATUS_REG_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<MSGBOX_RD_IRQ_STATUS_REG_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<MSGBOX_RD_IRQ_STATUS_REG_SPEC>) -> Self {
        W(writer)
    }
}
...
#[doc = "Fields `RECEPTION_MQ(0-3)_IRQ_PEND` reader - Reception Channel\\[i\\]
Interrupt Pending"]
...
#[doc = "Fields `RECEPTION_MQ(0-3)_IRQ_PEND` writer - Reception Channel\\[i\\]
Interrupt Pending"]
pub type RECEPTION_MQ_IRQ_PEND_W<'a, const O: u8> =
    crate::BitWriter1C<'a, u32, MSGBOX_RD_IRQ_STATUS_REG_SPEC, RECEPTION_MQ_IRQ_PEND_A, O>;
...
#[doc = "Message Box Read Interrupt Status Register\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [msgbox_rd_irq_status_reg](index.html) module"]
pub struct MSGBOX_RD_IRQ_STATUS_REG_SPEC;
impl crate::RegisterSpec for MSGBOX_RD_IRQ_STATUS_REG_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [msgbox_rd_irq_status_reg::R](R) reader structure"]
impl crate::Readable for MSGBOX_RD_IRQ_STATUS_REG_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [msgbox_rd_irq_status_reg::W](W) writer structure"]
impl crate::Writable for MSGBOX_RD_IRQ_STATUS_REG_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets MSGBOX_RD_IRQ_STATUS_REG to value 0"]
impl crate::Resettable for MSGBOX_RD_IRQ_STATUS_REG_SPEC {
    #[inline(always)]
