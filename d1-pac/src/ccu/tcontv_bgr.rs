...
pub struct R(crate::R<TCONTV_BGR_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<TCONTV_BGR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<TCONTV_BGR_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<TCONTV_BGR_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `tcontv_bgr` writer"]
pub struct W(crate::W<TCONTV_BGR_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<TCONTV_BGR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<TCONTV_BGR_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<TCONTV_BGR_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type GATING_W<'a, const O: u8> = crate::BitWriter<'a, u32, TCONTV_BGR_SPEC, GATING_A, O>;
...
pub type RST_W<'a, const O: u8> = crate::BitWriter<'a, u32, TCONTV_BGR_SPEC, RST_A, O>;
