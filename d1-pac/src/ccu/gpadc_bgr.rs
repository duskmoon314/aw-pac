...
pub type GATING_W<'a, const O: u8> = crate::BitWriter<'a, u32, GPADC_BGR_SPEC, GATING_A, O>;
...
pub type RST_W<'a, const O: u8> = crate::BitWriter<'a, u32, GPADC_BGR_SPEC, RST_A, O>;
