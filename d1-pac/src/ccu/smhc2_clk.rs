...
pub type R = crate::R<SMHC2_CLK_SPEC>;
#[doc = "Register `smhc2_clk` writer"]
pub type W = crate::W<SMHC2_CLK_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn factor_m(&mut self) -> FACTOR_M_W<SMHC2_CLK_SPEC> {
        FACTOR_M_W::new(self, 0)
    }
    #[doc = "Bits 8:9 - Factor N"]
    #[inline(always)]
    #[must_use]
    pub fn factor_n(&mut self) -> FACTOR_N_W<SMHC2_CLK_SPEC> {
        FACTOR_N_W::new(self, 8)
    }
    #[doc = "Bits 24:26 - Clock Source Select"]
    #[inline(always)]
    #[must_use]
    pub fn clk_src_sel(&mut self) -> CLK_SRC_SEL_W<SMHC2_CLK_SPEC> {
        CLK_SRC_SEL_W::new(self, 24)
    }
    #[doc = "Bit 31 - Gating Clock"]
    #[inline(always)]
    #[must_use]
    pub fn clk_gating(&mut self) -> CLK_GATING_W<SMHC2_CLK_SPEC> {
