#[doc = "Register `tpadc_bgr` reader"]
pub struct R(crate::R<TPADC_BGR_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<TPADC_BGR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<TPADC_BGR_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<TPADC_BGR_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `tpadc_bgr` writer"]
pub struct W(crate::W<TPADC_BGR_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<TPADC_BGR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<TPADC_BGR_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<TPADC_BGR_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type GATING_W<'a, const O: u8> = crate::BitWriter<'a, u32, TPADC_BGR_SPEC, GATING_A, O>;
...
pub type RST_W<'a, const O: u8> = crate::BitWriter<'a, u32, TPADC_BGR_SPEC, RST_A, O>;
...
pub struct TPADC_BGR_SPEC;
impl crate::RegisterSpec for TPADC_BGR_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [tpadc_bgr::R](R) reader structure"]
impl crate::Readable for TPADC_BGR_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [tpadc_bgr::W](W) writer structure"]
impl crate::Writable for TPADC_BGR_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets tpadc_bgr to value 0"]
impl crate::Resettable for TPADC_BGR_SPEC {
