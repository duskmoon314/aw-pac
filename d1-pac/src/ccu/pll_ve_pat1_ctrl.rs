...
pub type R = crate::R<PLL_VE_PAT1_CTRL_SPEC>;
#[doc = "Register `pll_ve_pat1_ctrl` writer"]
pub type W = crate::W<PLL_VE_PAT1_CTRL_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn frac_in(&mut self) -> FRAC_IN_W<PLL_VE_PAT1_CTRL_SPEC> {
        FRAC_IN_W::new(self, 0)
    }
    #[doc = "Bit 20 - Fraction Enable"]
    #[inline(always)]
    #[must_use]
    pub fn frac_en(&mut self) -> FRAC_EN_W<PLL_VE_PAT1_CTRL_SPEC> {
        FRAC_EN_W::new(self, 20)
    }
    #[doc = "Bit 24 - Dither Enable"]
    #[inline(always)]
    #[must_use]
    pub fn dither_en(&mut self) -> DITHER_EN_W<PLL_VE_PAT1_CTRL_SPEC> {
