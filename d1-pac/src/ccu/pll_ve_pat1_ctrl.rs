...
pub type FRAC_IN_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, PLL_VE_PAT1_CTRL_SPEC, u32, u32, 17, O>;
#[doc = "Field `frac_en` reader - Fraction Enable"]
pub type FRAC_EN_R = crate::BitReader<bool>;
#[doc = "Field `frac_en` writer - Fraction Enable"]
pub type FRAC_EN_W<'a, const O: u8> = crate::BitWriter<'a, u32, PLL_VE_PAT1_CTRL_SPEC, bool, O>;
...
pub type DITHER_EN_W<'a, const O: u8> = crate::BitWriter<'a, u32, PLL_VE_PAT1_CTRL_SPEC, bool, O>;
impl R {
