#[doc = "Register `spi1_clk` reader"]
pub type R = crate::R<SPI1_CLK_SPEC>;
#[doc = "Register `spi1_clk` writer"]
pub type W = crate::W<SPI1_CLK_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn factor_m(&mut self) -> FACTOR_M_W<SPI1_CLK_SPEC> {
        FACTOR_M_W::new(self, 0)
    }
    #[doc = "Bits 8:9 - Factor N"]
    #[inline(always)]
    #[must_use]
    pub fn factor_n(&mut self) -> FACTOR_N_W<SPI1_CLK_SPEC> {
        FACTOR_N_W::new(self, 8)
    }
    #[doc = "Bits 24:26 - Clock Source Select"]
    #[inline(always)]
    #[must_use]
    pub fn clk_src_sel(&mut self) -> CLK_SRC_SEL_W<SPI1_CLK_SPEC> {
        CLK_SRC_SEL_W::new(self, 24)
    }
    #[doc = "Bit 31 - Gating Clock"]
    #[inline(always)]
    #[must_use]
    pub fn clk_gating(&mut self) -> CLK_GATING_W<SPI1_CLK_SPEC> {
...
#[doc = "SPI1 Clock Register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`spi1_clk::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`spi1_clk::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct SPI1_CLK_SPEC;
impl crate::RegisterSpec for SPI1_CLK_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`spi1_clk::R`](R) reader structure"]
impl crate::Readable for SPI1_CLK_SPEC {}
#[doc = "`write(|w| ..)` method takes [`spi1_clk::W`](W) writer structure"]
impl crate::Writable for SPI1_CLK_SPEC {
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets spi1_clk to value 0"]
impl crate::Resettable for SPI1_CLK_SPEC {
