...
pub type TOP_GATING_W<'a, const O: u8> = crate::BitWriter<'a, u32, TVE_BGR_SPEC, TOP_GATING_A, O>;
...
pub type GATING_W<'a, const O: u8> = crate::BitWriter<'a, u32, TVE_BGR_SPEC, GATING_A, O>;
...
pub type TOP_RST_W<'a, const O: u8> = crate::BitWriter<'a, u32, TVE_BGR_SPEC, TOP_RST_A, O>;
...
pub type RST_W<'a, const O: u8> = crate::BitWriter<'a, u32, TVE_BGR_SPEC, RST_A, O>;
