...
pub type R = crate::R<PLL_VIDEO1_BIAS_SPEC>;
#[doc = "Register `pll_video1_bias` writer"]
pub type W = crate::W<PLL_VIDEO1_BIAS_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn pll_cp(&mut self) -> PLL_CP_W<PLL_VIDEO1_BIAS_SPEC> {
