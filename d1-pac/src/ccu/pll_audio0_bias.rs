...
pub type R = crate::R<PLL_AUDIO0_BIAS_SPEC>;
#[doc = "Register `pll_audio0_bias` writer"]
pub type W = crate::W<PLL_AUDIO0_BIAS_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn pll_cp(&mut self) -> PLL_CP_W<PLL_AUDIO0_BIAS_SPEC> {
...
#[doc = "PLL_AUDIO0 Bias Register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`pll_audio0_bias::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`pll_audio0_bias::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
