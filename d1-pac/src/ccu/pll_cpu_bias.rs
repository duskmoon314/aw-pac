...
pub type R = crate::R<PLL_CPU_BIAS_SPEC>;
#[doc = "Register `pll_cpu_bias` writer"]
pub type W = crate::W<PLL_CPU_BIAS_SPEC>;
...
pub type PLL_VCO_RST_IN_R = crate::BitReader;
#[doc = "Field `pll_vco_rst_in` writer - VCO reset in"]
pub type PLL_VCO_RST_IN_W<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn pll_cp(&mut self) -> PLL_CP_W<PLL_CPU_BIAS_SPEC> {
        PLL_CP_W::new(self, 16)
    }
    #[doc = "Bit 31 - VCO reset in"]
    #[inline(always)]
    #[must_use]
    pub fn pll_vco_rst_in(&mut self) -> PLL_VCO_RST_IN_W<PLL_CPU_BIAS_SPEC> {
        PLL_VCO_RST_IN_W::new(self, 31)
    }
