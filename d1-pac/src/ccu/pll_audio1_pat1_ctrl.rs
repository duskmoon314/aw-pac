...
pub type DITHER_EN_W<'a> = crate::BitWriter<'a, u32, PLL_AUDIO1_PAT1_CTRL_SPEC, bool, 24>;
#[doc = "Field `FRAC_EN` reader - Fraction Enable"]
pub type FRAC_EN_R = crate::BitReader<bool>;
#[doc = "Field `FRAC_EN` writer - Fraction Enable"]
pub type FRAC_EN_W<'a> = crate::BitWriter<'a, u32, PLL_AUDIO1_PAT1_CTRL_SPEC, bool, 20>;
#[doc = "Field `FRAC_IN` reader - Fraction In"]
pub type FRAC_IN_R = crate::FieldReader<u32, u32>;
#[doc = "Field `FRAC_IN` writer - Fraction In"]
pub type FRAC_IN_W<'a> = crate::FieldWriter<'a, u32, PLL_AUDIO1_PAT1_CTRL_SPEC, u32, u32, 17, 0>;
impl R {
