#[doc = "Register `PLL_VIDEO0_CTRL` reader"]
pub struct R(crate::R<PLL_VIDEO0_CTRL_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<PLL_VIDEO0_CTRL_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<PLL_VIDEO0_CTRL_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<PLL_VIDEO0_CTRL_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `PLL_VIDEO0_CTRL` writer"]
pub struct W(crate::W<PLL_VIDEO0_CTRL_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<PLL_VIDEO0_CTRL_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<PLL_VIDEO0_CTRL_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<PLL_VIDEO0_CTRL_SPEC>) -> Self {
        W(writer)
    }
}
#[doc = "PLL Enable\n\nValue on reset: 0"]
...
pub type PLL_EN_W<'a> = crate::BitWriter<'a, u32, PLL_VIDEO0_CTRL_SPEC, PLL_EN_A, 31>;
impl<'a> PLL_EN_W<'a> {
    #[doc = "`0`"]
    #[inline(always)]
...
pub type PLL_LDO_EN_W<'a> = crate::BitWriter<'a, u32, PLL_VIDEO0_CTRL_SPEC, PLL_LDO_EN_A, 30>;
...
pub type LOCK_ENABLE_W<'a> = crate::BitWriter<'a, u32, PLL_VIDEO0_CTRL_SPEC, LOCK_ENABLE_A, 29>;
...
pub type PLL_OUTPUT_GATE_W<'a> =
    crate::BitWriter<'a, u32, PLL_VIDEO0_CTRL_SPEC, PLL_OUTPUT_GATE_A, 27>;
...
pub type PLL_SDM_EN_W<'a> = crate::BitWriter<'a, u32, PLL_VIDEO0_CTRL_SPEC, PLL_SDM_EN_A, 24>;
...
pub type PLL_N_W<'a> = crate::FieldWriter<'a, u32, PLL_VIDEO0_CTRL_SPEC, u8, u8, 8, 8>;
...
pub type PLL_UNLOCK_MDSEL_W<'a> =
    crate::FieldWriter<'a, u32, PLL_VIDEO0_CTRL_SPEC, u8, PLL_UNLOCK_MDSEL_A, 2, 6>;
...
pub type PLL_LOCK_MDSEL_W<'a> =
    crate::BitWriter<'a, u32, PLL_VIDEO0_CTRL_SPEC, PLL_LOCK_MDSEL_A, 5>;
...
pub type PLL_INPUT_DIV2_W<'a> = crate::BitWriter<'a, u32, PLL_VIDEO0_CTRL_SPEC, bool, 1>;
...
pub type PLL_OUTPUT_DIV2_W<'a> = crate::BitWriter<'a, u32, PLL_VIDEO0_CTRL_SPEC, bool, 0>;
impl R {
...
#[doc = "PLL_VIDEO0 Control Register\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [pll_video0_ctrl](index.html) module"]
pub struct PLL_VIDEO0_CTRL_SPEC;
impl crate::RegisterSpec for PLL_VIDEO0_CTRL_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [pll_video0_ctrl::R](R) reader structure"]
impl crate::Readable for PLL_VIDEO0_CTRL_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [pll_video0_ctrl::W](W) writer structure"]
impl crate::Writable for PLL_VIDEO0_CTRL_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets PLL_VIDEO0_CTRL to value 0"]
impl crate::Resettable for PLL_VIDEO0_CTRL_SPEC {
    #[inline(always)]
