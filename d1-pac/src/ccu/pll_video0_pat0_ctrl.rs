...
pub type R = crate::R<PLL_VIDEO0_PAT0_CTRL_SPEC>;
#[doc = "Register `pll_video0_pat0_ctrl` writer"]
pub type W = crate::W<PLL_VIDEO0_PAT0_CTRL_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn wave_bot(&mut self) -> WAVE_BOT_W<PLL_VIDEO0_PAT0_CTRL_SPEC> {
        WAVE_BOT_W::new(self, 0)
    }
    #[doc = "Bits 17:18 - Frequency"]
    #[inline(always)]
    #[must_use]
    pub fn freq(&mut self) -> FREQ_W<PLL_VIDEO0_PAT0_CTRL_SPEC> {
        FREQ_W::new(self, 17)
    }
    #[doc = "Bit 19 - SDM Clock Select"]
    #[inline(always)]
    #[must_use]
    pub fn sdm_clk_sel(&mut self) -> SDM_CLK_SEL_W<PLL_VIDEO0_PAT0_CTRL_SPEC> {
        SDM_CLK_SEL_W::new(self, 19)
    }
    #[doc = "Bits 20:28 - Wave Step"]
    #[inline(always)]
    #[must_use]
    pub fn wave_step(&mut self) -> WAVE_STEP_W<PLL_VIDEO0_PAT0_CTRL_SPEC> {
        WAVE_STEP_W::new(self, 20)
    }
    #[doc = "Bits 29:30 - Spread Frequency Mode"]
    #[inline(always)]
    #[must_use]
    pub fn spr_freq_mode(&mut self) -> SPR_FREQ_MODE_W<PLL_VIDEO0_PAT0_CTRL_SPEC> {
        SPR_FREQ_MODE_W::new(self, 29)
    }
    #[doc = "Bit 31 - Sigma-Delta Pattern Enable"]
    #[inline(always)]
    #[must_use]
    pub fn sig_delt_pat_en(&mut self) -> SIG_DELT_PAT_EN_W<PLL_VIDEO0_PAT0_CTRL_SPEC> {
...
#[doc = "PLL_VIDEO0 Pattern0 Control Register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`pll_video0_pat0_ctrl::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`pll_video0_pat0_ctrl::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
