...
pub type R = crate::R<CSI_MASTER_CLK_SPEC>;
#[doc = "Register `csi_master_clk` writer"]
pub type W = crate::W<CSI_MASTER_CLK_SPEC>;
...
impl CLK_SRC_SEL_R {
    ...
    pub const fn variant(&self) -> Option<CLK_SRC_SEL_A> {
        match self.bits {
            ...
            2 => Some(CLK_SRC_SEL_A::PLL_VIDEO0_1X),
            3 => Some(CLK_SRC_SEL_A::PLL_VIDEO1_1X),
            4 => Some(CLK_SRC_SEL_A::PLL_AUDIO1_DIV2),
            5 => Some(CLK_SRC_SEL_A::PLL_AUDIO1_DIV5),
            _ => None,
        }
    }
    #[doc = "`0`"]
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn factor_m(&mut self) -> FACTOR_M_W<CSI_MASTER_CLK_SPEC> {
        FACTOR_M_W::new(self, 0)
    }
    #[doc = "Bits 24:26 - Clock Source Select"]
    #[inline(always)]
    #[must_use]
    pub fn clk_src_sel(&mut self) -> CLK_SRC_SEL_W<CSI_MASTER_CLK_SPEC> {
        CLK_SRC_SEL_W::new(self, 24)
    }
    #[doc = "Bit 31 - Gating Clock"]
    #[inline(always)]
    #[must_use]
    pub fn clk_gating(&mut self) -> CLK_GATING_W<CSI_MASTER_CLK_SPEC> {
