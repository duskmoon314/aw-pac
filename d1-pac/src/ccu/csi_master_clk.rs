...
pub type FACTOR_M_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, CSI_MASTER_CLK_SPEC, u8, u8, 5, O>;
...
pub type CLK_SRC_SEL_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, CSI_MASTER_CLK_SPEC, u8, CLK_SRC_SEL_A, 3, O>;
...
pub type CLK_GATING_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, CSI_MASTER_CLK_SPEC, CLK_GATING_A, O>;
