...
pub type R = crate::R<CSI_CLK_SPEC>;
#[doc = "Register `csi_clk` writer"]
pub type W = crate::W<CSI_CLK_SPEC>;
    ...
    REG::Ux: From<u8>,
{
    ...
    #[doc = "`1`"]
    #[inline(always)]
    pub fn pll_video0_2x(self) -> &'a mut crate::W<REG> {
        self.variant(CLK_SRC_SEL_A::PLL_VIDEO0_2X)
    }
    #[doc = "`10`"]
    #[inline(always)]
    pub fn pll_video1_2x(self) -> &'a mut crate::W<REG> {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn factor_m(&mut self) -> FACTOR_M_W<CSI_CLK_SPEC> {
        FACTOR_M_W::new(self, 0)
    }
    #[doc = "Bits 24:26 - Clock Source Select"]
    #[inline(always)]
    #[must_use]
    pub fn clk_src_sel(&mut self) -> CLK_SRC_SEL_W<CSI_CLK_SPEC> {
        CLK_SRC_SEL_W::new(self, 24)
    }
    #[doc = "Bit 31 - Gating Clock"]
    #[inline(always)]
    #[must_use]
    pub fn clk_gating(&mut self) -> CLK_GATING_W<CSI_CLK_SPEC> {
