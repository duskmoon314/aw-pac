...
pub type R = crate::R<PLL_AUDIO1_CTRL_SPEC>;
#[doc = "Register `pll_audio1_ctrl` writer"]
pub type W = crate::W<PLL_AUDIO1_CTRL_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn pll_input_div2(&mut self) -> PLL_INPUT_DIV2_W<PLL_AUDIO1_CTRL_SPEC> {
        PLL_INPUT_DIV2_W::new(self, 1)
    }
    #[doc = "Bit 5 - PLL Lock Level"]
    #[inline(always)]
    #[must_use]
    pub fn pll_lock_mdsel(&mut self) -> PLL_LOCK_MDSEL_W<PLL_AUDIO1_CTRL_SPEC> {
        PLL_LOCK_MDSEL_W::new(self, 5)
    }
    #[doc = "Bits 6:7 - PLL Unlock Level"]
    #[inline(always)]
    #[must_use]
    pub fn pll_unlock_mdsel(&mut self) -> PLL_UNLOCK_MDSEL_W<PLL_AUDIO1_CTRL_SPEC> {
        PLL_UNLOCK_MDSEL_W::new(self, 6)
    }
    #[doc = "Bits 8:15 - PLL N"]
    #[inline(always)]
    #[must_use]
    pub fn pll_n(&mut self) -> PLL_N_W<PLL_AUDIO1_CTRL_SPEC> {
        PLL_N_W::new(self, 8)
    }
    #[doc = "Bits 16:18 - PLL Output Div P0"]
    #[inline(always)]
    #[must_use]
    pub fn pll_p0(&mut self) -> PLL_P0_W<PLL_AUDIO1_CTRL_SPEC> {
        PLL_P0_W::new(self, 16)
    }
    #[doc = "Bits 20:22 - PLL Output Div P1"]
    #[inline(always)]
    #[must_use]
    pub fn pll_p1(&mut self) -> PLL_P1_W<PLL_AUDIO1_CTRL_SPEC> {
        PLL_P1_W::new(self, 20)
    }
    #[doc = "Bit 24 - PLL SDM Enable"]
    #[inline(always)]
    #[must_use]
    pub fn pll_sdm_en(&mut self) -> PLL_SDM_EN_W<PLL_AUDIO1_CTRL_SPEC> {
        PLL_SDM_EN_W::new(self, 24)
    }
    #[doc = "Bit 27 - PLL Output Gating Enable"]
    #[inline(always)]
    #[must_use]
    pub fn pll_output_gate(&mut self) -> PLL_OUTPUT_GATE_W<PLL_AUDIO1_CTRL_SPEC> {
        PLL_OUTPUT_GATE_W::new(self, 27)
    }
    #[doc = "Bit 29 - Lock Enable"]
    #[inline(always)]
    #[must_use]
    pub fn lock_enable(&mut self) -> LOCK_ENABLE_W<PLL_AUDIO1_CTRL_SPEC> {
        LOCK_ENABLE_W::new(self, 29)
    }
    #[doc = "Bit 30 - LDO Enable"]
    #[inline(always)]
    #[must_use]
    pub fn pll_ldo_en(&mut self) -> PLL_LDO_EN_W<PLL_AUDIO1_CTRL_SPEC> {
        PLL_LDO_EN_W::new(self, 30)
    }
    #[doc = "Bit 31 - PLL Enable"]
    #[inline(always)]
    #[must_use]
    pub fn pll_en(&mut self) -> PLL_EN_W<PLL_AUDIO1_CTRL_SPEC> {
