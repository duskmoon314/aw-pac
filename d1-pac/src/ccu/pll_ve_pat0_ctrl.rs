...
pub type WAVE_BOT_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, PLL_VE_PAT0_CTRL_SPEC, u32, u32, 17, O>;
...
pub type FREQ_W<'a, const O: u8> =
    crate::FieldWriterSafe<'a, u32, PLL_VE_PAT0_CTRL_SPEC, u8, FREQ_A, 2, O>;
...
pub type SDM_CLK_SEL_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, PLL_VE_PAT0_CTRL_SPEC, SDM_CLK_SEL_A, O>;
...
pub type WAVE_STEP_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, PLL_VE_PAT0_CTRL_SPEC, u16, u16, 9, O>;
...
pub type SPR_FREQ_MODE_W<'a, const O: u8> =
    crate::FieldWriterSafe<'a, u32, PLL_VE_PAT0_CTRL_SPEC, u8, SPR_FREQ_MODE_A, 2, O>;
...
pub type SIG_DELT_PAT_EN_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, PLL_VE_PAT0_CTRL_SPEC, bool, O>;
impl R {
