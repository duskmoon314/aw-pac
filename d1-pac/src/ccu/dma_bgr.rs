...
pub type R = crate::R<DMA_BGR_SPEC>;
#[doc = "Register `dma_bgr` writer"]
pub type W = crate::W<DMA_BGR_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn gating(&mut self) -> GATING_W<DMA_BGR_SPEC> {
        GATING_W::new(self, 0)
    }
    #[doc = "Bit 16 - Reset"]
    #[inline(always)]
    #[must_use]
    pub fn rst(&mut self) -> RST_W<DMA_BGR_SPEC> {
        RST_W::new(self, 16)
    }
