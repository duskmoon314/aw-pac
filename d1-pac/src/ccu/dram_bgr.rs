...
pub type R = crate::R<DRAM_BGR_SPEC>;
#[doc = "Register `dram_bgr` writer"]
pub type W = crate::W<DRAM_BGR_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn gating(&mut self) -> GATING_W<DRAM_BGR_SPEC> {
        GATING_W::new(self, 0)
    }
    #[doc = "Bit 16 - Reset"]
    #[inline(always)]
    #[must_use]
    pub fn rst(&mut self) -> RST_W<DRAM_BGR_SPEC> {
        RST_W::new(self, 16)
    }
...
#[doc = "DRAM Bus Gating Reset Register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`dram_bgr::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`dram_bgr::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
