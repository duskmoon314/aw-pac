#[doc = "Register `dram_bgr` reader"]
pub struct R(crate::R<DRAM_BGR_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<DRAM_BGR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<DRAM_BGR_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<DRAM_BGR_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `dram_bgr` writer"]
pub struct W(crate::W<DRAM_BGR_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<DRAM_BGR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<DRAM_BGR_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<DRAM_BGR_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type GATING_W<'a, const O: u8> = crate::BitWriter<'a, u32, DRAM_BGR_SPEC, GATING_A, O>;
...
pub type RST_W<'a, const O: u8> = crate::BitWriter<'a, u32, DRAM_BGR_SPEC, RST_A, O>;
...
#[doc = "DRAM Bus Gating Reset Register\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [dram_bgr](index.html) module"]
pub struct DRAM_BGR_SPEC;
impl crate::RegisterSpec for DRAM_BGR_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [dram_bgr::R](R) reader structure"]
impl crate::Readable for DRAM_BGR_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [dram_bgr::W](W) writer structure"]
impl crate::Writable for DRAM_BGR_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets dram_bgr to value 0"]
impl crate::Resettable for DRAM_BGR_SPEC {
