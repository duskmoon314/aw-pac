...
pub type R = crate::R<PLL_VIDEO0_PAT1_CTRL_SPEC>;
#[doc = "Register `pll_video0_pat1_ctrl` writer"]
pub type W = crate::W<PLL_VIDEO0_PAT1_CTRL_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn frac_in(&mut self) -> FRAC_IN_W<PLL_VIDEO0_PAT1_CTRL_SPEC> {
        FRAC_IN_W::new(self, 0)
    }
    #[doc = "Bit 20 - Fraction Enable"]
    #[inline(always)]
    #[must_use]
    pub fn frac_en(&mut self) -> FRAC_EN_W<PLL_VIDEO0_PAT1_CTRL_SPEC> {
        FRAC_EN_W::new(self, 20)
    }
    #[doc = "Bit 24 - Dither Enable"]
    #[inline(always)]
    #[must_use]
    pub fn dither_en(&mut self) -> DITHER_EN_W<PLL_VIDEO0_PAT1_CTRL_SPEC> {
...
#[doc = "PLL_VIDEO0 Pattern1 Control Register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`pll_video0_pat1_ctrl::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`pll_video0_pat1_ctrl::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
