...
pub type R = crate::R<USB0_CLK_SPEC>;
#[doc = "Register `usb0_clk` writer"]
pub type W = crate::W<USB0_CLK_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn clk12m_sel(&mut self) -> CLK12M_SEL_W<USB0_CLK_SPEC> {
        CLK12M_SEL_W::new(self, 24)
    }
    #[doc = "Bit 30 - PHY Reset"]
    #[inline(always)]
    #[must_use]
    pub fn rstn(&mut self) -> RSTN_W<USB0_CLK_SPEC> {
        RSTN_W::new(self, 30)
    }
    #[doc = "Bit 31 - Gating Special Clock"]
    #[inline(always)]
    #[must_use]
    pub fn clken(&mut self) -> CLKEN_W<USB0_CLK_SPEC> {
        CLKEN_W::new(self, 31)
    }
...
#[doc = "USB0 Clock Register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`usb0_clk::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`usb0_clk::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
