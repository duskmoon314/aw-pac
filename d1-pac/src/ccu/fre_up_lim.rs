...
pub type R = crate::R<FRE_UP_LIM_SPEC>;
#[doc = "Register `fre_up_lim` writer"]
pub type W = crate::W<FRE_UP_LIM_SPEC>;
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        write!(f, "{}", self.bits())
    }
}
impl core::fmt::Debug for crate::generic::Reg<FRE_UP_LIM_SPEC> {
