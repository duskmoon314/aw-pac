#[doc = "Register `pll_audio0_pat1_ctrl` reader"]
pub struct R(crate::R<PLL_AUDIO0_PAT1_CTRL_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<PLL_AUDIO0_PAT1_CTRL_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<PLL_AUDIO0_PAT1_CTRL_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<PLL_AUDIO0_PAT1_CTRL_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `pll_audio0_pat1_ctrl` writer"]
pub struct W(crate::W<PLL_AUDIO0_PAT1_CTRL_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<PLL_AUDIO0_PAT1_CTRL_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<PLL_AUDIO0_PAT1_CTRL_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<PLL_AUDIO0_PAT1_CTRL_SPEC>) -> Self {
        W(writer)
    }
}
...
#[doc = "PLL_AUDIO0 Pattern1 Control Register\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [pll_audio0_pat1_ctrl](index.html) module"]
pub struct PLL_AUDIO0_PAT1_CTRL_SPEC;
impl crate::RegisterSpec for PLL_AUDIO0_PAT1_CTRL_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [pll_audio0_pat1_ctrl::R](R) reader structure"]
impl crate::Readable for PLL_AUDIO0_PAT1_CTRL_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [pll_audio0_pat1_ctrl::W](W) writer structure"]
impl crate::Writable for PLL_AUDIO0_PAT1_CTRL_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets pll_audio0_pat1_ctrl to value 0"]
impl crate::Resettable for PLL_AUDIO0_PAT1_CTRL_SPEC {
