...
pub type PLL_OUTPUT_DIV2_W<'a, const O: u8> = crate::BitWriter<'a, u32, PLL_VE_CTRL_SPEC, bool, O>;
...
pub type PLL_INPUT_DIV2_W<'a, const O: u8> = crate::BitWriter<'a, u32, PLL_VE_CTRL_SPEC, bool, O>;
...
pub type PLL_LOCK_MDSEL_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, PLL_VE_CTRL_SPEC, PLL_LOCK_MDSEL_A, O>;
...
pub type PLL_UNLOCK_MDSEL_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, PLL_VE_CTRL_SPEC, u8, PLL_UNLOCK_MDSEL_A, 2, O>;
...
pub type PLL_N_W<'a, const O: u8> = crate::FieldWriter<'a, u32, PLL_VE_CTRL_SPEC, u8, u8, 8, O>;
...
pub type PLL_SDM_EN_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, PLL_VE_CTRL_SPEC, PLL_SDM_EN_A, O>;
...
pub type PLL_OUTPUT_GATE_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, PLL_VE_CTRL_SPEC, PLL_OUTPUT_GATE_A, O>;
...
pub type LOCK_ENABLE_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, PLL_VE_CTRL_SPEC, LOCK_ENABLE_A, O>;
...
pub type PLL_LDO_EN_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, PLL_VE_CTRL_SPEC, PLL_LDO_EN_A, O>;
...
pub type PLL_EN_W<'a, const O: u8> = crate::BitWriter<'a, u32, PLL_VE_CTRL_SPEC, PLL_EN_A, O>;
