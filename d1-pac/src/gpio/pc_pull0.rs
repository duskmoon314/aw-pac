...
pub type R = crate::R<PC_PULL0_SPEC>;
#[doc = "Register `pc_pull0` writer"]
pub type W = crate::W<PC_PULL0_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn pc_pull(&mut self, n: u8) -> PC_PULL_W<PC_PULL0_SPEC> {
        #[allow(clippy::no_effect)]
        [(); 8][n as usize];
    ...
    #[inline(always)]
    #[must_use]
    pub fn pc0_pull(&mut self) -> PC_PULL_W<PC_PULL0_SPEC> {
        PC_PULL_W::new(self, 0)
    }
    #[doc = "Bits 2:3 - PC Pull_up/down Select"]
    #[inline(always)]
    #[must_use]
    pub fn pc1_pull(&mut self) -> PC_PULL_W<PC_PULL0_SPEC> {
        PC_PULL_W::new(self, 2)
    }
    #[doc = "Bits 4:5 - PC Pull_up/down Select"]
    #[inline(always)]
    #[must_use]
    pub fn pc2_pull(&mut self) -> PC_PULL_W<PC_PULL0_SPEC> {
        PC_PULL_W::new(self, 4)
    }
    #[doc = "Bits 6:7 - PC Pull_up/down Select"]
    #[inline(always)]
    #[must_use]
    pub fn pc3_pull(&mut self) -> PC_PULL_W<PC_PULL0_SPEC> {
        PC_PULL_W::new(self, 6)
    }
    #[doc = "Bits 8:9 - PC Pull_up/down Select"]
    #[inline(always)]
    #[must_use]
    pub fn pc4_pull(&mut self) -> PC_PULL_W<PC_PULL0_SPEC> {
        PC_PULL_W::new(self, 8)
    }
    #[doc = "Bits 10:11 - PC Pull_up/down Select"]
    #[inline(always)]
    #[must_use]
    pub fn pc5_pull(&mut self) -> PC_PULL_W<PC_PULL0_SPEC> {
        PC_PULL_W::new(self, 10)
    }
    #[doc = "Bits 12:13 - PC Pull_up/down Select"]
    #[inline(always)]
    #[must_use]
    pub fn pc6_pull(&mut self) -> PC_PULL_W<PC_PULL0_SPEC> {
        PC_PULL_W::new(self, 12)
    }
    #[doc = "Bits 14:15 - PC Pull_up/down Select"]
    #[inline(always)]
    #[must_use]
    pub fn pc7_pull(&mut self) -> PC_PULL_W<PC_PULL0_SPEC> {
