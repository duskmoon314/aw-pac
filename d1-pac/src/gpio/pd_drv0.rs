...
impl W {
    ...
    #[doc = "Bits 0:1 - PD Multi_Driving Select"]
    #[inline(always)]
    pub fn pd0_drv(&mut self) -> PD_DRV_CGW<0> {
        PD_DRV_CGW { w: self }
    }
    #[doc = "Bits 4:5 - PD Multi_Driving Select"]
    #[inline(always)]
    pub fn pd1_drv(&mut self) -> PD_DRV_CGW<4> {
        PD_DRV_CGW { w: self }
    }
    #[doc = "Bits 8:9 - PD Multi_Driving Select"]
    #[inline(always)]
    pub fn pd2_drv(&mut self) -> PD_DRV_CGW<8> {
        PD_DRV_CGW { w: self }
    }
    #[doc = "Bits 12:13 - PD Multi_Driving Select"]
    #[inline(always)]
    pub fn pd3_drv(&mut self) -> PD_DRV_CGW<12> {
        PD_DRV_CGW { w: self }
    }
    #[doc = "Bits 16:17 - PD Multi_Driving Select"]
    #[inline(always)]
    pub fn pd4_drv(&mut self) -> PD_DRV_CGW<16> {
        PD_DRV_CGW { w: self }
    }
    #[doc = "Bits 20:21 - PD Multi_Driving Select"]
    #[inline(always)]
    pub fn pd5_drv(&mut self) -> PD_DRV_CGW<20> {
        PD_DRV_CGW { w: self }
    }
    #[doc = "Bits 24:25 - PD Multi_Driving Select"]
    #[inline(always)]
    pub fn pd6_drv(&mut self) -> PD_DRV_CGW<24> {
        PD_DRV_CGW { w: self }
    }
    #[doc = "Bits 28:29 - PD Multi_Driving Select"]
    #[inline(always)]
    pub fn pd7_drv(&mut self) -> PD_DRV_CGW<28> {
        PD_DRV_CGW { w: self }
    }
