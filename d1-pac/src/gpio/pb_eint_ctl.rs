...
pub type R = crate::R<PB_EINT_CTL_SPEC>;
#[doc = "Register `pb_eint_ctl` writer"]
pub type W = crate::W<PB_EINT_CTL_SPEC>;
#[doc = "Field `eint_ctl[0-11]` reader - External INT Enable"]
...
#[doc = "Field `eint_ctl[0-11]` writer - External INT Enable"]
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn eint_ctl(&mut self, n: u8) -> EINT_CTL_W<PB_EINT_CTL_SPEC> {
        #[allow(clippy::no_effect)]
        [(); 12][n as usize];
    ...
    #[inline(always)]
    #[must_use]
    pub fn eint0_ctl(&mut self) -> EINT_CTL_W<PB_EINT_CTL_SPEC> {
        EINT_CTL_W::new(self, 0)
    }
    #[doc = "Bit 1 - External INT Enable"]
    #[inline(always)]
    #[must_use]
    pub fn eint1_ctl(&mut self) -> EINT_CTL_W<PB_EINT_CTL_SPEC> {
        EINT_CTL_W::new(self, 1)
    }
    #[doc = "Bit 2 - External INT Enable"]
    #[inline(always)]
    #[must_use]
    pub fn eint2_ctl(&mut self) -> EINT_CTL_W<PB_EINT_CTL_SPEC> {
        EINT_CTL_W::new(self, 2)
    }
    #[doc = "Bit 3 - External INT Enable"]
    #[inline(always)]
    #[must_use]
    pub fn eint3_ctl(&mut self) -> EINT_CTL_W<PB_EINT_CTL_SPEC> {
        EINT_CTL_W::new(self, 3)
    }
    #[doc = "Bit 4 - External INT Enable"]
    #[inline(always)]
    #[must_use]
    pub fn eint4_ctl(&mut self) -> EINT_CTL_W<PB_EINT_CTL_SPEC> {
        EINT_CTL_W::new(self, 4)
    }
    #[doc = "Bit 5 - External INT Enable"]
    #[inline(always)]
    #[must_use]
    pub fn eint5_ctl(&mut self) -> EINT_CTL_W<PB_EINT_CTL_SPEC> {
        EINT_CTL_W::new(self, 5)
    }
    #[doc = "Bit 6 - External INT Enable"]
    #[inline(always)]
    #[must_use]
    pub fn eint6_ctl(&mut self) -> EINT_CTL_W<PB_EINT_CTL_SPEC> {
        EINT_CTL_W::new(self, 6)
    }
    #[doc = "Bit 7 - External INT Enable"]
    #[inline(always)]
    #[must_use]
    pub fn eint7_ctl(&mut self) -> EINT_CTL_W<PB_EINT_CTL_SPEC> {
        EINT_CTL_W::new(self, 7)
    }
    #[doc = "Bit 8 - External INT Enable"]
    #[inline(always)]
    #[must_use]
    pub fn eint8_ctl(&mut self) -> EINT_CTL_W<PB_EINT_CTL_SPEC> {
        EINT_CTL_W::new(self, 8)
    }
    #[doc = "Bit 9 - External INT Enable"]
    #[inline(always)]
    #[must_use]
    pub fn eint9_ctl(&mut self) -> EINT_CTL_W<PB_EINT_CTL_SPEC> {
        EINT_CTL_W::new(self, 9)
    }
    #[doc = "Bit 10 - External INT Enable"]
    #[inline(always)]
    #[must_use]
    pub fn eint10_ctl(&mut self) -> EINT_CTL_W<PB_EINT_CTL_SPEC> {
        EINT_CTL_W::new(self, 10)
    }
    #[doc = "Bit 11 - External INT Enable"]
    #[inline(always)]
    #[must_use]
    pub fn eint11_ctl(&mut self) -> EINT_CTL_W<PB_EINT_CTL_SPEC> {
...
#[doc = "PB External Interrupt Control Register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`pb_eint_ctl::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`pb_eint_ctl::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
