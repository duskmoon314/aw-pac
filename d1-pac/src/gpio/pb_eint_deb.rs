...
pub type R = crate::R<PB_EINT_DEB_SPEC>;
#[doc = "Register `pb_eint_deb` writer"]
pub type W = crate::W<PB_EINT_DEB_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn pio_int_clk_select(&mut self) -> PIO_INT_CLK_SELECT_W<PB_EINT_DEB_SPEC> {
        PIO_INT_CLK_SELECT_W::new(self, 0)
    }
    #[doc = "Bits 4:6 - Debounce Clock Pre_scale n"]
    #[inline(always)]
    #[must_use]
    pub fn deb_clk_pre_scale(&mut self) -> DEB_CLK_PRE_SCALE_W<PB_EINT_DEB_SPEC> {
...
#[doc = "PB External Interrupt Debounce Register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`pb_eint_deb::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`pb_eint_deb::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
