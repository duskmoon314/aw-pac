#[doc = "Register `pg_eint_cfg1` reader"]
pub type R = crate::R<PG_EINT_CFG1_SPEC>;
#[doc = "Register `pg_eint_cfg1` writer"]
pub type W = crate::W<PG_EINT_CFG1_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn eint_cfg(&mut self, n: u8) -> EINT_CFG_W<PG_EINT_CFG1_SPEC> {
        #[allow(clippy::no_effect)]
        [(); 8][n as usize];
    ...
    #[inline(always)]
    #[must_use]
    pub fn eint8_cfg(&mut self) -> EINT_CFG_W<PG_EINT_CFG1_SPEC> {
        EINT_CFG_W::new(self, 0)
    }
    #[doc = "Bits 4:7 - External INT Mode"]
    #[inline(always)]
    #[must_use]
    pub fn eint9_cfg(&mut self) -> EINT_CFG_W<PG_EINT_CFG1_SPEC> {
        EINT_CFG_W::new(self, 4)
    }
    #[doc = "Bits 8:11 - External INT Mode"]
    #[inline(always)]
    #[must_use]
    pub fn eint10_cfg(&mut self) -> EINT_CFG_W<PG_EINT_CFG1_SPEC> {
        EINT_CFG_W::new(self, 8)
    }
    #[doc = "Bits 12:15 - External INT Mode"]
    #[inline(always)]
    #[must_use]
    pub fn eint11_cfg(&mut self) -> EINT_CFG_W<PG_EINT_CFG1_SPEC> {
        EINT_CFG_W::new(self, 12)
    }
    #[doc = "Bits 16:19 - External INT Mode"]
    #[inline(always)]
    #[must_use]
    pub fn eint12_cfg(&mut self) -> EINT_CFG_W<PG_EINT_CFG1_SPEC> {
        EINT_CFG_W::new(self, 16)
    }
    #[doc = "Bits 20:23 - External INT Mode"]
    #[inline(always)]
    #[must_use]
    pub fn eint13_cfg(&mut self) -> EINT_CFG_W<PG_EINT_CFG1_SPEC> {
        EINT_CFG_W::new(self, 20)
    }
    #[doc = "Bits 24:27 - External INT Mode"]
    #[inline(always)]
    #[must_use]
    pub fn eint14_cfg(&mut self) -> EINT_CFG_W<PG_EINT_CFG1_SPEC> {
        EINT_CFG_W::new(self, 24)
    }
    #[doc = "Bits 28:31 - External INT Mode"]
    #[inline(always)]
    #[must_use]
    pub fn eint15_cfg(&mut self) -> EINT_CFG_W<PG_EINT_CFG1_SPEC> {
...
#[doc = "PG External Interrupt Configure Register 1\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`pg_eint_cfg1::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`pg_eint_cfg1::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct PG_EINT_CFG1_SPEC;
impl crate::RegisterSpec for PG_EINT_CFG1_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`pg_eint_cfg1::R`](R) reader structure"]
impl crate::Readable for PG_EINT_CFG1_SPEC {}
#[doc = "`write(|w| ..)` method takes [`pg_eint_cfg1::W`](W) writer structure"]
impl crate::Writable for PG_EINT_CFG1_SPEC {
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets pg_eint_cfg1 to value 0"]
impl crate::Resettable for PG_EINT_CFG1_SPEC {
