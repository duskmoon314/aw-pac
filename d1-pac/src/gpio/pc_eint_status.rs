...
pub type R = crate::R<PC_EINT_STATUS_SPEC>;
#[doc = "Register `pc_eint_status` writer"]
pub type W = crate::W<PC_EINT_STATUS_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn eint_status(&mut self, n: u8) -> EINT_STATUS_W<PC_EINT_STATUS_SPEC> {
        #[allow(clippy::no_effect)]
        [(); 8][n as usize];
    ...
    #[inline(always)]
    #[must_use]
    pub fn eint0_status(&mut self) -> EINT_STATUS_W<PC_EINT_STATUS_SPEC> {
        EINT_STATUS_W::new(self, 0)
    }
    #[doc = "Bit 1 - External INT Pending Bit"]
    #[inline(always)]
    #[must_use]
    pub fn eint1_status(&mut self) -> EINT_STATUS_W<PC_EINT_STATUS_SPEC> {
        EINT_STATUS_W::new(self, 1)
    }
    #[doc = "Bit 2 - External INT Pending Bit"]
    #[inline(always)]
    #[must_use]
    pub fn eint2_status(&mut self) -> EINT_STATUS_W<PC_EINT_STATUS_SPEC> {
        EINT_STATUS_W::new(self, 2)
    }
    #[doc = "Bit 3 - External INT Pending Bit"]
    #[inline(always)]
    #[must_use]
    pub fn eint3_status(&mut self) -> EINT_STATUS_W<PC_EINT_STATUS_SPEC> {
        EINT_STATUS_W::new(self, 3)
    }
    #[doc = "Bit 4 - External INT Pending Bit"]
    #[inline(always)]
    #[must_use]
    pub fn eint4_status(&mut self) -> EINT_STATUS_W<PC_EINT_STATUS_SPEC> {
        EINT_STATUS_W::new(self, 4)
    }
    #[doc = "Bit 5 - External INT Pending Bit"]
    #[inline(always)]
    #[must_use]
    pub fn eint5_status(&mut self) -> EINT_STATUS_W<PC_EINT_STATUS_SPEC> {
        EINT_STATUS_W::new(self, 5)
    }
    #[doc = "Bit 6 - External INT Pending Bit"]
    #[inline(always)]
    #[must_use]
    pub fn eint6_status(&mut self) -> EINT_STATUS_W<PC_EINT_STATUS_SPEC> {
        EINT_STATUS_W::new(self, 6)
    }
    #[doc = "Bit 7 - External INT Pending Bit"]
    #[inline(always)]
    #[must_use]
    pub fn eint7_status(&mut self) -> EINT_STATUS_W<PC_EINT_STATUS_SPEC> {
