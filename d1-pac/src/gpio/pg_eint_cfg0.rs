...
pub type R = crate::R<PG_EINT_CFG0_SPEC>;
#[doc = "Register `pg_eint_cfg0` writer"]
pub type W = crate::W<PG_EINT_CFG0_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn eint_cfg(&mut self, n: u8) -> EINT_CFG_W<PG_EINT_CFG0_SPEC> {
        #[allow(clippy::no_effect)]
        [(); 8][n as usize];
    ...
    #[inline(always)]
    #[must_use]
    pub fn eint0_cfg(&mut self) -> EINT_CFG_W<PG_EINT_CFG0_SPEC> {
        EINT_CFG_W::new(self, 0)
    }
    #[doc = "Bits 4:7 - External INT Mode"]
    #[inline(always)]
    #[must_use]
    pub fn eint1_cfg(&mut self) -> EINT_CFG_W<PG_EINT_CFG0_SPEC> {
        EINT_CFG_W::new(self, 4)
    }
    #[doc = "Bits 8:11 - External INT Mode"]
    #[inline(always)]
    #[must_use]
    pub fn eint2_cfg(&mut self) -> EINT_CFG_W<PG_EINT_CFG0_SPEC> {
        EINT_CFG_W::new(self, 8)
    }
    #[doc = "Bits 12:15 - External INT Mode"]
    #[inline(always)]
    #[must_use]
    pub fn eint3_cfg(&mut self) -> EINT_CFG_W<PG_EINT_CFG0_SPEC> {
        EINT_CFG_W::new(self, 12)
    }
    #[doc = "Bits 16:19 - External INT Mode"]
    #[inline(always)]
    #[must_use]
    pub fn eint4_cfg(&mut self) -> EINT_CFG_W<PG_EINT_CFG0_SPEC> {
        EINT_CFG_W::new(self, 16)
    }
    #[doc = "Bits 20:23 - External INT Mode"]
    #[inline(always)]
    #[must_use]
    pub fn eint5_cfg(&mut self) -> EINT_CFG_W<PG_EINT_CFG0_SPEC> {
        EINT_CFG_W::new(self, 20)
    }
    #[doc = "Bits 24:27 - External INT Mode"]
    #[inline(always)]
    #[must_use]
    pub fn eint6_cfg(&mut self) -> EINT_CFG_W<PG_EINT_CFG0_SPEC> {
        EINT_CFG_W::new(self, 24)
    }
    #[doc = "Bits 28:31 - External INT Mode"]
    #[inline(always)]
    #[must_use]
    pub fn eint7_cfg(&mut self) -> EINT_CFG_W<PG_EINT_CFG0_SPEC> {
