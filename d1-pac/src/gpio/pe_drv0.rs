...
pub type R = crate::R<PE_DRV0_SPEC>;
#[doc = "Register `pe_drv0` writer"]
pub type W = crate::W<PE_DRV0_SPEC>;
...
impl R {
    #[doc = "PE Multi_Driving Select\n\nNOTE: `n` is number of field in register. `n == 0` corresponds to `pe0_drv` field"]
    #[inline(always)]
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn pe_drv(&mut self, n: u8) -> PE_DRV_W<PE_DRV0_SPEC> {
        #[allow(clippy::no_effect)]
        [(); 8][n as usize];
    ...
    #[inline(always)]
    #[must_use]
    pub fn pe0_drv(&mut self) -> PE_DRV_W<PE_DRV0_SPEC> {
        PE_DRV_W::new(self, 0)
    }
    #[doc = "Bits 4:5 - PE Multi_Driving Select"]
    #[inline(always)]
    #[must_use]
    pub fn pe1_drv(&mut self) -> PE_DRV_W<PE_DRV0_SPEC> {
        PE_DRV_W::new(self, 4)
    }
    #[doc = "Bits 8:9 - PE Multi_Driving Select"]
    #[inline(always)]
    #[must_use]
    pub fn pe2_drv(&mut self) -> PE_DRV_W<PE_DRV0_SPEC> {
        PE_DRV_W::new(self, 8)
    }
    #[doc = "Bits 12:13 - PE Multi_Driving Select"]
    #[inline(always)]
    #[must_use]
    pub fn pe3_drv(&mut self) -> PE_DRV_W<PE_DRV0_SPEC> {
        PE_DRV_W::new(self, 12)
    }
    #[doc = "Bits 16:17 - PE Multi_Driving Select"]
    #[inline(always)]
    #[must_use]
    pub fn pe4_drv(&mut self) -> PE_DRV_W<PE_DRV0_SPEC> {
        PE_DRV_W::new(self, 16)
    }
    #[doc = "Bits 20:21 - PE Multi_Driving Select"]
    #[inline(always)]
    #[must_use]
    pub fn pe5_drv(&mut self) -> PE_DRV_W<PE_DRV0_SPEC> {
        PE_DRV_W::new(self, 20)
    }
    #[doc = "Bits 24:25 - PE Multi_Driving Select"]
    #[inline(always)]
    #[must_use]
    pub fn pe6_drv(&mut self) -> PE_DRV_W<PE_DRV0_SPEC> {
        PE_DRV_W::new(self, 24)
    }
    #[doc = "Bits 28:29 - PE Multi_Driving Select"]
    #[inline(always)]
    #[must_use]
    pub fn pe7_drv(&mut self) -> PE_DRV_W<PE_DRV0_SPEC> {
