...
pub struct R(crate::R<PB_EINT_STATUS_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<PB_EINT_STATUS_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<PB_EINT_STATUS_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<PB_EINT_STATUS_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `pb_eint_status` writer"]
pub struct W(crate::W<PB_EINT_STATUS_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<PB_EINT_STATUS_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<PB_EINT_STATUS_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<PB_EINT_STATUS_SPEC>) -> Self {
        W(writer)
    }
}
...
#[doc = "Fields `EINT(0-11)_STATUS` const generic writer - External INT Pending Bit"]
