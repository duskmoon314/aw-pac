...
pub type R = crate::R<PG_EINT_DEB_SPEC>;
#[doc = "Register `pg_eint_deb` writer"]
pub type W = crate::W<PG_EINT_DEB_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn pio_int_clk_select(&mut self) -> PIO_INT_CLK_SELECT_W<PG_EINT_DEB_SPEC> {
        PIO_INT_CLK_SELECT_W::new(self, 0)
    }
    #[doc = "Bits 4:6 - Debounce Clock Pre_scale n"]
    #[inline(always)]
    #[must_use]
    pub fn deb_clk_pre_scale(&mut self) -> DEB_CLK_PRE_SCALE_W<PG_EINT_DEB_SPEC> {
...
#[doc = "PG External Interrupt Debounce Register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`pg_eint_deb::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`pg_eint_deb::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
