...
pub type R = crate::R<PD_EINT_CFG1_SPEC>;
#[doc = "Register `pd_eint_cfg1` writer"]
pub type W = crate::W<PD_EINT_CFG1_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn eint_cfg(&mut self, n: u8) -> EINT_CFG_W<PD_EINT_CFG1_SPEC> {
        #[allow(clippy::no_effect)]
        [(); 8][n as usize];
    ...
    #[inline(always)]
    #[must_use]
    pub fn eint8_cfg(&mut self) -> EINT_CFG_W<PD_EINT_CFG1_SPEC> {
        EINT_CFG_W::new(self, 0)
    }
    #[doc = "Bits 4:7 - External INT Mode"]
    #[inline(always)]
    #[must_use]
    pub fn eint9_cfg(&mut self) -> EINT_CFG_W<PD_EINT_CFG1_SPEC> {
        EINT_CFG_W::new(self, 4)
    }
    #[doc = "Bits 8:11 - External INT Mode"]
    #[inline(always)]
    #[must_use]
    pub fn eint10_cfg(&mut self) -> EINT_CFG_W<PD_EINT_CFG1_SPEC> {
        EINT_CFG_W::new(self, 8)
    }
    #[doc = "Bits 12:15 - External INT Mode"]
    #[inline(always)]
    #[must_use]
    pub fn eint11_cfg(&mut self) -> EINT_CFG_W<PD_EINT_CFG1_SPEC> {
        EINT_CFG_W::new(self, 12)
    }
    #[doc = "Bits 16:19 - External INT Mode"]
    #[inline(always)]
    #[must_use]
    pub fn eint12_cfg(&mut self) -> EINT_CFG_W<PD_EINT_CFG1_SPEC> {
        EINT_CFG_W::new(self, 16)
    }
    #[doc = "Bits 20:23 - External INT Mode"]
    #[inline(always)]
    #[must_use]
    pub fn eint13_cfg(&mut self) -> EINT_CFG_W<PD_EINT_CFG1_SPEC> {
        EINT_CFG_W::new(self, 20)
    }
    #[doc = "Bits 24:27 - External INT Mode"]
    #[inline(always)]
    #[must_use]
    pub fn eint14_cfg(&mut self) -> EINT_CFG_W<PD_EINT_CFG1_SPEC> {
        EINT_CFG_W::new(self, 24)
    }
    #[doc = "Bits 28:31 - External INT Mode"]
    #[inline(always)]
    #[must_use]
    pub fn eint15_cfg(&mut self) -> EINT_CFG_W<PD_EINT_CFG1_SPEC> {
...
#[doc = "PD External Interrupt Configure Register 1\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`pd_eint_cfg1::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`pd_eint_cfg1::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
