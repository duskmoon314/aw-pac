...
pub type R = crate::R<PG_EINT_CTL_SPEC>;
#[doc = "Register `pg_eint_ctl` writer"]
pub type W = crate::W<PG_EINT_CTL_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn eint_ctl(&mut self, n: u8) -> EINT_CTL_W<PG_EINT_CTL_SPEC> {
        #[allow(clippy::no_effect)]
        [(); 19][n as usize];
    ...
    #[inline(always)]
    #[must_use]
    pub fn eint0_ctl(&mut self) -> EINT_CTL_W<PG_EINT_CTL_SPEC> {
        EINT_CTL_W::new(self, 0)
    }
    #[doc = "Bit 1 - External INT Enable"]
    #[inline(always)]
    #[must_use]
    pub fn eint1_ctl(&mut self) -> EINT_CTL_W<PG_EINT_CTL_SPEC> {
        EINT_CTL_W::new(self, 1)
    }
    #[doc = "Bit 2 - External INT Enable"]
    #[inline(always)]
    #[must_use]
    pub fn eint2_ctl(&mut self) -> EINT_CTL_W<PG_EINT_CTL_SPEC> {
        EINT_CTL_W::new(self, 2)
    }
    #[doc = "Bit 3 - External INT Enable"]
    #[inline(always)]
    #[must_use]
    pub fn eint3_ctl(&mut self) -> EINT_CTL_W<PG_EINT_CTL_SPEC> {
        EINT_CTL_W::new(self, 3)
    }
    #[doc = "Bit 4 - External INT Enable"]
    #[inline(always)]
    #[must_use]
    pub fn eint4_ctl(&mut self) -> EINT_CTL_W<PG_EINT_CTL_SPEC> {
        EINT_CTL_W::new(self, 4)
    }
    #[doc = "Bit 5 - External INT Enable"]
    #[inline(always)]
    #[must_use]
    pub fn eint5_ctl(&mut self) -> EINT_CTL_W<PG_EINT_CTL_SPEC> {
        EINT_CTL_W::new(self, 5)
    }
    #[doc = "Bit 6 - External INT Enable"]
    #[inline(always)]
    #[must_use]
    pub fn eint6_ctl(&mut self) -> EINT_CTL_W<PG_EINT_CTL_SPEC> {
        EINT_CTL_W::new(self, 6)
    }
    #[doc = "Bit 7 - External INT Enable"]
    #[inline(always)]
    #[must_use]
    pub fn eint7_ctl(&mut self) -> EINT_CTL_W<PG_EINT_CTL_SPEC> {
        EINT_CTL_W::new(self, 7)
    }
    #[doc = "Bit 8 - External INT Enable"]
    #[inline(always)]
    #[must_use]
    pub fn eint8_ctl(&mut self) -> EINT_CTL_W<PG_EINT_CTL_SPEC> {
        EINT_CTL_W::new(self, 8)
    }
    #[doc = "Bit 9 - External INT Enable"]
    #[inline(always)]
    #[must_use]
    pub fn eint9_ctl(&mut self) -> EINT_CTL_W<PG_EINT_CTL_SPEC> {
        EINT_CTL_W::new(self, 9)
    }
    #[doc = "Bit 10 - External INT Enable"]
    #[inline(always)]
    #[must_use]
    pub fn eint10_ctl(&mut self) -> EINT_CTL_W<PG_EINT_CTL_SPEC> {
        EINT_CTL_W::new(self, 10)
    }
    #[doc = "Bit 11 - External INT Enable"]
    #[inline(always)]
    #[must_use]
    pub fn eint11_ctl(&mut self) -> EINT_CTL_W<PG_EINT_CTL_SPEC> {
        EINT_CTL_W::new(self, 11)
    }
    #[doc = "Bit 12 - External INT Enable"]
    #[inline(always)]
    #[must_use]
    pub fn eint12_ctl(&mut self) -> EINT_CTL_W<PG_EINT_CTL_SPEC> {
        EINT_CTL_W::new(self, 12)
    }
    #[doc = "Bit 13 - External INT Enable"]
    #[inline(always)]
    #[must_use]
    pub fn eint13_ctl(&mut self) -> EINT_CTL_W<PG_EINT_CTL_SPEC> {
        EINT_CTL_W::new(self, 13)
    }
    #[doc = "Bit 14 - External INT Enable"]
    #[inline(always)]
    #[must_use]
    pub fn eint14_ctl(&mut self) -> EINT_CTL_W<PG_EINT_CTL_SPEC> {
        EINT_CTL_W::new(self, 14)
    }
    #[doc = "Bit 15 - External INT Enable"]
    #[inline(always)]
    #[must_use]
    pub fn eint15_ctl(&mut self) -> EINT_CTL_W<PG_EINT_CTL_SPEC> {
        EINT_CTL_W::new(self, 15)
    }
    #[doc = "Bit 16 - External INT Enable"]
    #[inline(always)]
    #[must_use]
    pub fn eint16_ctl(&mut self) -> EINT_CTL_W<PG_EINT_CTL_SPEC> {
        EINT_CTL_W::new(self, 16)
    }
    #[doc = "Bit 17 - External INT Enable"]
    #[inline(always)]
    #[must_use]
    pub fn eint17_ctl(&mut self) -> EINT_CTL_W<PG_EINT_CTL_SPEC> {
        EINT_CTL_W::new(self, 17)
    }
    #[doc = "Bit 18 - External INT Enable"]
    #[inline(always)]
    #[must_use]
    pub fn eint18_ctl(&mut self) -> EINT_CTL_W<PG_EINT_CTL_SPEC> {
