...
pub struct PB_DRV_R(crate::FieldReader<u8>);
impl PB_DRV_R {
    #[inline(always)]
...
pub struct PB_DRV_W<'a, const O: usize> {
    w: &'a mut W,
}
impl<'a, const O: usize> PB_DRV_W<'a, O> {
...
impl W {
    #[doc = "PB Multi_Driving Select"]
    #[inline(always)]
    pub unsafe fn pb_drv<const O: usize>(&mut self) -> PB_DRV_W<O> {
        PB_DRV_W { w: self }
    }
    #[doc = "Bits 0:1 - PB Multi_Driving Select"]
    #[inline(always)]
