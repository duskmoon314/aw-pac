...
pub type R = crate::R<PD_EINT_CFG2_SPEC>;
#[doc = "Register `pd_eint_cfg2` writer"]
pub type W = crate::W<PD_EINT_CFG2_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn eint_cfg(&mut self, n: u8) -> EINT_CFG_W<PD_EINT_CFG2_SPEC> {
        #[allow(clippy::no_effect)]
        [(); 7][n as usize];
    ...
    #[inline(always)]
    #[must_use]
    pub fn eint16_cfg(&mut self) -> EINT_CFG_W<PD_EINT_CFG2_SPEC> {
        EINT_CFG_W::new(self, 0)
    }
    #[doc = "Bits 4:7 - External INT Mode"]
    #[inline(always)]
    #[must_use]
    pub fn eint17_cfg(&mut self) -> EINT_CFG_W<PD_EINT_CFG2_SPEC> {
        EINT_CFG_W::new(self, 4)
    }
    #[doc = "Bits 8:11 - External INT Mode"]
    #[inline(always)]
    #[must_use]
    pub fn eint18_cfg(&mut self) -> EINT_CFG_W<PD_EINT_CFG2_SPEC> {
        EINT_CFG_W::new(self, 8)
    }
    #[doc = "Bits 12:15 - External INT Mode"]
    #[inline(always)]
    #[must_use]
    pub fn eint19_cfg(&mut self) -> EINT_CFG_W<PD_EINT_CFG2_SPEC> {
        EINT_CFG_W::new(self, 12)
    }
    #[doc = "Bits 16:19 - External INT Mode"]
    #[inline(always)]
    #[must_use]
    pub fn eint20_cfg(&mut self) -> EINT_CFG_W<PD_EINT_CFG2_SPEC> {
        EINT_CFG_W::new(self, 16)
    }
    #[doc = "Bits 20:23 - External INT Mode"]
    #[inline(always)]
    #[must_use]
    pub fn eint21_cfg(&mut self) -> EINT_CFG_W<PD_EINT_CFG2_SPEC> {
        EINT_CFG_W::new(self, 20)
    }
    #[doc = "Bits 24:27 - External INT Mode"]
    #[inline(always)]
    #[must_use]
    pub fn eint22_cfg(&mut self) -> EINT_CFG_W<PD_EINT_CFG2_SPEC> {
