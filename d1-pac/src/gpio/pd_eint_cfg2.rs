...
pub struct R(crate::R<PD_EINT_CFG2_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<PD_EINT_CFG2_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<PD_EINT_CFG2_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<PD_EINT_CFG2_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `pd_eint_cfg2` writer"]
pub struct W(crate::W<PD_EINT_CFG2_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<PD_EINT_CFG2_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<PD_EINT_CFG2_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<PD_EINT_CFG2_SPEC>) -> Self {
        W(writer)
    }
}
#[doc = "Field `eint_cfg[16-22]` reader - External INT Mode"]
...
#[doc = "Field `eint_cfg[16-22]` writer - External INT Mode"]
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn eint19_cfg(&mut self) -> EINT_CFG_W<12> {
        EINT_CFG_W::new(self)
    }
    #[doc = "Bits 16:19 - External INT Mode"]
    #[inline(always)]
    #[must_use]
    pub fn eint20_cfg(&mut self) -> EINT_CFG_W<16> {
        EINT_CFG_W::new(self)
    }
    #[doc = "Bits 20:23 - External INT Mode"]
    #[inline(always)]
    #[must_use]
    pub fn eint21_cfg(&mut self) -> EINT_CFG_W<20> {
        EINT_CFG_W::new(self)
    }
    #[doc = "Bits 24:27 - External INT Mode"]
    #[inline(always)]
    #[must_use]
    pub fn eint22_cfg(&mut self) -> EINT_CFG_W<24> {
        EINT_CFG_W::new(self)
    }
...
#[doc = "PD External Interrupt Configure Register 2\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [pd_eint_cfg2](index.html) module"]
pub struct PD_EINT_CFG2_SPEC;
impl crate::RegisterSpec for PD_EINT_CFG2_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [pd_eint_cfg2::R](R) reader structure"]
impl crate::Readable for PD_EINT_CFG2_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [pd_eint_cfg2::W](W) writer structure"]
impl crate::Writable for PD_EINT_CFG2_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets pd_eint_cfg2 to value 0"]
impl crate::Resettable for PD_EINT_CFG2_SPEC {
