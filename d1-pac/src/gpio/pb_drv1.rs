...
pub type R = crate::R<PB_DRV1_SPEC>;
#[doc = "Register `pb_drv1` writer"]
pub type W = crate::W<PB_DRV1_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn pb_drv(&mut self, n: u8) -> PB_DRV_W<PB_DRV1_SPEC> {
        #[allow(clippy::no_effect)]
        [(); 5][n as usize];
    ...
    #[inline(always)]
    #[must_use]
    pub fn pb8_drv(&mut self) -> PB_DRV_W<PB_DRV1_SPEC> {
        PB_DRV_W::new(self, 0)
    }
    #[doc = "Bits 4:5 - PB Multi_Driving Select"]
    #[inline(always)]
    #[must_use]
    pub fn pb9_drv(&mut self) -> PB_DRV_W<PB_DRV1_SPEC> {
        PB_DRV_W::new(self, 4)
    }
    #[doc = "Bits 8:9 - PB Multi_Driving Select"]
    #[inline(always)]
    #[must_use]
    pub fn pb10_drv(&mut self) -> PB_DRV_W<PB_DRV1_SPEC> {
        PB_DRV_W::new(self, 8)
    }
    #[doc = "Bits 12:13 - PB Multi_Driving Select"]
    #[inline(always)]
    #[must_use]
    pub fn pb11_drv(&mut self) -> PB_DRV_W<PB_DRV1_SPEC> {
        PB_DRV_W::new(self, 12)
    }
    #[doc = "Bits 16:17 - PB Multi_Driving Select"]
    #[inline(always)]
    #[must_use]
    pub fn pb12_drv(&mut self) -> PB_DRV_W<PB_DRV1_SPEC> {
