...
pub type R = crate::R<PD_DRV1_SPEC>;
#[doc = "Register `pd_drv1` writer"]
pub type W = crate::W<PD_DRV1_SPEC>;
...
impl R {
    #[doc = "PD Multi_Driving Select\n\nNOTE: `n` is number of field in register. `n == 0` corresponds to `pd8_drv` field"]
    #[inline(always)]
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn pd_drv(&mut self, n: u8) -> PD_DRV_W<PD_DRV1_SPEC> {
        #[allow(clippy::no_effect)]
        [(); 8][n as usize];
    ...
    #[inline(always)]
    #[must_use]
    pub fn pd8_drv(&mut self) -> PD_DRV_W<PD_DRV1_SPEC> {
        PD_DRV_W::new(self, 0)
    }
    #[doc = "Bits 4:5 - PD Multi_Driving Select"]
    #[inline(always)]
    #[must_use]
    pub fn pd9_drv(&mut self) -> PD_DRV_W<PD_DRV1_SPEC> {
        PD_DRV_W::new(self, 4)
    }
    #[doc = "Bits 8:9 - PD Multi_Driving Select"]
    #[inline(always)]
    #[must_use]
    pub fn pd10_drv(&mut self) -> PD_DRV_W<PD_DRV1_SPEC> {
        PD_DRV_W::new(self, 8)
    }
    #[doc = "Bits 12:13 - PD Multi_Driving Select"]
    #[inline(always)]
    #[must_use]
    pub fn pd11_drv(&mut self) -> PD_DRV_W<PD_DRV1_SPEC> {
        PD_DRV_W::new(self, 12)
    }
    #[doc = "Bits 16:17 - PD Multi_Driving Select"]
    #[inline(always)]
    #[must_use]
    pub fn pd12_drv(&mut self) -> PD_DRV_W<PD_DRV1_SPEC> {
        PD_DRV_W::new(self, 16)
    }
    #[doc = "Bits 20:21 - PD Multi_Driving Select"]
    #[inline(always)]
    #[must_use]
    pub fn pd13_drv(&mut self) -> PD_DRV_W<PD_DRV1_SPEC> {
        PD_DRV_W::new(self, 20)
    }
    #[doc = "Bits 24:25 - PD Multi_Driving Select"]
    #[inline(always)]
    #[must_use]
    pub fn pd14_drv(&mut self) -> PD_DRV_W<PD_DRV1_SPEC> {
        PD_DRV_W::new(self, 24)
    }
    #[doc = "Bits 28:29 - PD Multi_Driving Select"]
    #[inline(always)]
    #[must_use]
    pub fn pd15_drv(&mut self) -> PD_DRV_W<PD_DRV1_SPEC> {
...
#[doc = "PD Multi_Driving Register 1\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`pd_drv1::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`pd_drv1::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
