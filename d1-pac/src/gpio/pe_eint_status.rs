...
pub struct R(crate::R<PE_EINT_STATUS_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<PE_EINT_STATUS_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<PE_EINT_STATUS_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<PE_EINT_STATUS_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `pe_eint_status` writer"]
pub struct W(crate::W<PE_EINT_STATUS_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<PE_EINT_STATUS_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<PE_EINT_STATUS_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<PE_EINT_STATUS_SPEC>) -> Self {
        W(writer)
    }
}
...
#[doc = "Fields `EINT(0-17)_STATUS` const generic writer - External INT Pending Bit"]
