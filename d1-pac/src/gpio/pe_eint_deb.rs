...
pub type R = crate::R<PE_EINT_DEB_SPEC>;
#[doc = "Register `pe_eint_deb` writer"]
pub type W = crate::W<PE_EINT_DEB_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn pio_int_clk_select(&mut self) -> PIO_INT_CLK_SELECT_W<PE_EINT_DEB_SPEC> {
        PIO_INT_CLK_SELECT_W::new(self, 0)
    }
    #[doc = "Bits 4:6 - Debounce Clock Pre_scale n"]
    #[inline(always)]
    #[must_use]
    pub fn deb_clk_pre_scale(&mut self) -> DEB_CLK_PRE_SCALE_W<PE_EINT_DEB_SPEC> {
