...
#[doc = "Register `EMAC_TX_CUR_BUF` writer"]
pub struct W(crate::W<EMAC_TX_CUR_BUF_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<EMAC_TX_CUR_BUF_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<EMAC_TX_CUR_BUF_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<EMAC_TX_CUR_BUF_SPEC>) -> Self {
        W(writer)
    }
}
impl W {
...
#[doc = "`write(|w| ..)` method takes [emac_tx_cur_buf::W](W) writer structure"]
impl crate::Writable for EMAC_TX_CUR_BUF_SPEC {
    type Writer = W;
}
