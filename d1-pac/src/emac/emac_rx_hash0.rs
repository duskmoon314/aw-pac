...
impl From<crate::R<EMAC_RX_HASH0_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<EMAC_RX_HASH0_SPEC>) -> Self {
        R(reader)
    }
}
...
impl From<crate::W<EMAC_RX_HASH0_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<EMAC_RX_HASH0_SPEC>) -> Self {
        W(writer)
    }
}
impl W {
