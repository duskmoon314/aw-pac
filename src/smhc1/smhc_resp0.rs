...
#[doc = "Register `SMHC_RESP0` writer"]
pub struct W(crate::W<SMHC_RESP0_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<SMHC_RESP0_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<SMHC_RESP0_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<SMHC_RESP0_SPEC>) -> Self {
        W(writer)
    }
}
impl W {
...
#[doc = "`write(|w| ..)` method takes [smhc_resp0::W](W) writer structure"]
impl crate::Writable for SMHC_RESP0_SPEC {
    type Writer = W;
}
