...
#[doc = "Register `SMHC_RESP3` writer"]
pub struct W(crate::W<SMHC_RESP3_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<SMHC_RESP3_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<SMHC_RESP3_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<SMHC_RESP3_SPEC>) -> Self {
        W(writer)
    }
}
impl W {
...
#[doc = "`write(|w| ..)` method takes [smhc_resp3::W](W) writer structure"]
impl crate::Writable for SMHC_RESP3_SPEC {
    type Writer = W;
}
