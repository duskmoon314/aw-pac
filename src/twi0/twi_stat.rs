...
#[doc = "Register `TWI_STAT` writer"]
pub struct W(crate::W<TWI_STAT_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<TWI_STAT_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<TWI_STAT_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<TWI_STAT_SPEC>) -> Self {
        W(writer)
    }
}
impl W {
...
#[doc = "`write(|w| ..)` method takes [twi_stat::W](W) writer structure"]
impl crate::Writable for TWI_STAT_SPEC {
    type Writer = W;
}
