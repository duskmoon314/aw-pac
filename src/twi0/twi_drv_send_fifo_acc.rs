#[doc = "Register `TWI_DRV_SEND_FIFO_ACC` reader"]
pub struct R(crate::R<TWI_DRV_SEND_FIFO_ACC_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<TWI_DRV_SEND_FIFO_ACC_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<TWI_DRV_SEND_FIFO_ACC_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<TWI_DRV_SEND_FIFO_ACC_SPEC>) -> Self {
        R(reader)
    }
}
...
#[doc = "`read()` method returns [twi_drv_send_fifo_acc::R](R) reader structure"]
impl crate::Readable for TWI_DRV_SEND_FIFO_ACC_SPEC {
    type Reader = R;
}
