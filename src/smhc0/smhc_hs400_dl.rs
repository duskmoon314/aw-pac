...
pub struct HS400_DL_CAL_START_R(crate::FieldReader<bool, bool>);
...
pub struct HS400_DL_CAL_DONE_R(crate::FieldReader<bool, bool>);
...
pub struct HS400_DL_R(crate::FieldReader<u8, u8>);
impl HS400_DL_R {
    #[inline(always)]
...
pub struct HS400_DL_SW_EN_R(crate::FieldReader<bool, bool>);
...
pub struct HS400_DL_SW_R(crate::FieldReader<u8, u8>);
impl HS400_DL_SW_R {
    #[inline(always)]
    pub(crate) fn new(bits: u8) -> Self {
...
impl R {
    ...
    pub fn hs400_dl_sw_en(&self) -> HS400_DL_SW_EN_R {
        HS400_DL_SW_EN_R::new(((self.bits >> 7) & 0x01) != 0)
    }
