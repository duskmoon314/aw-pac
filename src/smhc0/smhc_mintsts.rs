...
#[doc = "Register `SMHC_MINTSTS` writer"]
pub struct W(crate::W<SMHC_MINTSTS_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<SMHC_MINTSTS_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<SMHC_MINTSTS_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<SMHC_MINTSTS_SPEC>) -> Self {
        W(writer)
    }
}
impl W {
...
#[doc = "`write(|w| ..)` method takes [smhc_mintsts::W](W) writer structure"]
impl crate::Writable for SMHC_MINTSTS_SPEC {
    type Writer = W;
}
