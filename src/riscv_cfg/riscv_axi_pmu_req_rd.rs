...
#[doc = "Register `RISCV_AXI_PMU_REQ_RD` writer"]
pub struct W(crate::W<RISCV_AXI_PMU_REQ_RD_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<RISCV_AXI_PMU_REQ_RD_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<RISCV_AXI_PMU_REQ_RD_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<RISCV_AXI_PMU_REQ_RD_SPEC>) -> Self {
        W(writer)
    }
}
impl W {
...
#[doc = "`write(|w| ..)` method takes [riscv_axi_pmu_req_rd::W](W) writer structure"]
impl crate::Writable for RISCV_AXI_PMU_REQ_RD_SPEC {
    type Writer = W;
}
