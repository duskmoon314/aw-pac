...
#[doc = "Register `SPI_FSR` writer"]
pub struct W(crate::W<SPI_FSR_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<SPI_FSR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<SPI_FSR_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<SPI_FSR_SPEC>) -> Self {
        W(writer)
    }
}
impl W {
...
#[doc = "`write(|w| ..)` method takes [spi_fsr::W](W) writer structure"]
impl crate::Writable for SPI_FSR_SPEC {
    type Writer = W;
}
