...
#[doc = "Fields `EINT(0-22)_CTL` const generic writer - External INT Enable"]
...
impl W {
    ...
    #[doc = "Bit 18 - External INT Enable"]
    #[inline(always)]
    pub fn eint18_ctl(&mut self) -> EINT_CTL_CGW<18> {
        EINT_CTL_CGW { w: self }
    }
    #[doc = "Bit 19 - External INT Enable"]
    #[inline(always)]
    pub fn eint19_ctl(&mut self) -> EINT_CTL_CGW<19> {
        EINT_CTL_CGW { w: self }
    }
    #[doc = "Bit 20 - External INT Enable"]
    #[inline(always)]
    pub fn eint20_ctl(&mut self) -> EINT_CTL_CGW<20> {
        EINT_CTL_CGW { w: self }
    }
    #[doc = "Bit 21 - External INT Enable"]
    #[inline(always)]
    pub fn eint21_ctl(&mut self) -> EINT_CTL_CGW<21> {
        EINT_CTL_CGW { w: self }
    }
    #[doc = "Bit 22 - External INT Enable"]
    #[inline(always)]
    pub fn eint22_ctl(&mut self) -> EINT_CTL_CGW<22> {
        EINT_CTL_CGW { w: self }
    }
