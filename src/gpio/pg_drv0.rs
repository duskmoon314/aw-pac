...
impl W {
    ...
    #[doc = "Bits 0:1 - PG Multi_Driving Select"]
    #[inline(always)]
    pub fn pg0_drv(&mut self) -> PG_DRV_W {
        PG_DRV_W { w: self, offset: 0 }
    }
    #[doc = "Bits 4:5 - PG Multi_Driving Select"]
    #[inline(always)]
    pub fn pg1_drv(&mut self) -> PG_DRV_W {
        PG_DRV_W { w: self, offset: 4 }
    }
    #[doc = "Bits 8:9 - PG Multi_Driving Select"]
    #[inline(always)]
    pub fn pg2_drv(&mut self) -> PG_DRV_W {
        PG_DRV_W { w: self, offset: 8 }
    }
    #[doc = "Bits 12:13 - PG Multi_Driving Select"]
    #[inline(always)]
    pub fn pg3_drv(&mut self) -> PG_DRV_W {
        PG_DRV_W {
            w: self,
            offset: 12,
        }
    ...
    #[doc = "Bits 16:17 - PG Multi_Driving Select"]
    #[inline(always)]
    pub fn pg4_drv(&mut self) -> PG_DRV_W {
        PG_DRV_W {
            w: self,
            offset: 16,
        }
    ...
    #[doc = "Bits 20:21 - PG Multi_Driving Select"]
    #[inline(always)]
    pub fn pg5_drv(&mut self) -> PG_DRV_W {
        PG_DRV_W {
            w: self,
            offset: 20,
        }
    ...
    #[doc = "Bits 24:25 - PG Multi_Driving Select"]
    #[inline(always)]
    pub fn pg6_drv(&mut self) -> PG_DRV_W {
        PG_DRV_W {
            w: self,
            offset: 24,
        }
    ...
    #[doc = "Bits 28:29 - PG Multi_Driving Select"]
    #[inline(always)]
    pub fn pg7_drv(&mut self) -> PG_DRV_W {
        PG_DRV_W {
            w: self,
            offset: 28,
        }
