...
pub struct R(crate::R<PD_EINT_STATUS_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<PD_EINT_STATUS_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<PD_EINT_STATUS_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<PD_EINT_STATUS_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `pd_eint_status` writer"]
pub struct W(crate::W<PD_EINT_STATUS_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<PD_EINT_STATUS_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<PD_EINT_STATUS_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<PD_EINT_STATUS_SPEC>) -> Self {
        W(writer)
    }
}
...
impl W {
    ...
    #[doc = "Bit 18 - External INT Pending Bit"]
    #[inline(always)]
    pub fn eint18_status(&mut self) -> EINT_STATUS_W {
        EINT_STATUS_W {
            w: self,
            offset: 18,
        }
    ...
    #[doc = "Bit 19 - External INT Pending Bit"]
    #[inline(always)]
    pub fn eint19_status(&mut self) -> EINT_STATUS_W {
        EINT_STATUS_W {
            w: self,
            offset: 19,
        }
    ...
    #[doc = "Bit 20 - External INT Pending Bit"]
    #[inline(always)]
    pub fn eint20_status(&mut self) -> EINT_STATUS_W {
        EINT_STATUS_W {
            w: self,
            offset: 20,
        }
    ...
    #[doc = "Bit 21 - External INT Pending Bit"]
    #[inline(always)]
    pub fn eint21_status(&mut self) -> EINT_STATUS_W {
        EINT_STATUS_W {
            w: self,
            offset: 21,
        }
    ...
    #[doc = "Bit 22 - External INT Pending Bit"]
    #[inline(always)]
    pub fn eint22_status(&mut self) -> EINT_STATUS_W {
        EINT_STATUS_W {
            w: self,
            offset: 22,
        }
