...
#[doc = "Register `pio_pow_val` writer"]
pub struct W(crate::W<PIO_POW_VAL_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<PIO_POW_VAL_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<PIO_POW_VAL_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<PIO_POW_VAL_SPEC>) -> Self {
        W(writer)
    }
}
impl W {
...
#[doc = "`write(|w| ..)` method takes [pio_pow_val::W](W) writer structure"]
impl crate::Writable for PIO_POW_VAL_SPEC {
    type Writer = W;
}
