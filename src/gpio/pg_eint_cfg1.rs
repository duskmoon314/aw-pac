...
pub struct R(crate::R<PG_EINT_CFG1_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<PG_EINT_CFG1_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<PG_EINT_CFG1_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<PG_EINT_CFG1_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `pg_eint_cfg1` writer"]
pub struct W(crate::W<PG_EINT_CFG1_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<PG_EINT_CFG1_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<PG_EINT_CFG1_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<PG_EINT_CFG1_SPEC>) -> Self {
        W(writer)
    }
}
...
impl W {
    ...
    #[doc = "Bits 0:3 - External INT Mode"]
    #[inline(always)]
    pub fn eint8_cfg(&mut self) -> EINT_CFG_W {
        EINT_CFG_W { w: self, offset: 0 }
    }
    #[doc = "Bits 4:7 - External INT Mode"]
    #[inline(always)]
    pub fn eint9_cfg(&mut self) -> EINT_CFG_W {
        EINT_CFG_W { w: self, offset: 4 }
    }
    #[doc = "Bits 8:11 - External INT Mode"]
    #[inline(always)]
    pub fn eint10_cfg(&mut self) -> EINT_CFG_W {
        EINT_CFG_W { w: self, offset: 8 }
    }
    #[doc = "Bits 12:15 - External INT Mode"]
    #[inline(always)]
    pub fn eint11_cfg(&mut self) -> EINT_CFG_W {
        EINT_CFG_W {
            w: self,
            offset: 12,
        }
    ...
    #[doc = "Bits 16:19 - External INT Mode"]
    #[inline(always)]
    pub fn eint12_cfg(&mut self) -> EINT_CFG_W {
        EINT_CFG_W {
            w: self,
            offset: 16,
        }
    ...
    #[doc = "Bits 20:23 - External INT Mode"]
    #[inline(always)]
    pub fn eint13_cfg(&mut self) -> EINT_CFG_W {
        EINT_CFG_W {
            w: self,
            offset: 20,
        }
    ...
    #[doc = "Bits 24:27 - External INT Mode"]
    #[inline(always)]
    pub fn eint14_cfg(&mut self) -> EINT_CFG_W {
        EINT_CFG_W {
            w: self,
            offset: 24,
        }
    ...
    #[doc = "Bits 28:31 - External INT Mode"]
    #[inline(always)]
    pub fn eint15_cfg(&mut self) -> EINT_CFG_W {
        EINT_CFG_W {
            w: self,
            offset: 28,
        }
