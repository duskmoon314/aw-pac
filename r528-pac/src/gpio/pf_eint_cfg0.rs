...
#[doc = "Fields `EINT(0-6)_CFG` reader - External INT Mode"]
...
#[doc = "Fields `EINT(0-6)_CFG` writer - External INT Mode"]
...
#[doc = "Fields `EINT(0-6)_CFG` const generic writer - External INT Mode"]
