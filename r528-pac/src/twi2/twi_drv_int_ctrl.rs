...
pub struct RX_REQ_INT_EN_R(crate::FieldReader<bool, bool>);
...
pub struct TX_REQ_INT_EN_R(crate::FieldReader<bool, bool>);
...
pub struct TRAN_ERR_INT_EN_R(crate::FieldReader<bool, bool>);
...
pub struct TRAN_COM_INT_EN_R(crate::FieldReader<bool, bool>);
...
pub struct RX_REQ_PD_R(crate::FieldReader<bool, bool>);
impl RX_REQ_PD_R {
    #[inline(always)]
    pub(crate) fn new(bits: bool) -> Self {
...
pub struct TX_REQ_PD_R(crate::FieldReader<bool, bool>);
impl TX_REQ_PD_R {
    #[inline(always)]
    pub(crate) fn new(bits: bool) -> Self {
...
pub struct TRAN_ERR_PD_R(crate::FieldReader<bool, bool>);
impl TRAN_ERR_PD_R {
    #[inline(always)]
    pub(crate) fn new(bits: bool) -> Self {
...
pub struct TRAN_COM_PD_R(crate::FieldReader<bool, bool>);
impl TRAN_COM_PD_R {
    #[inline(always)]
    pub(crate) fn new(bits: bool) -> Self {
...
impl R {
    ...
    pub fn rx_req_int_en(&self) -> RX_REQ_INT_EN_R {
        RX_REQ_INT_EN_R::new(((self.bits >> 19) & 0x01) != 0)
    }
    #[doc = "Bit 18"]
    #[inline(always)]
    pub fn tx_req_int_en(&self) -> TX_REQ_INT_EN_R {
        TX_REQ_INT_EN_R::new(((self.bits >> 18) & 0x01) != 0)
    }
    #[doc = "Bit 17"]
    #[inline(always)]
    pub fn tran_err_int_en(&self) -> TRAN_ERR_INT_EN_R {
        TRAN_ERR_INT_EN_R::new(((self.bits >> 17) & 0x01) != 0)
    }
    #[doc = "Bit 16"]
    #[inline(always)]
    pub fn tran_com_int_en(&self) -> TRAN_COM_INT_EN_R {
        TRAN_COM_INT_EN_R::new(((self.bits >> 16) & 0x01) != 0)
    }
    #[doc = "Bit 3"]
    #[inline(always)]
    pub fn rx_req_pd(&self) -> RX_REQ_PD_R {
        RX_REQ_PD_R::new(((self.bits >> 3) & 0x01) != 0)
    }
    #[doc = "Bit 2"]
    #[inline(always)]
    pub fn tx_req_pd(&self) -> TX_REQ_PD_R {
        TX_REQ_PD_R::new(((self.bits >> 2) & 0x01) != 0)
    }
    #[doc = "Bit 1"]
    #[inline(always)]
    pub fn tran_err_pd(&self) -> TRAN_ERR_PD_R {
        TRAN_ERR_PD_R::new(((self.bits >> 1) & 0x01) != 0)
    }
    #[doc = "Bit 0"]
    #[inline(always)]
    pub fn tran_com_pd(&self) -> TRAN_COM_PD_R {
        TRAN_COM_PD_R::new((self.bits & 0x01) != 0)
    }
}
impl W {
    #[doc = "Bit 19"]
