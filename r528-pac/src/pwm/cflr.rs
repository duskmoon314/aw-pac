...
#[doc = "Register `cflr%s` writer"]
pub struct W(crate::W<CFLR_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<CFLR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<CFLR_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<CFLR_SPEC>) -> Self {
        W(writer)
    }
}
impl W {
...
#[doc = "`write(|w| ..)` method takes [cflr::W](W) writer structure"]
impl crate::Writable for CFLR_SPEC {
    type Writer = W;
}
