#[doc = "HC_HCCA register accessor: an alias for `Reg<HC_HCCA_SPEC>`"]
pub type HC_HCCA = crate::Reg<hc_hcca::HC_HCCA_SPEC>;
#[doc = "OHCI HCCA Base"]
pub mod hc_hcca;
#[doc = "HC_PERIOD_CURRENT_ED register accessor: an alias for `Reg<HC_PERIOD_CURRENT_ED_SPEC>`"]
...
#[doc = "HC_CONTROL_HEAD_ED register accessor: an alias for `Reg<HC_CONTROL_HEAD_ED_SPEC>`"]
...
#[doc = "HC_CONTROL_CURRENT_ED register accessor: an alias for `Reg<HC_CONTROL_CURRENT_ED_SPEC>`"]
...
#[doc = "HC_BULK_HEAD_ED register accessor: an alias for `Reg<HC_BULK_HEAD_ED_SPEC>`"]
pub type HC_BULK_HEAD_ED = crate::Reg<hc_bulk_head_ed::HC_BULK_HEAD_ED_SPEC>;
#[doc = "OHCI Bulk Head ED Base"]
pub mod hc_bulk_head_ed;
#[doc = "HC_BULK_CURRENT_ED register accessor: an alias for `Reg<HC_BULK_CURRENT_ED_SPEC>`"]
...
#[doc = "HC_DONE_HEAD register accessor: an alias for `Reg<HC_DONE_HEAD_SPEC>`"]
