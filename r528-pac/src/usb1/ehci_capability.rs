#[doc = "CAPLENGTH register accessor: an alias for `Reg<CAPLENGTH_SPEC>`"]
pub type CAPLENGTH = crate::Reg<caplength::CAPLENGTH_SPEC>;
#[doc = "EHCI Identification Register"]
pub mod caplength;
#[doc = "HCIVERSION register accessor: an alias for `Reg<HCIVERSION_SPEC>`"]
...
pub mod hccparams;
#[doc = "HCSP_PORTROUTE register accessor: an alias for `Reg<HCSP_PORTROUTE_SPEC>`"]
