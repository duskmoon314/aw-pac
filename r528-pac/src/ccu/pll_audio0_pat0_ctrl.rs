#[doc = "Register `PLL_AUDIO0_PAT0_CTRL` reader"]
pub struct R(crate::R<PLL_AUDIO0_PAT0_CTRL_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<PLL_AUDIO0_PAT0_CTRL_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<PLL_AUDIO0_PAT0_CTRL_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<PLL_AUDIO0_PAT0_CTRL_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `PLL_AUDIO0_PAT0_CTRL` writer"]
pub struct W(crate::W<PLL_AUDIO0_PAT0_CTRL_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<PLL_AUDIO0_PAT0_CTRL_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<PLL_AUDIO0_PAT0_CTRL_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<PLL_AUDIO0_PAT0_CTRL_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type SIG_DELT_PAT_EN_W<'a> = crate::BitWriter<'a, u32, PLL_AUDIO0_PAT0_CTRL_SPEC, bool, 31>;
...
pub type SPR_FREQ_MODE_W<'a> =
    crate::FieldWriterSafe<'a, u32, PLL_AUDIO0_PAT0_CTRL_SPEC, u8, SPR_FREQ_MODE_A, 2, 29>;
...
pub type WAVE_STEP_W<'a> = crate::FieldWriter<'a, u32, PLL_AUDIO0_PAT0_CTRL_SPEC, u16, u16, 9, 20>;
...
pub type SDM_CLK_SEL_W<'a> =
    crate::BitWriter<'a, u32, PLL_AUDIO0_PAT0_CTRL_SPEC, SDM_CLK_SEL_A, 19>;
...
pub type FREQ_W<'a> = crate::FieldWriterSafe<'a, u32, PLL_AUDIO0_PAT0_CTRL_SPEC, u8, FREQ_A, 2, 17>;
impl<'a> FREQ_W<'a> {
    #[doc = "`0`"]
    #[inline(always)]
...
pub type WAVE_BOT_W<'a> = crate::FieldWriter<'a, u32, PLL_AUDIO0_PAT0_CTRL_SPEC, u32, u32, 17, 0>;
impl R {
...
#[doc = "PLL_AUDIO0 Pattern0 Control Register\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [pll_audio0_pat0_ctrl](index.html) module"]
pub struct PLL_AUDIO0_PAT0_CTRL_SPEC;
impl crate::RegisterSpec for PLL_AUDIO0_PAT0_CTRL_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [pll_audio0_pat0_ctrl::R](R) reader structure"]
impl crate::Readable for PLL_AUDIO0_PAT0_CTRL_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [pll_audio0_pat0_ctrl::W](W) writer structure"]
impl crate::Writable for PLL_AUDIO0_PAT0_CTRL_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets PLL_AUDIO0_PAT0_CTRL to value 0"]
impl crate::Resettable for PLL_AUDIO0_PAT0_CTRL_SPEC {
    #[inline(always)]
