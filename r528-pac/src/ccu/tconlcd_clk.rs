...
pub type CLK_GATING_W<'a> = crate::BitWriter<'a, u32, TCONLCD_CLK_SPEC, CLK_GATING_A, 31>;
...
pub type CLK_SRC_SEL_W<'a> =
    crate::FieldWriter<'a, u32, TCONLCD_CLK_SPEC, u8, CLK_SRC_SEL_A, 3, 24>;
...
pub type FACTOR_N_W<'a> = crate::FieldWriterSafe<'a, u32, TCONLCD_CLK_SPEC, u8, FACTOR_N_A, 2, 8>;
impl<'a> FACTOR_N_W<'a> {
    #[doc = "`0`"]
    #[inline(always)]
...
pub type FACTOR_M_W<'a> = crate::FieldWriter<'a, u32, TCONLCD_CLK_SPEC, u8, u8, 4, 0>;
impl R {
