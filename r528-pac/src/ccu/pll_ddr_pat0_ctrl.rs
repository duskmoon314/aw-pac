...
impl From<crate::R<PLL_DDR_PAT0_CTRL_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<PLL_DDR_PAT0_CTRL_SPEC>) -> Self {
        R(reader)
    }
}
...
impl From<crate::W<PLL_DDR_PAT0_CTRL_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<PLL_DDR_PAT0_CTRL_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type SIG_DELT_PAT_EN_W<'a> = crate::BitWriter<'a, u32, PLL_DDR_PAT0_CTRL_SPEC, bool, 31>;
...
pub type SPR_FREQ_MODE_W<'a> =
    crate::FieldWriterSafe<'a, u32, PLL_DDR_PAT0_CTRL_SPEC, u8, SPR_FREQ_MODE_A, 2, 29>;
...
pub type WAVE_STEP_W<'a> = crate::FieldWriter<'a, u32, PLL_DDR_PAT0_CTRL_SPEC, u16, u16, 9, 20>;
...
pub type SDM_CLK_SEL_W<'a> = crate::BitWriter<'a, u32, PLL_DDR_PAT0_CTRL_SPEC, SDM_CLK_SEL_A, 19>;
...
pub type FREQ_W<'a> = crate::FieldWriterSafe<'a, u32, PLL_DDR_PAT0_CTRL_SPEC, u8, FREQ_A, 2, 17>;
impl<'a> FREQ_W<'a> {
    #[doc = "`0`"]
    #[inline(always)]
...
pub type WAVE_BOT_W<'a> = crate::FieldWriter<'a, u32, PLL_DDR_PAT0_CTRL_SPEC, u32, u32, 17, 0>;
impl R {
...
#[doc = "PLL_DDR Pattern0 Control Register\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [pll_ddr_pat0_ctrl](index.html) module"]
pub struct PLL_DDR_PAT0_CTRL_SPEC;
impl crate::RegisterSpec for PLL_DDR_PAT0_CTRL_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [pll_ddr_pat0_ctrl::R](R) reader structure"]
impl crate::Readable for PLL_DDR_PAT0_CTRL_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [pll_ddr_pat0_ctrl::W](W) writer structure"]
