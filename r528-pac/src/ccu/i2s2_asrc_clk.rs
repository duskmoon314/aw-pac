#[doc = "Register `I2S2_ASRC_CLK` reader"]
pub struct R(crate::R<I2S2_ASRC_CLK_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<I2S2_ASRC_CLK_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<I2S2_ASRC_CLK_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<I2S2_ASRC_CLK_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `I2S2_ASRC_CLK` writer"]
pub struct W(crate::W<I2S2_ASRC_CLK_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<I2S2_ASRC_CLK_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<I2S2_ASRC_CLK_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<I2S2_ASRC_CLK_SPEC>) -> Self {
        W(writer)
    }
}
#[doc = "Gating Clock\n\nValue on reset: 0"]
...
pub type CLK_GATING_W<'a> = crate::BitWriter<'a, u32, I2S2_ASRC_CLK_SPEC, CLK_GATING_A, 31>;
...
impl CLK_SRC_SEL_R {
    ...
    pub fn variant(&self) -> Option<CLK_SRC_SEL_A> {
        match self.bits {
            0 => Some(CLK_SRC_SEL_A::PLL_AUDIO0_4X),
...
pub type CLK_SRC_SEL_W<'a> =
    crate::FieldWriter<'a, u32, I2S2_ASRC_CLK_SPEC, u8, CLK_SRC_SEL_A, 3, 24>;
...
pub type FACTOR_N_W<'a> = crate::FieldWriterSafe<'a, u32, I2S2_ASRC_CLK_SPEC, u8, FACTOR_N_A, 2, 8>;
impl<'a> FACTOR_N_W<'a> {
    #[doc = "`0`"]
    #[inline(always)]
...
pub type FACTOR_M_W<'a> = crate::FieldWriter<'a, u32, I2S2_ASRC_CLK_SPEC, u8, u8, 5, 0>;
impl R {
...
#[doc = "I2S2_ASRC Clock Register\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [i2s2_asrc_clk](index.html) module"]
pub struct I2S2_ASRC_CLK_SPEC;
impl crate::RegisterSpec for I2S2_ASRC_CLK_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [i2s2_asrc_clk::R](R) reader structure"]
impl crate::Readable for I2S2_ASRC_CLK_SPEC {
    type Reader = R;
}
