...
impl From<crate::R<G2D_BGR_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<G2D_BGR_SPEC>) -> Self {
        R(reader)
    }
}
...
impl From<crate::W<G2D_BGR_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<G2D_BGR_SPEC>) -> Self {
        W(writer)
    }
}
#[doc = "Reset\n\nValue on reset: 0"]
...
pub type RST_W<'a> = crate::BitWriter<'a, u32, G2D_BGR_SPEC, RST_A, 16>;
impl<'a> RST_W<'a> {
    #[doc = "`0`"]
    #[inline(always)]
...
pub type GATING_W<'a> = crate::BitWriter<'a, u32, G2D_BGR_SPEC, GATING_A, 0>;
impl<'a> GATING_W<'a> {
    #[doc = "`0`"]
    #[inline(always)]
...
#[doc = "G2D Bus Gating Reset Register\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [g2d_bgr](index.html) module"]
pub struct G2D_BGR_SPEC;
impl crate::RegisterSpec for G2D_BGR_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [g2d_bgr::R](R) reader structure"]
impl crate::Readable for G2D_BGR_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [g2d_bgr::W](W) writer structure"]
