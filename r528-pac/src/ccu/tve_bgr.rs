...
pub type RST_W<'a> = crate::BitWriter<'a, u32, TVE_BGR_SPEC, RST_A, 17>;
impl<'a> RST_W<'a> {
    #[doc = "`0`"]
    #[inline(always)]
...
pub type TOP_RST_W<'a> = crate::BitWriter<'a, u32, TVE_BGR_SPEC, TOP_RST_A, 16>;
impl<'a> TOP_RST_W<'a> {
    #[doc = "`0`"]
    #[inline(always)]
    pub fn assert(self) -> &'a mut W {
...
pub type GATING_W<'a> = crate::BitWriter<'a, u32, TVE_BGR_SPEC, GATING_A, 1>;
impl<'a> GATING_W<'a> {
    #[doc = "`0`"]
    #[inline(always)]
...
pub type TOP_GATING_W<'a> = crate::BitWriter<'a, u32, TVE_BGR_SPEC, TOP_GATING_A, 0>;
