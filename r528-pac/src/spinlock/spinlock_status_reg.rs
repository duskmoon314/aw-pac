...
#[doc = "Register `SPINLOCK_STATUS_REG` writer"]
pub struct W(crate::W<SPINLOCK_STATUS_REG_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<SPINLOCK_STATUS_REG_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<SPINLOCK_STATUS_REG_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<SPINLOCK_STATUS_REG_SPEC>) -> Self {
        W(writer)
    }
}
impl W {
...
#[doc = "`write(|w| ..)` method takes [spinlock_status_reg::W](W) writer structure"]
impl crate::Writable for SPINLOCK_STATUS_REG_SPEC {
    type Writer = W;
}
